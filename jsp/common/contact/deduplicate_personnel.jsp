...
public static String strTitle[][] = {
	{"No","Terpakai","Pilih","Kode","Nama","Alamat"},	
	{"No","Used","Selected","Code","Name","Address"}
};
...
public String drawListPersonel(int language, Vector objectClass, int start){
	...
	ctrlist.dataFormat(strTitle[language][4],"30%","left","left");		
	ctrlist.dataFormat(strTitle[language][5],"45%","left","left");				
...
try{ 
	records = (Vector)session.getValue("DEDUPLICATE_PERSONNEL");
}catch(Exception e){ 
	System.out.println("Exception : "+e.toString());
}

// konstanta command
String strTitle = SESS_LANGUAGE==langForeign ? "Masterdata &gt Merge Personnel" : "Masterdata &gt Penggabungan Perseorangan";
String strMergeComp = SESS_LANGUAGE==langForeign ? "Personnel Merge" : "Penggabungan Perseorangan";
...
function cmdUpdate(oid){
	...
	document.frmpersonel.action="deduplicate_personnel.jsp";
