...
<% int  appObjCode = 0; //AppObjInfo.composeObjCode(AppObjInfo.G1_MASTERDATA, AppObjInfo.G2_MASTERDATA_CONTACT, AppObjInfo.OBJ_MASTERDATA_CONTACT_COMPANY); %>
...
public String drawList(int language, Vector objectClass, long oid, int start){
	...
	for (int i = 0; i < objectClass.size(); i++) {
		...
		rowx.add(cekNull(contactList.getPersonName())+" "+contactList.getPersonLastname());
