                  ...
                  <td> 
                    <%
						...
						try {
							...
							ctrlList.setLinkPrefix("javascript:cmdEdit('");					
							ctrlList.setLinkSufix("')");
							ctrlList.reset();
                       ...
                       if((sysProp2.getNote()==null || sysProp2.getNote().trim().length()< 1)  && (sysProp2.getName()==null || sysProp2.getName().length()>0 ) ) {
                           sysProp2.setNote(SessSystemProperty.getSystemPropsAISONote(sysProp2.getName()) );
                       } 
