<%-- 
    Document   : pengurus_kelompok
    Created on : Aug 26, 2017, 9:45:49 AM
    Author     : Dimata 007
--%>
...
<html>
    ...
    <script language="javascript">
      $(document).ready(function () {
        ...
        $('#btn_add').click(function () {
          ...
          window.location = "../anggota/pengurus_kelompok.jsp?kelompok_id=<%=idKelompok%>&pengurus_id=0&command=<%=Command.ADD%>";
        });

        $('.btn_edit').click(function () {
          $(this).attr({"disabled": "true"}).html("....");
          var oidPengurus = $(this).data('oid');
          window.location = "../anggota/pengurus_kelompok.jsp?kelompok_id=<%=idKelompok%>&pengurus_id=" + oidPengurus + "&command=<%=Command.EDIT%>";
        });

        $('#btn_cancel').click(function () {
          $(this).attr({"disabled": "true"}).html("Tunggu...");
          window.location = "../anggota/pengurus_kelompok.jsp?kelompok_id=<%=idKelompok%>";
        });
  ...
  <body style="background-color: #eaf3df;">
    ...
    <section class="content-header">
      ...
      <a class="btn btn-danger" href="../anggota/pengurus_kelompok.jsp?kelompok_id=<%=idKelompok%>">Data Pengurus / Pemilik</a>
