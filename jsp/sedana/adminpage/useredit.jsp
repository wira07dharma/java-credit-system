...
public static String strTitle[][] = {
	{"Login ID","Password","Konfirmasi Password","Nama","Email","Keterangan","Status User","Dimasukkan ke Grup","Ubah","Tambah","Lokasi Transaksi","Departmen","Kelompok Pemakai", "Lokasi Utama"},
	{"Login ID","Password","Confirm Password","Full Name","Email","Description","User Status","Group Assigned","Edit","Add","Assign Trans.Location","Department","User Group", "Main Location"}
};
          ...
          <td valign="top"><!-- #BeginEditable "content" --> 
            <form name="frmAppUser" method="get" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="0">
				...
				%>
					<tr> 
					  <td class="msgerror"><%=strMasage%></td>
					</tr>
				<%}else{%>	
					<tr> 
					  <td  class="msginfo"><%=strMasage%></td>
					</tr>
				<%}
				}%>
              ...
              <table width="100%" cellspacing="2" cellpadding="2">
				...
				<tr>
					<td width="11%" valign="top" height="14" nowrap><%=strTitle[SESS_LANGUAGE][13]%></td>
