<%-- 
    Document   : list_credit_write_off
    Created on : 02 Sep 20, 16:36:00
    Author     : gndiw
--%>
...
<% int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_SEDANA, AppObjInfo.G2_TRANSACTION, AppObjInfo.OBJ_PENGHAPUSAN_KREDIT);%>
...
<%!
    public static final String textHeader[][] = {
        {"Transaksi", "Penghapusan Kredit", "List Penghapusan", "Form Pencarian"},
        {"Transaction", "Credit Write Off", "Write Off List", "Search Form"}
    };
    ...
    public static final String textHeaderTable[][] = {
        {"No.", "Nomor Dokumen", "Nomor Kredit", "Nama Pemohon", "Catatan", "Status", "Aksi", "Tanggal"},
        {"No.", "Document Number", "Credit Number", "Applicant Name", "Note", "Status", "Action", "Date"}
    };
            ...
            <section class="content">
                        ...
                        <form id="form-search" class="form-horizontal">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Tgl</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control input-sm select2" multiple="multiple" style="width: 100%;" 
                                                    ...
                                                    <option value="<%=I_DocStatus.DOCUMENT_STATUS_POSTED%>"><%=I_DocStatus.fieldDocumentStatus[I_DocStatus.DOCUMENT_STATUS_POSTED]%></option>
                                                </select>
                                            </div>
                                        </div>
                ...
                <div id="search-result-box">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div id="hapusListTable">
                                <table id="hapusList" class="table table-bordered table-striped table-responsive">
                                    <thead>
                                        <tr>
        ...
        <script>
            $(document).ready(function () {
                ...
                function runDataTable() {
                    dataTablesOptions("#hapusListTable", "hapusList", "AjaxKredit", "listHapus", null);
                }
                ...
                $('body').on('click', '#create-form-btn', function () {
                    var url = "penghapusan_kredit.jsp";
                    window.location = url;
                });
            });
        </script>				
