...
<% int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_SEDANA, AppObjInfo.G2_TRANSACTION, AppObjInfo.OBJ_ANALISA_FORM_5C);%>
...
<%!
    public static final String textHeader[][] = {
        {"Analisa", "Form 5C", "List Form 5C", "Form Pencarian"},
        {"Analysis", "Form 5C", "List Form 5C", "Search Form"}
    };
    ...
    public static final String textHeaderTable[][] = {
        {"No.", "Nomor Form 5C", "Nomor Kredit", "Nama Pemohon", "Catatan", "Status", "Aksi", "Tanggal Analisa"},
        {"No.", "Form 5C Number", "Loan Number", "Applicant Name", "Note", "Status", "Action", "Analysis Date"}
    };
            ...
            <section class="content">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <form id="form-search" class="form-horizontal">
                            <input type="hidden" name="FRM_FIELD_LOCATION_OID" value="<%= userLocationId %>">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Nomor Form</label>
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" placeholder="Nomor Form 5C"
                                                       name="form_num" id="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" placeholder="Nomor Kredit"
                                                       name="kredit_num" id="">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Tgl. Analisa</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control input-sm select2" multiple="multiple" style="width: 100%;" 
                                                        name="form_status">
                                                    <%
                                                        for (int i = 0; i < PstAnalisaKreditMain.analisaStatusName.length; i++) {
                                                            out.println("<option value='" + PstAnalisaKreditMain.analisaStatusValue[i] + "'>" + PstAnalisaKreditMain.analisaStatusName[i] + "</option>");
                                                        }
                                                    %>
                                                </select>
                                            </div>
                ...
                <div id="search-result-box">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div id="form5c-table-parent">
                                <table id="form5c-table" class="table table-bordered table-striped table-responsive">
                                    <thead>
                                        <tr>
        ...
        <script>
            $(document).ready(function () {
                ...
                function runDataTable() {
                    dataTablesOptions("#form5c-table-parent", "form5c-table", "AjaxAnalisaKredit", "listForm5C", null);
                       }
