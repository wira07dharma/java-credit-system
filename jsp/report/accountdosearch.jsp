...
function cmdEdit(oid,number,name){
	self.opener.document.forms.frmGeneralLedger.<%=SessGeneralLedger.FRM_NAMA_PERKIRAAN%>.value = oid;
	self.opener.document.forms.frmGeneralLedger.ACCOUNT_NUMBER.value = number;
	self.opener.document.forms.frmGeneralLedger.ACCOUNT_TITLES.value = name;	
	self.close();
}
