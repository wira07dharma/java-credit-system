...
vectLA.add(new AccountValue());
vectLA.add(new AccountValue());

Vector vectCL = new Vector();
vectCL.add(new AccountValue());
vectCL.add(new AccountValue());



vectCurrRatio.add(vectLA);
vectCurrRatio.add(vectLA);
...
<script language="javascript">
 document.location="<%=reportroot%>session.report.CurrentRatioPdf?gettime=<%=System.currentTimeMillis()%>";
</script>
