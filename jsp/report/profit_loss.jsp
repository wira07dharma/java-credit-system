...
String strViewReport = SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_FOREIGN ? "Print Report" : "Cetak Laporan";
            ...
            <form name="frmProfitLoss" method="post" action="">
              ...
              <table width="100%" border="0">
                ...
                <tr> 
                  <td width="8%" height="20%">&nbsp;</td>
                  <td height="20%" width="2%">&nbsp;</td>
                  <td height="20%" width="90%"><a href="javascript:report()"><span class="command"><%=strViewReport%></span></a></td>
                </tr>
                <tr> 
                  <td width="8%" height="20%">&nbsp;</td>
                  <td height="20%" width="2%">&nbsp;</td>
