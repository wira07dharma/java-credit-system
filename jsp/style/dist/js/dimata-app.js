(function($) {
	...
	return this.each( function() {
	   ...
	   $.ajax({
		   ...
		   if(settings.notification == true && settings.ajaxDataType == "html"){
		       $("#notifications").notify({
			    message: { html : data },
			    type    : settings.notificationType,
			    transition : settings.notificationTransition
			}).show();
		   }else if(settings.notification == true && settings.ajaxDataType == "json"){
		       $("#notifications").notify({
			    message: { html : data.FRM_FIELD_HTML },
			    type    : settings.notificationType,
			    transition : settings.notificationTransition
			}).show();
		   }
