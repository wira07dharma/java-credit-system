...
function form2JSON(parent) {
    return $(parent).serializeArray().reduce(function(a, x) { a[x.name] = x.value; return a; }, {});
}

function basicAjax(uri, onSuccess, objectData=null, method="POST") {
  var method = method;
  var uri = uri;
  var oS = onSuccess;
  var q = $.param(objectData);
