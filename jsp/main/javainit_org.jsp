...
String reportroot = "/aiso/servlet/com.dimata.aiso.";
String chartroot = approot+"/servlet/DisplayChart?filename=";
String reportrootimage = "http://localhost:8080/aiso/images/"; 
String reportrootfooter = "http://localhost"+reportroot;
...
String sPdfCompanyTitle = "ANUGERAH\nDigital Photo Studio & Lab\nJl. Letda Made Putra, Denpasar";
if (bPdfCompanyTitleUseImg)
    sPdfCompanyTitle = sPdfCompanyTitleImgPath;

String sPdfCompanyDetail = "Anugerah Digital Photo Studio\nJl. Letda Made Putra, Denpasar\nTelp. +62-361-254333 (Hunting) Fax. +62-361-254330\nanugerah@dps.centrin.net.id";
