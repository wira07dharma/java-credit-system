...
{
	{
		...
		"Supplier",
		"Uang Muka",
        "System tidak menemukan data order aktiva"
	},
	{
		"Order Number",
		"Date",
        "Supplier",
        "Down Payment",
        "System can not found fixed order data"
	}
};
...
public String listDrawOrderAktiva(FRMHandler objFRMHandler, Vector objectClass, int language)
{
	...
	try{
		for (int i = 0; i < objectClass.size(); i++){
            ...
            rowx.add("<div align=\"right\">"+FRMHandler.userFormatStringDecimal(orderAktiva.getDownPayment())+"</div>");
...
function cmdEdit(oid){
	document.frmsrcorderaktiva.order_aktiva_id.value=oid;
...
function first(){
	...
	document.frmsrcorderaktiva.action="order_aktiva_list.jsp";
	document.frmsrcorderaktiva.submit();
}
...
function cmdBack(){
	...
	document.frmsrcorderaktiva.action="order_aktiva_search.jsp";
	document.frmsrcorderaktiva.submit();
}
</script>
<!-- #EndEditable -->
