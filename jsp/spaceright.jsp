...
'<frameset cols="'+upSize+','+midSize+',*" frameborder="NO" border="0" framespacing="0">'+  
  '<frameset rows="160,*" frameborder="NO" border="0" framespacing="0">' + 
    ...
    '<frame name="leftFrame" scrolling="YES" noresize src="leftmenukoperasi.jsp?user_group=<%=groupUser%>&SESS_LANGUAGE=<%=SESS_LANGUAGE%>">' +
  '</frameset>' +
  '<frameset rows="5,*" frameborder="NO" border="0" framespacing="0">' + 
    '<frame name="spaceTopFrame" scrolling="NO" noresize src="header.jsp" >' +
    '<frame name="spaceImageFrame" scrolling="NO" noresize src="space.jsp?user_group=<%=groupUser%>&SESS_LANGUAGE=<%=SESS_LANGUAGE%>">' +
  '</frameset>' +
  '<frameset rows="5,*" frameborder="NO" border="0" framespacing="0" cols="*">' + 
    '<frame name="topFrame" scrolling="YES" noresize src="header.jsp" >' +
    '<frame name="mainFrame" scrolling="YES" noresize src="'+url+'">' +
  '</frameset>';
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" class="bodystyle" onLoad="MM_preloadImages('activeright.jpg')">
<table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#FFFFFF">  
  <tr> 
    <td height="500" > 
      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr> 
          <td align="right"><a href="javascript:setSubFrames('222','15')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','activeright.jpg',1)"><img src="inactiveright.jpg" name="Image1" width="11" height="65" border="0"></a></td>
        </tr>
      </table>
    </td>
  </tr>  
