...
<!--package aiso -->
<%@ page import = "com.dimata.aiso.form.masterdata.FrmDonorComponent"%>
...
if(cHeckBoxContact.equalsIgnoreCase("N")){
	if(iCommand==Command.LIST || iCommand==Command.BACK || iCommand==Command.NONE){	
		 ...
		 long idContactClassCashier = PstContactClass.getIdContactType(PstContactClass.FLD_CLASS_DONOR);
...
function cmdEdit(oid, name){  
	self.opener.document.forms.frmdonorcomponent.<%=FrmDonorComponent.fieldNames[FrmDonorComponent.FRM_CONTACT_ID]%>.value = oid;
	self.opener.document.forms.frmdonorcomponent.<%=FrmDonorComponent.fieldNames[FrmDonorComponent.FRM_CONTACT_ID]%>_TEXT.value = name;	
    self.close();
}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr> 
          <td height="20" class="contenttitle" >&nbsp;<!-- #BeginEditable "contenttitle" --> 
            <%=masterTitle[SESS_LANGUAGE]%> : <font color="#CC3300"><%=compTitle[SESS_LANGUAGE].toUpperCase()%></font><!-- #EndEditable --></td>
        </tr>
        <tr> 
                  ...
                  <td width="98%">
				  		...
				  		<table border="0" cellspacing="2" cellpadding="2" width="100%">
                            <tr align="left" valign="top"> 
                              ...
                              <td width="89%">
							   <%
							   String whClause = PstContactClass.fieldNames[PstContactClass.FLD_CLASS_TYPE]+" = "+PstContactClass.FLD_CLASS_DONOR;
                            ...
                            <tr align="left" valign="top"> 
							  ...
							  <input name="viewListContact" type="button" onClick="javascript:cmdSearch()" value="<%=strSearchComp%>">
