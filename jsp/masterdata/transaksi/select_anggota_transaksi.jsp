<%-- 
    ...
    Author     : HaddyPuutraa
--%>
<%@page import="com.dimata.aiso.form.masterdata.transaksi.FrmDataTransaksi"%>
<%@page import="com.dimata.aiso.form.masterdata.transaksi.FrmDataTabungan"%>
<!-- package java -->
<%@ page language="java" %>
...
<%!
	...
	for(int i=0; i<objectClass.size(); i++){
            ...
            rowx.add("<a href=\"javascript:selectAnggota('"+anggota.getOID()+"','"+anggota.getName()+"','"+anggota.getNoRekening()+"')\">"+String.valueOf(anggota.getNoAnggota()) +"</a>");
...
<html><!-- #BeginTemplate "/Templates/main.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            ...
            function selectAnggota(oid,name,no_rekening){
                self.opener.document.<%=formName%>.<%=FrmDataTransaksi.fieldNames[FrmDataTransaksi.FRM_FIELD_ID_ANGGOTA]%>.value =oid; 
                self.opener.document.<%=formName%>.<%=frmAnggota.fieldNames[frmAnggota.FRM_NAME_ANGGOTA]%>.value =name;
                self.opener.document.<%=formName%>.<%=frmAnggota.fieldNames[frmAnggota.FRM_NO_REKENING]%>.value =no_rekening;
                self.close();                               
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td height="100%">
                                                                                                            <table border="0" cellspacing="2" cellpadding="2" width="70%">
                                                                                                                ...
                                                                                                                <tr align="left" valign="top">
                                                                                                                    <td valign="top" height="25">Nama Anggota</td>
                                                                                                                    <td>
