    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function selectAnggota(oid,no,name,no_rekening,alamat){
                self.opener.document.<%=formName%>.<%=FrmDataTabungan.fieldNames[FrmDataTabungan.FRM_FIELD_ID_ANGGOTA]%>.value =oid; 
                self.opener.document.<%=formName%>.<%=frmAnggota.fieldNames[frmAnggota.FRM_NO_ANGGOTA]%>.value =no;
                ...
                self.opener.document.<%=formName%>.<%=frmAnggota.fieldNames[frmAnggota.FRM_ADDR_PERMANENT]%>.value =alamat;
                self.close();                               
