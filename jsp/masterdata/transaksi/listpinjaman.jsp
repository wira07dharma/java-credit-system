<%-- 
    ...
    Created on : Mar 25, 2013, 11:02:23 AM
    Author     : dw1p4
--%>
...
<%!
	...
	for(int i=0; i<objectClass.size(); i++){
            ...
            rowx.add(String.valueOf(Formater.formatNumber(totalAngsuran,"#.##")));
             rowx.add(String.valueOf("<center><a class=\"btn-edit btn-sm\" style=\"color:#FFF\" href=\"javascript:cmdEdit('"+pinjaman.getOID()+"')\">Edit</a></center>"));
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function addNew(){
                ...
                document.<%=frmPinjaman.FRM_PINJAMAN%>.action="<%=approot%>/sedana/transaksikredit/transaksi_kredit.jsp";
            ...
            function cmdEdit(oid){
                <%if(privUpdate){%>
                    ...
                    document.<%=frmPinjaman.FRM_PINJAMAN%>.list_command.value="<%=listCommand%>";
                    document.<%=frmPinjaman.FRM_PINJAMAN%>.command.value="<%=Command.EDIT%>";
                    document.<%=frmPinjaman.FRM_PINJAMAN%>.action="<%=approot%>/sedana/transaksikredit/transaksi_kredit.jsp";
                    document.<%=frmPinjaman.FRM_PINJAMAN%>.submit();
                <%}%>
            }
                                        ...
                                        <span class="command">
                                            ...
                                            <tr>
                                                <td>
                                                    <table width="100%">
                                                      <tr>
                                                          <td width="10%" class="command">&nbsp;<a class="btn btn-sm btn-primary" href="javascript:addNew()"><i class="fa fa-plus-circle"></i> <%=strAddDeposito%></a> </td>
                                                      </tr>
                                                    </table>
                                                </td>
                                            </tr>
