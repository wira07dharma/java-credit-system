...
<html>
  ...
  <body style="background-color: #eaf3df;">
    ...
    <section class="content-header">
      <h1>
        Report Rangkuman Tabungan
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<%=approot%>/homexframe.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Laporan</li>
        <li class="active">Report Rangkuman Tabungan</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<%=approot%>/report-rangkuman-tabungan.xls" method="post">
              <input type="hidden" class="hidden" name="reportType" value="<%=FrmRscReport.REPORT_RANGKUMAN_TABUNGAN %>" />
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <% Vector<JenisTabungan> jts = PstJenisTabungan.list(0, 0, "", PstJenisTabungan.fieldNames[PstJenisTabungan.FLD_NAMA_JENIS_TABUNGAN]); %>
                    <select class="form-control select2" name="<%=FrmRscReport.fieldNames[FrmRscReport.FRM_TABUNGAN] %>" multiple data-placeholder="Select a State" style="width: 100%;">
                      <% for(JenisTabungan jt : jts) { %>
                      <option value="<%=jt.getOID()%>"><%=jt.getNamaJenisTbgn()%></option>
                      <% } %>
                    </select>
                  </div>
                </div>
