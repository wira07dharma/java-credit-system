  ...
  <body style="background-color: #eaf3df;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Laporan</li>
        <li class="active">Report Tabungan</li>
      </ol>
    </section>
            ...
            <form class="form-horizontal" action="<%=approot%>/report-tabungan.xls" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="number" name="<%=FrmRscReport.fieldNames[FrmRscReport.FRM_NO_ANGGOTA_START] %>" class="form-control" placeholder="<%=FrmRscReport.shortFieldNames[SESS_LANGUAGE][3]%>">
                  </div>
                  <div class="col-sm-5">
                    <input type="number" name="<%=FrmRscReport.fieldNames[FrmRscReport.FRM_NO_ANGGOTA_END] %>" class="form-control" placeholder="<%=FrmRscReport.shortFieldNames[SESS_LANGUAGE][4]%>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label"><%=FrmRscReport.shortFieldNames[SESS_LANGUAGE][7]%></label>
                  <div class="col-sm-10">
                    <% Vector<MasterTabungan> jts = PstMasterTabungan.list(0, 0, "", PstMasterTabungan.fieldNames[PstMasterTabungan.FLD_NAMA_TABUNGAN]); %>
                    <select class="form-control select2" name="<%=FrmRscReport.fieldNames[FrmRscReport.FRM_TABUNGAN] %>" multiple data-placeholder="Select a State" style="width: 100%;">
                      <% for(MasterTabungan jt : jts) { %>
                      <option value="<%=jt.getOID()%>"><%=jt.getNamaTabungan() %></option>
                      <% } %>
                    </select>
                  </div>
                </div>
