...
public String drawListClass(Vector objectClass, int language){
	...
	try { 								
		for (int i = 0; i < objectClass.size(); i++) {
			 ...
			 boolean pos = perkiraan.getPostable();
			 if(pos){
			    psn = "Postable";  
			 }else{ 
        	   psn = "Header";  
			 ...
			 rowx.add(strLvl+perkiraan.getNoPerkiraan()+"&nbsp;&nbsp;&nbsp;&nbsp;"+perkiraan.getNama());  
...
<%
int estimationType = FRMQueryString.requestInt(request,"estimation_type"); 
...
Vector listPerkiraan = PstPerkiraan.list(0,0,whereClause,order);
%>
<!-- End of JSP Block -->
