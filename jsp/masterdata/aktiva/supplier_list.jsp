...
function cmdAdd(){
		...
		document.frm_contactlist.action="supplier_list.jsp";
...
function cmdEdit(oid, nama){		
	self.opener.document.forms.frmstandartrate.<%=FrmModulAktiva.fieldNames[FrmModulAktiva.FRM_SUPPLIER_ID] %>.value = oid;
	self.opener.document.forms.frmstandartrate.<%=FrmModulAktiva.fieldNames[FrmModulAktiva.FRM_SUPPLIER_ID] %>_TEXT.value = nama;		
	self.close();
}
				  	...
				  	<%if(iCommand != Command.LIST){%>
				  		<table border="0" cellspacing="2" cellpadding="2" width="100%">
                            <tr align="left" valign="top"> 
                              ...
                              <td width="89%">
			       <%
			       String whClause = PstContactClass.fieldNames[PstContactClass.FLD_CLASS_TYPE]+" = "+PstContactClass.CONTACT_TYPE_SUPPLIER;
