...
{
	{"Jenis Aktiva","Harus diisi"},
	{"Fixed Assets Type","Required"}
};

public static final String textListHeader[][] =
{
	{"Kode","Jenis Aktiva"},
	{"Code","Fixed Assets Type"}
};
...
function cmdAdd(){
	...
	document.frmstandartrate.action="jenisaktiva.jsp";
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content" --> 
            <form name="frmstandartrate" method ="post" action="">
              ...
              <input type="hidden" name="<%=FrmAktiva.fieldNames[FrmAktiva.FRM_TYPE] %>" value="<%=PstAktiva.TYPE_AKTIVA_JENIS_AKTIVA%>">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <td height="8"  colspan="3" valign="top"> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr align="left" valign="top"> 
						...
						<%= drawList(listAktiva,oidAktiva,SESS_LANGUAGE,sUserDecimalSymbol,sUserDigitGroup)%> 
						<%}%>
						</td>
                      </tr>
                      <tr align="left" valign="top"> 
                ...
                <tr align="left" valign="top"> 
                  <td height="8" colspan="3"> 
				   <%System.out.println("iCommand bawah sebelum if :::::: "+iCommand);%>
                    <%if((iCommand ==Command.ADD)||(iCommand==Command.SAVE && iErrCode > 0)||(iCommand==Command.EDIT)||(iCommand==Command.ASK) || iCommand == Command.NONE){%>
                    <%System.out.println("iCommand bawah setelah if :::::: "+iCommand);%>
