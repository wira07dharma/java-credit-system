...
<%if(privAdd){%>
function cmdAdd(){
	document.frmsrcju.hidden_modul_aktiva_id.value="0";
	document.frmsrcju.command.value="<%=Command.ADD%>";
	document.frmsrcju.action="modul_aktiva_edit.jsp";
	document.frmsrcju.submit();
}
<%}%>

function cmdEdit(oid){
	document.frmsrcju.hidden_modul_aktiva_id.value=oid;
	document.frmsrcju.command.value="<%=Command.EDIT%>";
	document.frmsrcju.fa_type.value="<%=iFATipe%>";
	document.frmsrcju.action="modul_aktiva_edit.jsp";
	document.frmsrcju.submit();
}
