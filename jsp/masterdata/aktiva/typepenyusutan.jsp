...
{
	{"Tipe Penyusutan","Harus diisi"},
	{"Depreciation Type","Required"}
};

public static final String textListHeader[][] =
{
	{"Kode","Tipe Penyusutan"},
	{"Code","Depreciation Type"}
};
...
String whereClause = PstAktiva.fieldNames[PstAktiva.FLD_TYPE]+"="+PstAktiva.TYPE_AKTIVA_TYPE_PENYUSUTAN;
...
function cmdAdd(){
	...
	document.frmstandartrate.action="typepenyusutan.jsp";
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content" --> 
            <form name="frmstandartrate" method ="post" action="">
              ...
              <input type="hidden" name="<%=FrmAktiva.fieldNames[FrmAktiva.FRM_TYPE] %>" value="<%=PstAktiva.TYPE_AKTIVA_TYPE_PENYUSUTAN%>">
