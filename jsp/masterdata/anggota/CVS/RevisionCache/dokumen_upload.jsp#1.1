...
<%@ page import="com.dimata.qdep.form.*" %>
 ...
 <%//
    ...
    DokumenPinjaman fetchRelevant = new DokumenPinjaman();
    try{
        fetchRelevant = PstDokumenPinjaman.fetchExc(longOidDoc);	
    }catch(Exception e){
    ...
    try {
        ...
        try {
            ...
            if(intByteOfObjLength > 0) {
                ...
                if (result == 0) {
                    try {
                        PstDokumenPinjaman.updateFileName(fileName,longOidDoc);
