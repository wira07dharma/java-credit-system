...
String whereClause = PstDokumenPinjaman.fieldNames[PstDokumenPinjaman.FLD_DOKUMEN_ID]+ " = "+oidDokumen;
String orderClause = "";
...
/*switch statement */
iErrCode = ctrlDokumenPinjaman.action(iCommand , oidDokumen);
/* end switch*/
...
msgString =  ctrlDokumenPinjaman.getMessage();
                                              ...
                                              <tr align="left" valign="top"> 
                                                <td height="8"  colspan="3"> 
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <% if(oidDokumen != 0){
                                                            DokumenPinjaman objDokumenPinjaman = new DokumenPinjaman();
                                                            try{
                                                                 objDokumenPinjaman = PstDokumenPinjaman.fetchExc(oidDokumen);
                                                            }catch(Exception exc){
                                                                 objDokumenPinjaman = new DokumenPinjaman();
                                                            }
                                                      %>
                                                    <tr align="left" valign="top"> 
                                                      <td height="14" valign="middle" colspan="3" class="listedittitle"> 
                                                        <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                                          <tr> 
                                                            ...
                                                            <td width="2%">:</td>
                                                            <td width="81%"><strong><%=objDokumenPinjaman.getNamaDokumen()%></strong></td>
                                                          </tr>
                                                          <tr> 
                                                            <td width="17%"><strong><%=strText[SESS_LANGUAGE][1]%></strong></td>
                                                            <td width="2%">:</td>
                                                            <td width="81%"><strong><%=objDokumenPinjaman.getDeskripsi()%></strong></td>
                                                          </tr>
                                                        </table>
                                                      </td>
                                                    </tr>
													...
													<table width="100%" border="0">
													 <tr align="left" valign="top"> 
													  ...
													  <tr>
														...
														<td><input type="file" name="FRM_FIELD_NAMA_FILE" size="60" height="100"></td>
													  </tr>
													</table>
