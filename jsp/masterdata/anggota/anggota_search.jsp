...
<%
    ...
    Vector listNasabahIndividu = SessAnggota.listJoinContactClassAssign(0, 0, " cc." + PstContactClass.fieldNames[PstContactClass.FLD_CLASS_TYPE] + " = '" + PstContactClass.CONTACT_TYPE_MEMBER + "'", order);
    if (print == 0) {
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearchAnggota() {
                ...
                document.frmAnggota.action = "anggota_search.jsp?anggota_number=" + anggota_number + "&anggota_name=" + anggota_name;
                document.frmAnggota.submit();
            }
        ...
        <script language="javascript">
            $(document).ready(function () {
                ...
                function runDataTable() {
                    dataTablesOptions("#individuTableElement", "tableIndividuTableElement", "AjaxAnggota", "listIndividu", null);
                }
