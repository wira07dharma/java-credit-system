...
function cmdEdit(oid, name){
	self.opener.document.forms.<%=FrmBussinessCenter.FRM_BUSSINESS_CENTER%>.<%=FrmBussinessCenter.fieldNames[FrmBussinessCenter.FRM_CONTACT_ID]%>.value = oid;
	self.opener.document.forms.<%=FrmBussinessCenter.FRM_BUSSINESS_CENTER%>.<%=FrmBussinessCenter.fieldNames[FrmBussinessCenter.FRM_CONTACT_ID]%>_TEXT.value = name;	
    self.close();
}
