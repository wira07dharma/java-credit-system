            ...
            <form name="frm_contactlist" method="post" action="">
              ...
              <table width="100%" cellspacing="1" cellpadding="1" >
                ...
                <tr align="left"> 
                  ...
                  <td  width="1%"  valign="top">:</td>
                  <td  width="86%"  valign="top"><table width="100%">				  	
					<% 
					   int iCount = 0;						
					   int iMaxColumn = 4;
                ...
                <tr align="left"> 
                  ...
                  <td  width="1%"  valign="top">:</td>
                  <td  width="86%"  valign="top">&nbsp; 
                    <input type="text" name="<%=FrmContactList.fieldNames[FrmContactList.FRM_FIELD_EMAIL_COMPANY]%>" value="<%=contactList.getEmailCompany()%>" size="15">
