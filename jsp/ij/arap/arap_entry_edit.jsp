...
String strBack = strBack = SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_FOREIGN ? "Back To "+PstArApMain.stTypeArAp[1][arapType]+ " List": "Kembali Ke Daftar "+PstArApMain.stTypeArAp[0][arapType];
...
Vector lArap = new Vector(); 
if(arapType==PstArApMain.TYPE_AR){    
   	lArap = PstAccountLink.getVectObjListAccountLink(0,PstPerkiraan.ACC_GROUP_PIUTANG);
	...
	lPaymentCmb.add(PstAccountLink.getVectObjListAccountLink(0,PstPerkiraan.ACC_GROUP_REVENUE));
	lPaymentCmb.add(PstAccountLink.getVectObjListAccountLink(0,PstPerkiraan.ACC_GROUP_RETAINED_EARNING));

}else{
	lArap = PstAccountLink.getVectObjListAccountLink(0,PstPerkiraan.ACC_GROUP_CURRENCT_LIABILITIES);
	lPaymentCmb.add(PstAccountLink.getVectObjListAccountLink(0,PstPerkiraan.ACC_GROUP_CASH));
	lPaymentCmb.add(PstAccountLink.getVectObjListAccountLink(0,PstPerkiraan.ACC_GROUP_BANK));
	lPaymentCmb.add(PstAccountLink.getVectObjListAccountLink(0,PstPerkiraan.ACC_GROUP_EXPENSE));
	lPaymentCmb.add(PstAccountLink.getVectObjListAccountLink(0,PstPerkiraan.ACC_GROUP_RETAINED_EARNING));
}
                                  ...
                                  <tr>
                                    ...
                                    <td width="27%" height="25">
                                      ...
                                      if(vUsrCustomDepartment!=null && vUsrCustomDepartment.size()>0)
                                      {
                                       ...
                                       if(lArap!=null&&lArap.size()>0){
								for(int i=0;i<lArap.size();i++){
									Perkiraan perkiraan =(Perkiraan)lArap.get(i);
