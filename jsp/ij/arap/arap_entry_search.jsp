            ...
            <form name="frmsearch" method="post" action="">
              ...
              <table width="100%" border="0" cellspacing="3" cellpadding="2">
                ...
                <tr id=searchar>
                  <td width="16%" height="80%">&nbsp;</td>
                  <td width="1%">&nbsp;</td>
                  <td width="83%"><input type="submit" name="Search" value="<%=strSearchAr%>" onClick="javascript:cmdSearchAR()"></td>			
                </tr>
                <tr id=searchap>
                  <td width="16%" height="80%">&nbsp;</td>
                  <td width="1%">&nbsp;</td>
                  <td width="83%"><input type="submit" name="Search" value="<%=strSearchAp%>" onClick="javascript:cmdSearchAP()"></td>			
                </tr>
                <%if((privAdd)){%>
                <tr id=ar>
