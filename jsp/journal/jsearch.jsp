...
{
	"Jurnal Umum","Journal Inquiries"
};

public static final String searchTitle[] =
{
	"Pencarian Jurnal Umum","General Journal"
};
...
<script language="JavaScript">
	...
	function cmdUpdateVoucher(){
		...
		document.frmjournal.target="_self";
		document.frmjournal.action="jsearch.jsp";
		document.frmjournal.submit();
	}
	<%}%>
	      ...
	      <input type="hidden" name="edit_journal" value="<%=iEditJournal%>">
			  ...
			  <tr>
				...
				<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#99CCCC">
					<tr>
						<td>
							<table width="100%" class="search08">
                <tr>
                  <td colspan="3">&nbsp;
                      ...
                      <tr>
                        <td>
						  ...
						  <%if(isUseDatePicker.equalsIgnoreCase("Y")){%>										   										   
										  ...
										  <%}%>                          
						  <%//=ControlDate.drawDate(FrmSrcJurnalUmum.fieldNames[FrmSrcJurnalUmum.FRM_SEARCH_START_DATE], startDateCondition, 0, interval)%>
                ...
                <tr>
                  ...
                  <td width="1%"><b>:</b></td>
                  <td width="89%">&nbsp;&nbsp;
                    <input type="text" name="<%=FrmSrcJurnalUmum.fieldNames[FrmSrcJurnalUmum.FRM_SEARCH_JOURNAL_NUMBER]%>" size="10" value="<%=srcJurnalUmum.getStrJournalNumber()%>">
					<input type="hidden" name="<%=FrmSrcJurnalUmum.fieldNames[FrmSrcJurnalUmum.FRM_SEARCH_VOUCHER]%>" size="10" value="<%=srcJurnalUmum.getVoucher()%>">
					  <input type="hidden" name="<%=FrmSrcJurnalUmum.fieldNames[FrmSrcJurnalUmum.FRM_SEARCH_VOUCHER_NUMBER]%>" size="10" value="<%=srcJurnalUmum.getVoucher()%>">
                  </td>
                </tr>
                <tr>
                      ...
                      <tr>
                        <td>
						  ...
						  String sSelectedSort = String.valueOf(srcJurnalUmum.getOrderBy());
						      vSortKey.add(FrmSrcJurnalUmum.sortFieldNames[SESS_LANGUAGE][0]);
							  vSortValue.add(""+FrmSrcJurnalUmum.SORT_BY_VOUCHER);
							  vSortKey.add(FrmSrcJurnalUmum.sortFieldNames[SESS_LANGUAGE][1]);
							  vSortValue.add(""+FrmSrcJurnalUmum.SORT_BY_DATE);
                ...
                <%if((privAdd)){%>
                <tr>
                  <td height="16" colspan="3"><hr color="#00CCFF" size="0"></td>
                  </tr>
                <tr>
