...
String sAccCode = FRMQueryString.requestString(request,FrmJournalDistribution.fieldNames[FrmJournalDistribution.FRM_COA_CODE]+"_"+iJDistIdx);
String accountName = FRMQueryString.requestString(request,FrmJournalDistribution.fieldNames[FrmJournalDistribution.FRM_COA_NAME]+"_"+iJDistIdx);
String sDebetAmount = FRMQueryString.requestString(request,FrmJournalDistribution.fieldNames[FrmJournalDistribution.FRM_DEBIT_AMOUNT]+"_"+iJDistIdx);
String sCreditAmount = FRMQueryString.requestString(request,FrmJournalDistribution.fieldNames[FrmJournalDistribution.FRM_CREDIT_AMOUNT]+"_"+iJDistIdx);
...
function cmdEdit(jDisIdx, oid,number,name){
	...
	self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.<%=FrmJournalDistribution.fieldNames[FrmJournalDistribution.FRM_ID_PERKIRAAN]%>_<%=iJDistIdx%>.value = oid;
        //alert(self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.<%=FrmJournalDistribution.fieldNames[FrmJournalDistribution.FRM_ID_PERKIRAAN]%>_<%=iJDistIdx%>.value);
	self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.<%=FrmJournalDistribution.fieldNames[FrmJournalDistribution.FRM_COA_CODE]%>_<%=iJDistIdx%>.value = number;
        //alert(self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.<%=FrmJournalDistribution.fieldNames[FrmJournalDistribution.FRM_COA_CODE]%>_<%=iJDistIdx%>);
	self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.<%=FrmJournalDistribution.fieldNames[FrmJournalDistribution.FRM_COA_NAME]%>_<%=iJDistIdx%>.value = name;
        /*
	<%if(dDebetAmount > dCreditAmount){%>
		self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.DEBET.value = "";
		self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.KREDIT.disabled = false;	
		self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.KREDIT.value = "<%=strSisa%>";
	<%}else{%>
		self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.DEBET.value = "<%=dAmountSisa%>";
		self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.KREDIT.value = "";
		self.opener.document.forms.<%=FrmJournalDistribution.FRM_JOURNAL_DISTRIBUTION%>.DEBET.disabled = false;
	<%}%>*/
         //alert("Hi");
	self.close();
}
...
function first(){
	...
	document.frmaccountsearch.action="coasearch_jdis.jsp";
