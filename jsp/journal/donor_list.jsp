...
if(cHeckBoxContact.equalsIgnoreCase("Y")){
...
function cmdEdit(oid, name, address, town, country){  
    	...
    	self.opener.document.forms.frmjournal.<%=FrmJurnalUmum.fieldNames[FrmJurnalUmum.FRM_KETERANGAN]%>.focus();
		self.close();
}
							  ...
							  if(cHeckBoxContact.equalsIgnoreCase("Y")){
								...
								%>			
							 	<tr>				  
								  ...
								  %>
								  <td><input name="<%=frmSrcContactList.fieldNames[frmSrcContactList.FRM_FIELD_TYPE]%>" type="checkbox" <%=disabled%> class="formElemen" value="<%=idxContactClass%>" <%if(getTruedFalse(srcContactList.getType(),idxContactClass)){%>checked<%}%> >
