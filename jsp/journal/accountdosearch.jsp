...
double dDebetAmount = Double.parseDouble(sDebetAmount);
double dCreditAmount = Double.parseDouble(sCreditAmount);
double dSisa = Double.parseDouble(dAmountSisa); 
...
function cmdEdit(oid,number,name){
	self.opener.document.forms.frmjournaldetail.<%=FrmJurnalDetail.fieldNames[FrmJurnalDetail.FRM_IDPERKIRAAN]%>.value = oid;
	self.opener.document.forms.frmjournaldetail.account_code.value = number;
	self.opener.document.forms.frmjournaldetail.account_name.value = name;
	<%if(dDebetAmount > dCreditAmount){%>
		self.opener.document.forms.frmjournaldetail.DEBET.value = "";
		self.opener.document.forms.frmjournaldetail.KREDIT.disabled = false;	
		self.opener.document.forms.frmjournaldetail.KREDIT.value = "<%=strSisa%>";
	<%}else{%>
		self.opener.document.forms.frmjournaldetail.DEBET.value = "<%=dAmountSisa%>";
		self.opener.document.forms.frmjournaldetail.KREDIT.value = "";
		self.opener.document.forms.frmjournaldetail.DEBET.disabled = false;
	<%}%>
	self.close();
}
