...
ctrlContactList.setLanguage(SESS_LANGUAGE);
...
String whClause = PstContactClass.fieldNames[PstContactClass.FLD_CLASS_TYPE]+" IN ("+
...
Vector cntClass = PstContactClass.list(0,0,whClause,"");
              ...
              <table width="100%" cellspacing="1" cellpadding="1" >
                ...
                <!--<tr align="left"> 
                  ...
                  <td  width="86%"  valign="top">&nbsp; 
                    <%
					/* 
						Vector val_parentid = new Vector(1,1); //hidden values that will be deliver on request (oids) 
						Vector key_parentid = new Vector(1,1); //texts that displayed on combo box
						val_parentid.add("0");
						key_parentid.add("No Parent");
						for(int i=0;i<vectContact.size();i++){
							ContactList cntList = (ContactList)vectContact.get(i);
							val_parentid.add(""+cntList.getOID()+"");
							key_parentid.add(cntList.getCompName());
						}
						String select_parentid = ""+contactList.getParentId(); //selected on combo box
					*/	
					%>
                    <%//=ControlCombo.draw(FrmContactList.fieldNames[FrmContactList.FRM_FIELD_PARENT_ID], "formElemen",null, select_parentid, val_parentid, key_parentid,"")%><%=frmContactList.getErrorMsg(FrmContactList.FRM_FIELD_PARENT_ID)%></td>
                </tr>
				-->
                <tr align="left"> 
