...
{
	"Posting Invoice","Invoice To Posted"
};
...
function cmdSearch(qType){
	...
	document.<%=FrmSrcInvoice.FRM_INVOICE%>.action="post_invoice_list.jsp";
                ...
                <tr>
                  ...
                  <td>
				   ...
				   String strPosted = I_DocStatus.fieldDocumentStatus[I_DocStatus.DOCUMENT_STATUS_POSTED];
					...
					sts_value.add(strPosted);
					sts_key.add(""+I_DocStatus.DOCUMENT_STATUS_POSTED);
