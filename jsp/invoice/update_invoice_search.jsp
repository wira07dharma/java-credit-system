...
{
	"Ubah Status Invoice","Update Invoice Status"
};
...
System.out.println("iQueryType search ::::::: "+iQueryType);
...
function cmdSearch(qType){
	...
	document.<%=FrmSrcInvoice.FRM_INVOICE%>.action="update_invoice_list.jsp";
    ...
    <td width="91%" valign="top" align="left" bgcolor="#99CCCC"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr> 
	      ...
	      <input type="hidden" name="<%=FrmSrcInvoice.fieldNames[FrmSrcInvoice.FRM_INVOICE_STATUS]%>" value="<%=I_DocStatus.DOCUMENT_STATUS_FINAL%>">
              ...
              <table width="100%" border="0" cellspacing="3" cellpadding="2">
                ...
                <!-- tr>
                  ...
                  <td>
				   ...
				   String strPosted = I_DocStatus.fieldDocumentStatus[I_DocStatus.DOCUMENT_STATUS_POSTED];
