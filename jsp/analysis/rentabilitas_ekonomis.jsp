...
public static String strTitle[][] = {
	{"Periode Laporan","Periode","Tahun","Anda tidak punya hak akses untuk melihat laporan rentabilitas ekonomis !!!"},	
	{"Report Periode","Period","Annual","You don't have privilege to access economic rentability report !!!"}
};
...
public static final String listTitle[] = {
	"Rentabilitas Ekonomis", "Economic Rentability"	
};

public static final String reportTitles[][] = {
    {"Perkiraan" ,"Rincian", "Nilai", "Laba Tahun Berjalan", "Modal", "Hutang Jangka Pendek", "Hutang Jangka Panjang", "Rasio Rentabilitas Ekonomis"},
    {"Account", "Description", "Value", "Laba Tahun Berjalan", "Equity", "Current Liabilities", "Long Term Liabilities", "Equity Rentability Ratio"}
};
                              ...
                              String sDecimalSymbol)
{
    ...
    totalEquity += totalCurrLblties + totalLongTermLblties;
...
Vector vectCurrLblties = new Vector();             // hutang jangka pendek
Vector vectLongTermLblties = new Vector();         // hutang jangka panjang
if (iCommand == Command.VIEW) 
{
	...
	{                           
        ...
        if (SESS_LANGUAGE == com.dimata.util.lang.I_Language.LANGUAGE_FOREIGN) 
        {
            if (iReportType == TYPE_ANNUAL)
            {
                sTitle = "Economy Rentability Analysis Report";
                sTitle += "\nPeriod : " + iYear;                
            }
         ...
         {         
            if (iReportType == TYPE_ANNUAL)
            {
                sTitle = "Laporan Analisa Rentabilitas Ekonomi";
                sTitle += "\nPeriode : " + iYear;                
            }
...
function report() {
    ...
    document.frmCurrentRatio.action = "rentabilitas_ekonomis.jsp";
    document.frmCurrentRatio.submit();
}


function print(){
    var linkPage = "<%=reportroot%>session.analysis.EconomicRentabilityPdf?gettime=<%=System.currentTimeMillis()%>";
            ...
            <form name="frmCurrentRatio" method="post" action="">
             <input type="hidden" name="command" value="<%=iCommand%>">
              ...
              <table width="100%" border="0">
				...
				<%
                 if (iCommand == Command.VIEW) {
                    out.println(drawList(SESS_LANGUAGE, objProfit, vectEquity, vectCurrLblties, vectLongTermLblties, sUserDigitGroup, sUserDecimalSymbol));
                 }
                %>
				</td></tr>
				<% if (iCommand == Command.VIEW) { %>
