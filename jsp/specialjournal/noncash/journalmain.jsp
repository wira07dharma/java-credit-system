        ...
        if(iCommand==Command.POST){
            ...
            if(iCommand==Command.ADD){
                try{					
					...
					System.out.println("Exception on command add :::: "+e.toString());
					objSpecialJournalMain = new SpecialJournalMain();
				}
            }else{
				try{
        ...
        if(iCommand==Command.POST){
            ...
            if(iCommand==Command.NONE){
                try{					
					...
					System.out.println("Eception on command none :::: "+e.toString());
					objSpecialJournalMain = new SpecialJournalMain();
				}
...
if(session.getValue("NON_CASH") != null){
	session.removeValue("NON_CASH");
}
	session.putValue("NON_CASH",vDataToPdf);
...
function cmdopen(){
	...
	myWindow = window.open(url,"src_cnt_noncash_main","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}
...
function printJournal(){
		var linkPage = "<%=reportroot%>report.specialJournal.NonCashJournalPdf";
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content" -->
            <form name="<%=FrmSpecialJournalMain.FRM_SPECIAL_JOURNAL_MAIN%>" method="post" action="">
              ...
              <input type="hidden" name="<%=FrmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_JOURNAL_TYPE]%>" value="<%=I_JournalType.TIPE_SPECIAL_JOURNAL_NON_CASH%>" size="35">
                                  ...
                                  <tr>
                                    <td height="25" colspan="3" ><div align="center">
                                        ...
                                        <tr >
										  ...
										  <% 	if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>
													  <%
														Vector vectCashAccount = PstAccountLink.getVectObjListAccountLink(0, PstPerkiraan.ACC_GROUP_CURRENCT_LIABILITIES);
                                    ...
                                    <td colspan="3"><div align="center">
                                        ...
                                        <tr>
                                          ...
                                          <td><input type="hidden" readonly name="<%=frmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_CONTACT_ID]%>" value="<%=objSpecialJournalMain.getContactId()%>" size="25">
                                            <% if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>													<span class="msgErrComment">
                                          ...
                                          <td width="6%"><b><%=strTitleMain[SESS_LANGUAGE][5]%></b></td>
                                          <td width="1%"><strong>:</strong></td>
                                          <td colspan="2">
										  	<% if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>
										...
										%> 
                                          ...
                                          <td width="17%">
                                            ...
                                            <%}%></td>
											<td width="29%" ><% if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>
											  <font face="Verdana, Arial, Helvetica, sans-serif" color="#FF0033">*)
											  <%if(ctrlErr != ctrlSpecialJournalMain.RSLT_FORM_INCOMPLETE || ctrlErr == ctrlSpecialJournalMain.RSLT_ERR_MEMO){%>
															<%=msgString%></font>
															<%}%>
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td width="3%"><div align="left"><b><%=strTitleMain[SESS_LANGUAGE][8]%></b></div></td>
