...
function cmdEdit(oid, name, address, town, country){
    ...
    %>
		...
		self.opener.document.forms.all.address.innerHTML = address;
		self.opener.document.forms.all.town.innerHTML = town;
		self.opener.document.forms.all.country.innerHTML = country;
				  	...
				  	<%if(iCommand != Command.LIST){%>
				  		<table border="0" cellspacing="2" cellpadding="2" width="100%">
                            <tr align="left" valign="top"> 
                              ...
                              <td width="89%">
							   <%
							   String whClause = PstContactClass.fieldNames[PstContactClass.FLD_CLASS_TYPE]+" = "+PstContactClass.FLD_CLASS_CASHIER;
