...
{
	"Pencarian Jurnal Pendanaan","Fund Receipt"
};
...
<%}%>
    ...
    function cmdopen(){
        ...
        window.open(url,"src_cnt_cash_pay_src","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
    }
            ...
            <form name="frmjournal" method="post" action="">
			  ...
			  <td>
              	<table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="#99CCCC">
					<tr>
						<td>
							<table width="100%" border="0" cellpadding="2" cellspacing="3" class="search06">
                <tr>
                  <td colspan="3">&nbsp;
