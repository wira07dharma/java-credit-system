...
long idContactClassDonor = PstContactClass.getIdContactType(PstContactClass.FLD_CLASS_DONOR);
...
if(session.getValue("FUNDING") != null){
	session.removeValue("FUNDING");
}
	session.putValue("FUNDING",vDataToPdf);
...
function getText(element){
	parserNumberDown(element,false,0,'');
}
...
function cmdopen(){
	...
	myWindow = window.open(url,"src_cnt_cash_pay_main","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}
...
function printJournal(){
		var linkPage = "<%=reportroot%>report.specialJournal.FundingJournalPdf";
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content" -->
            <form name="<%=FrmSpecialJournalMain.FRM_SPECIAL_JOURNAL_MAIN%>" method="post" action="">
			  ...
			  <input type="hidden" name="cont_type_donor" value="<%=idContactClassDonor%>">
              ...
              <input type="hidden" name="<%=FrmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_JOURNAL_TYPE]%>" value="<%=I_JournalType.TIPE_SPECIAL_JOURNAL_FUND%>" size="35">
                              ...
                              <td width="94%" valign="top"><div align="center">
                                  ...
                                  <tr>
                                    <td height="25" colspan="3" ><div align="center">
										...
										%> 
										<%= ControlCombo.draw(frmSpecialJournalMain.fieldNames[frmSpecialJournalMain.FRM_ID_PERKIRAAN],null, selectPerkiraan, key, val, "onChange=\"javascript:changeTotal()\"", "")%> <%}else{
												Perkiraan objPerk = new Perkiraan();
												try{													
                                  ...
                                  <tr>
                                    <td colspan="3"><div align="center">
                                        ...
                                        <tr>
                                          ...
                                          <td width="1%"><strong>:</strong></td>
                                          <td >
									  		  <input type="hidden" readonly name="<%=frmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_CONTACT_ID]%>" value="<%=objSpecialJournalMain.getContactId()%>" size="25">
									  		  <% if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>                                            
                                            		<input type="text" name="<%=frmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_CONTACT_ID]%>_TEXT" value="<%=contactName%>" size="25" onKeyDown="javascript:entContact()">
                                           			<a href="javascript:cmdopen()"><img border="0" src="<%=approot%>/dtree/img/folderopen.gif"></a><span class="msgErrComment"> *) 
                                           			</span>
											<%}else{%>
                                            		<%=contactName%>
                                            <%}%>
                                        ...
                                        <tr>
                                          ...
                                          <td><strong>:</strong></td>
                                          <td><a id="address"></a><%=cekNull(contactList.getBussAddress())%><font face="Verdana, Arial, Helvetica, sans-serif" color="#FF0033">
										  <%if(ctrlErr != ctrlSpecialJournalMain.RSLT_FORM_INCOMPLETE || ctrlErr == ctrlSpecialJournalMain.RSLT_ERR_MEMO){%>
                                        ...
                                        <tr>
                                          ...
                                          <td width="17%">
											...
											%>
										  	<input name="<%=frmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_AMOUNT]%>" type="text" value="<%=strAmount%>" onKeyDown="javascript:getText(this)" maxlength="16">
										  	<%}else{%>
