...
vectSize = objSessSpecialJournal.getCount(srcJurnalUmum, I_JournalType.TIPE_SPECIAL_JOURNAL_REPLACEMENT, PstSpecialJournalMain.STS_KREDIT);
...
Vector listSpecialJournal = objSessSpecialJournal.listJurnalUmum(srcJurnalUmum, start, recordToGet, I_JournalType.TIPE_SPECIAL_JOURNAL_REPLACEMENT, PstSpecialJournalMain.STS_KREDIT);
