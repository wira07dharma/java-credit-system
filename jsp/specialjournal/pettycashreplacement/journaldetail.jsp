...
Vector vListAccount = PstAccountLink.getVectObjListAccountLink(0, PstPerkiraan.ACC_GROUP_PETTY_CASH);
...
function cmdopen(){
	window.open("activity.jsp","src_donor_comp_pcr_det","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}

function cmdopencontact(){
	window.open("donor_list.jsp?src_from=1&&command=<%=Command.LIST%>","src_cnt_pcr_det","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}
									  ...
									  %></td>
										...
										%>
										  ...
										  %>
                                                            ...
                                                            <tr align="right">
                                                              <td width="1%">&nbsp;</td>
                                                              <td colspan="6"><div align="center"><em> </em></div></td>
                                                            </tr>
                                                            <tr>
                                                              <td width="1%">&nbsp;</td>
                                                              <td colspan="6">&nbsp; </td>
