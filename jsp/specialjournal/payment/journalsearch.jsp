...
{
	"Pencarian Jurnal Pembayaran","Payment"
};
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content" -->
            <form name="frmjournal" method="post" action="">
			  ...
			  <tr>
			  <td>
              	<table width="100%" cellpadding="1" cellspacing="0" border="0" bgcolor="#99CCCC">
					<tr>
						<td>
							<table width="100%" border="0" cellpadding="2" cellspacing="3" class="search07">
                <tr>
                  <td colspan="3">&nbsp;
