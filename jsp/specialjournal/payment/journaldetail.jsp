...
public static final String subMasterTitle[] = {
	"Jurnal Payment","Payment Journal"
};
...
public String listJurnalDetail(int iCommand, int language,
                                   ...
                                   SpecialJournalDetailAssignt specialJournalDetailAssign,
								   Vector vlistCurrencyType,int index,String approot, 
								   Vector vListAccount, int errSize, String iconSearchContact){
        ...
        ctrlist.addHeader(strTitle[language][5],"25%");
        ctrlist.addHeader(strTitle[language][6],"50%");
        ...
        for(int i=0; i<objectClass.size(); i++){
			...
			if(vListAccount != null && vListAccount.size() > 0){
                ...
                rowx.add("<input type=\"hidden\" size=\"20\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN]+"\" value=\""+specJournalDetail.getIdPerkiraan()+"\">"+
					"<input type=\"text\" size=\"20\" disabled name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN]+"_TEXT\" value=\""+strNamaPerk+"\">");
				...
				double dAmount = 0;
				if(specJournalDetail.getCurrencyRate() > 0)
					dAmount = specJournalDetail.getAmount()/specJournalDetail.getCurrencyRate();
					
                rowx.add("<input type=\"text\" size=\"20\" name=\"cont_name\" value=\""+name+"\" class=\"hiddenText\" disabled>");
                ...
                rowx.add("<input type=\"text\" disabled size=\"10\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_CURRENCY_RATE]+"_TEXT\" value=\""+/*FRMHandler.userFormatStringDecimal(*/specJournalDetail.getCurrencyRate()/*)*/+"\" class=\"formElemenR\">"+
						"<input type=\"hidden\" size=\"20\"  name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_CURRENCY_RATE]+"\" value=\""+specJournalDetail.getCurrencyRate()+"\">");
                rowx.add("<input type=\"text\" disabled size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_AMOUNT ]+"_TEXT\" value=\""+FRMHandler.userFormatStringDecimal(specJournalDetail.getAmount()/specJournalDetail.getCurrencyRate())+"\" onKeyUp=\"javascript:getText(this)\" class=\"hiddenTextR\">"+
						"<input type=\"hidden\" size=\"20\"  name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_AMOUNT]+"\" value=\""+FRMHandler.userFormatStringDecimal(specJournalDetail.getAmount()/specJournalDetail.getCurrencyRate())+"\">");
                rowx.add("<input type=\"text\" disabled size=\"40\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_DESCRIPTION]+"_TEXT\" value=\""+specJournalDetail.getDescription()+"\">"+
						"<input type=\"hidden\" size=\"20\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_DESCRIPTION]+"\" value=\""+specJournalDetail.getDescription()+"\">");
            }else{
        ...
        if((iCommand==Command.ADD || (iCommand==Command.SAVE && frmSpecialJournalDetail.errorSize()>0)) && vDepartmentOid.size() > 0){
            ...
            rowx.add(ControlCombo.draw(FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_DEPARTMENT_ID], "", null, strSelectedDept, vectDeptKey, vectDeptName)); // <a href=\"javascript:cmdCheck()\">CHK</a>
            //rowx.add(ControlCombo.draw(FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN], null, sSelectedAccount,  vAccKey, vAccValue, "",""));
			rowx.add("<input type=\"hidden\" size=\"20\" disabled name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN]+"\" value=\"\">"+
					"<input type=\"text\" size=\"20\" disabled name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN]+"_TEXT\" value=\"\">");
            String name = "";
            if(contactList.getCompName()==null)
                name = contactList.getPersonName();
            else
                name = contactList.getCompName();
			String strImage = "";
			if(iconSearchContact.equalsIgnoreCase("Y"))
				strImage = "<img border=\"0\" src=\""+approot+"/dtree/img/folderopen.gif\"></a>";
			
			
            rowx.add("<input type=\"text\" size=\"20\" disabled name=\"cont_name\" value=\""+name+"\" class=\"hiddenText\" readOnly><a href=\"javascript:cmdopencontact()\" disable=\"true\">"+strImage);
            rowx.add(ControlCombo.draw(FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_CURRENCY_TYPE_ID], null, sSelectedCurrType, currencytypeid_key, currencytypeid_value, "onChange=\"javascript:changeCurrType()\"", ""));
            rowx.add("<input type=\"text\" size=\"10\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_CURRENCY_RATE]+"\" value=\""+/*FRMHandler.userFormatStringDecimal(*/specialJournalDetail.getCurrencyRate()/*)*/+"\" class=\"formElemenR\" readOnly>");
					//"<input type=\"hidden\"  size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_CURRENCY_RATE]+"\" value=\""+specialJournalDetail.getCurrencyRate()+"\" class=\"hiddenTextR\">");
            rowx.add("<input type=\"text\" disabled size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_AMOUNT ]+"_TEXT\" value=\"\" onKeyUp=\"javascript:getText(this)\" class=\"hiddenTextR\"><a href=\"javascript:cmdopenpayable()\" disable=\"true\"><img border=\"0\" src=\""+approot+"/dtree/img/folderopen.gif\"></a>"+
					"<input type=\"hidden\"  size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_AMOUNT ]+"\" value=\"\" class=\"hiddenTextR\">");
            rowx.add("<input type=\"text\" disabled size=\"40\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_DESCRIPTION]+"_TEXT\" value=\""+specialJournalDetail.getDescription()+"\">"+
					"<input type=\"hidden\"  size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_DESCRIPTION]+"\" value=\"\" class=\"hiddenTextR\">");
        }
...
String strAmount = FRMQueryString.requestString(request, ""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_AMOUNT]+"");
...
String msgErr = "";
	...
	frmSpecialJournalDetail.setDigitSeparator(".");
	frmSpecialJournalDetail.setDecimalSeparator(",");
	...
	msgErr = ctrlSpecialJournalDetailAssignt.getMessage();
        ...
        if(iCommand==Command.SAVE){			
				try{ 
					if(indexEdit==-1){
						...
						//Untuk cek boleh atau tidak boleh dua account yang sama dalam satu list
						int idx = -1;
						if(idx==-1)
					...
					System.out.println("Exception on Save Detail ====> "+e.toString());
				}
...
Vector vListAccount = PstAccountLink.getVectObjListAccountLink(0, PstPerkiraan.ACC_GROUP_CURRENCT_LIABILITIES);
...
Vector vlistStandartRate = PstStandartRate.list(0, 0, sStRateWhereClause, sStRateOrderBy);
	...
	if(session.getValue("objectClass") != null)
		session.removeValue("objectClass");
		
	session.putValue("objectClass",objectClass);
...
function getText(element){
	...
	parserNumberNew(element,true,blc,msg+' '+currCode+' '+strBalance,".",",");
}
...
function cmdopenpayable(){
	
	var url = "payablelist.jsp?src_from=0&command=<%=Command.LIST%>"+
				"&dbalance=<%=dBalance%>&objectClass<%=objectClass%>";
	myWindow = window.open(url,"src_payable_payment_det","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}
...
function changeCurrType()
{
	...
	%>
		case '<%=objStandartRate.getCurrencyTypeId()%>':	
			...
			%>		
			 document.<%=FrmSpecialJournalDetail.FRM_SPECIAL_JOURNAL_DETAIL%>.<%=FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_CURRENCY_RATE]%>.value = "<%=Formater.formatNumber(objStandartRate.getSellingRate(),"###")%>";			 
                      ...
                      <tr>
                        <td width="100%" class="tabtitleactive">
                          <table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
						  	<tr><td></td></tr>
                            <tr>
                              <td width="94%" valign="top"><div align="center">
                                  ...
                                  <tr> 
                                    <td height="25"><div align="center">
										<table width="99%" border="0" cellpadding="1" cellspacing="0" bgcolor="#D6EEFA">
											<tr>
												<td>
													<table width="99%"  border="0" cellpadding="0" cellspacing="0" class="mainJournalOut">
									<tr><td>&nbsp;</td></tr>
                                        <tr> 
										  <td width="1%">&nbsp;</td>
                                  ...
                                  <tr>
                                    <td>&nbsp;&nbsp;<b><font face="Verdana, Arial, Helvetica, sans-serif" size="+1" color="#0000CC"><%=strTableName%></font></b></td>
                                  </tr>
                                  <tr>
                                    <td><div align="center">
										<table width="99%" border="0" cellpadding="1" cellspacing="0" bgcolor="#D6EEFA">
                                  ...
                                  <tr> 
                                    <td><%=listJurnalDetail(iCommand,SESS_LANGUAGE,frmSpecialJournalDetail,objectClass,vDepartmentOid,objSpecialJournalDetail,specialJournalDetailAssignt,vlistCurrencyType,indexEdit,approot,vListAccount,ctrlErrDetail,iconSearchContact)%></td>
                                    </tr>
                                  <tr>
                                    <td class="msgerror">
