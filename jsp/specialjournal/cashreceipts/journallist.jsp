...
vectSize = objSessSpecialJournal.getCount(srcJurnalUmum, I_JournalType.TIPE_SPECIAL_JOURNAL_CASH, PstSpecialJournalMain.STS_DEBET);
...
Vector listSpecialJournal = objSessSpecialJournal.listJurnalUmum(srcJurnalUmum, start, recordToGet, I_JournalType.TIPE_SPECIAL_JOURNAL_CASH, PstSpecialJournalMain.STS_DEBET);
