...
public String listJurnalDetail(int iCommand, int language,
        ...
        for(int i=0; i<objectClass.size(); i++){
			...
			if(vListAccount != null && vListAccount.size() > 0){
                ...
                rowx.add("<input type=\"text\" size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_AMOUNT ]+"\" value=\""+FRMHandler.userFormatStringDecimal(specJournalDetail.getAmount()/specJournalDetail.getCurrencyRate())+"\" onKeyUp=\"javascript:getText(this)\" class=\"hiddenTextR\" maxlength=\""+(strBalanceLength + 2)+"\">");
...
String msgErr = "";
    ...
    //Get objJournalMain from session 
    ...
    /** Instansiasi object CtrlSpecialJournalDetail and FrmSpecialJournalDetail */
	...
	msgString = ctrlSpecialJournalDetail.getMessage();
    SpecialJournalDetail objSpecialJournalDetail = ctrlSpecialJournalDetail.getJurnalDetail();

    // Instansiasi object CtrlSpecialJournalDetailAssignt
    ...
    /** Get vector object class from session */
            ...
            try{ // ini digunakan untuk nyimpan data ke session saat tombol post
                if(indexEdit==-1){
					if(objSpecialJournalDetail.getIdPerkiraan()!=0 &&					
						...
						objSpecialJournalDetail.getCurrencyRate() > 0 &&
...
Vector vListAccount = PstAccountLink.getVectObjListAccountLink(0, PstPerkiraan.ACC_GROUP_REVENUE);
...
function cmdopen(){
	window.open("activity.jsp","src_donor_comp_cash_rcv","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}

function cmdopencontact(){
	window.open("donor_list.jsp?src_from=1&&command=<%=Command.LIST%>","src_cnt_cash_rcv_det","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}
                              ...
                              <td width="94%" valign="top"><div align="center">
                                  ...
                                  <tr> 
									...
									<tr><td>&nbsp;</td></tr>
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td><strong><%=strTitleMain[SESS_LANGUAGE][11]%></strong></td>
                                          <td><strong>:</strong></td>
                                          <td><%=contactNameFr%></td>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                        ...
                                        <tr>
                                          ...
                                          <td><strong><%=strTitleMain[SESS_LANGUAGE][6]%></strong></td>
                                          <td><strong>:</strong></td>
                                          <td><%=cntList.getBussAddress() == null? "-" : cntList.getBussAddress()%></td>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                          ...
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                          <td><div align="left"><%=cntList.getTown() == null? "-" : cntList.getTown()%>&nbsp;&nbsp;&nbsp;&nbsp;<%=cntList.getPostalCodeCompany() == null? "-" : cntList.getPostalCodeCompany()%></div></td>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                          ...
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                          <td><%=cntList.getProvince() == null? "-" : cntList.getProvince()%>,&nbsp;&nbsp;&nbsp;&nbsp;<%=cntList.getCountry() == null? "-" : cntList.getCountry()%></td>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                        </tr>
