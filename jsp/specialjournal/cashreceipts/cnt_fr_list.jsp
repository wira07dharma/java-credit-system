...
if(cHeckBoxContact.equalsIgnoreCase("N")){
	if(iCommand==Command.LIST || iCommand==Command.BACK || iCommand==Command.NONE){	
		 ...
		 long idContactClassCashier = PstContactClass.getIdContactType(PstContactClass.FLD_CLASS_COLLECTOR);
...
function cmdSearch(){
		...
		document.frm_contactlist.action="cnt_fr_list.jsp";
		document.frm_contactlist.submit();
}
...
function cmdEdit(oid, name, address, town, country){
    <%
        if(srcFrom==0){
    %>
        self.opener.document.forms.<%=FrmSpecialJournalMain.FRM_SPECIAL_JOURNAL_MAIN%>.<%=FrmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_FR_CONTACT_ID]%>.value = oid;
        self.opener.document.forms.<%=FrmSpecialJournalMain.FRM_SPECIAL_JOURNAL_MAIN%>.<%=FrmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_FR_CONTACT_ID]%>_TEXT.value = name;
		self.opener.document.all.address_fr.innerHTML = address;
		self.opener.document.all.townfr.innerHTML = town;
		self.opener.document.all.countryfr.innerHTML = country;
		self.opener.document.forms.<%=FrmSpecialJournalMain.FRM_SPECIAL_JOURNAL_MAIN%>.<%=FrmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_DESCRIPTION]%>.focus();
    <%}else{%>
				  	...
				  	<%if(iCommand != Command.LIST){%>
				  		<table border="0" cellspacing="2" cellpadding="2" width="100%">
                            <tr align="left" valign="top"> 
                              ...
                              <td width="89%">
							   <%
							   String whClause = PstContactClass.fieldNames[PstContactClass.FLD_CLASS_TYPE]+" = "+PstContactClass.FLD_CLASS_COLLECTOR;
                            ...
                            <tr align="left" valign="top"> 
                              ...
                              <td width="89%" class="command">&nbsp;&nbsp;<input name="viewListCollector" type="button" onClick="javascript:cmdSearch()" value="<%=strSearchComp%>">
