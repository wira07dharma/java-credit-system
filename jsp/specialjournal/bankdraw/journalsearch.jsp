...
{
	"Pencarian Jurnal Penarikan Bank","Cheque Request"
};
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content" -->
            <form name="frmjournal" method="post" action="">
			  ...
			  <tr>
			  <td>
              <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#99CCCC">
			  	<tr>
					<td>
						<table width="100%" border="0" cellpadding="2" cellspacing="3" class="search03">
                <tr>
                  <td colspan="3">&nbsp;
