...
System.out.println("vListAccount.size() :::::: "+vListAccount.size());
...
function cmdopen(){
	closeWindow();
	myWindow = window.open("activity.jsp","src_donor_comp_bank_draw","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}

function cmdopencontact(){
	closeWindow();
	myWindow = window.open("donor_list.jsp?src_from=1&&command=<%=Command.LIST%>","src_cnt_bank_draw_det","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}
