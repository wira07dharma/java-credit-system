...
public static final String subMasterTitle[] = {
	"Jurnal Setoran Bank","Bank Deposit Journal"
};
...
if(session.getValue("BANK_DEPOSIT") != null){
	...
	session.putValue("BANK_DEPOSIT",vDataToPdf);
...
function changeCurrType()
{
	...
	%>
		case '<%=objStandartRate.getCurrencyTypeId()%>':
			document.<%=FrmSpecialJournalMain.FRM_SPECIAL_JOURNAL_MAIN%>.<%=FrmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_STANDAR_RATE]%>.value = "<%=Formater.formatNumber(objStandartRate.getSellingRate(),"###")%>";
...
function printJournal(){
		var linkPage = "<%=reportroot%>report.specialJournal.DepositJournalPdf";
                ...
                <tr>
                  <td valign="top" height="372">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                      <tr>
					  	<td></td>
                        <td width="99%" class="tabtitleactive">
                          <table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">                            
                            <tr>
                              <td width="100%" valign="top"><div align="center">
                                ...
                                <tr>
                                  <td height="25" colspan="3"><div align="center">
                                    <table width="98%" border="0" cellpadding="1" cellspacing="0" bgcolor="#99CC99">
										<tr>
											<td><div align="center">
                                ...
                                <tr>
                                  <td colspan="3"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3" > </font></div></td>
                                </tr>
                                <tr>
                                  <td colspan="3"><div align="center">
								  	<table width="99%" border="0" cellpadding="1" cellspacing="0" bgcolor="#D6EEFA">
										<tr>
											<td>
												<table width="100%"  border="0" class="mainJournalOut">
                                      <%if(objectClass != null && objectClass.size() > 0 && iCommand != Command.NONE){%>
                                      <tr>
