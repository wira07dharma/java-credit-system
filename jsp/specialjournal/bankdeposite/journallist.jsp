...
vectSize = objSessSpecialJournal.getCount(srcJurnalUmum, I_JournalType.TIPE_SPECIAL_JOURNAL_BANK, PstSpecialJournalMain.STS_DEBET);
...
Vector listSpecialJournal = objSessSpecialJournal.listJurnalUmum(srcJurnalUmum, start, recordToGet, I_JournalType.TIPE_SPECIAL_JOURNAL_BANK, PstSpecialJournalMain.STS_DEBET);
            ...
            <form name="frmsrcju" method="post" action="">
			  ...
			  <td>
				  ...
				  %>
					...
					<tr> 
					  <td height="16" colspan="2" class="command">
					   <%}else{%>
							<%if(periodStatus==ctrlperiode.MSG_NO_PER){%>	
					  <a href="javascript:cmdSetPeriod()"><%=strSetupPeriod%></a>
					  | <a href="javascript:cmdBack()"><%=strBack%></a><%}else{%>
					  </td>
					</tr>
