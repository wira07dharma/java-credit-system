...
public Vector listJurnalDetail(int language, Vector objectClass,String approot, String updateJournal, int iCommand){
        ...
        for(int i=0; i<objectClass.size(); i++){
            ...
            }catch(Exception e){activity = new Activity();}			
...
public Vector listJurnalDetailCoA(int language,Vector objectClass, String updateJournal, int iCommand){
        ControlList ctrlist = new ControlList();
        ctrlist.setAreaWidth("100%");
        ctrlist.setListStyle("listgen");
        ctrlist.setTitleStyle("listgentitle");
...
FrmSrcContactList frmSrcContactList = new FrmSrcContactList();
	...
	try{
		...
		System.out.println("Exception on get data from HTTP session ::: "+e.toString());
	}	
    if(objectClass==null)
        ...
        if(iCommand==Command.POST){
			if(objSpecialJournalMain.getAmount() != 0 && 
				...
				try{ // ini digunakan untuk nyimpan data ke session saat tombol post
					...
					System.out.println("Eception : Failed insert to session");
				}
			}else{
				objSpecialJournalMain.setAmount(objSpecialJournalMain.getAmount() * objSpecialJournalMain.getStandarRate());
			}
...
Vector vectCashAccount = PstAccountLink.getVectObjListAccountLink(0, PstPerkiraan.ACC_GROUP_PETTY_CASH);
...
if(iJournalBaseOn == 1){
	...
	vDetail =(Vector)listJurnalDetailCoA(SESS_LANGUAGE, objectClass, updateJournal, iCommand); 
}
...
if(session.getValue("PETTY_CASH") != null){
	session.removeValue("PETTY_CASH");
}
	session.putValue("PETTY_CASH",vDataToPdf);			 
%>
<!-- End of JSP Block -->
...
function cmdopen(){
	...
	myWindow = window.open(url,"src_cnt_pettycash_main","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}
...
function changeTotal()
{
	...
	switch(iCurrType){
		...
		<%if(iCommand != Command.EDIT){%>
		default:
			document.<%=FrmSpecialJournalMain.FRM_SPECIAL_JOURNAL_MAIN%>.total_val_balance.value = 0;
...
function printJournal(){
		var linkPage = "<%=reportroot%>report.specialJournal.PettyCashJournalPdf";
        ...
        <tr> 
          <td valign="top"><!-- #BeginEditable "content" -->
            <form name="<%=FrmSpecialJournalMain.FRM_SPECIAL_JOURNAL_MAIN%>" method="post" action="">
              ...
              <input type="hidden" name="<%=FrmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_JOURNAL_TYPE]%>" value="<%=I_JournalType.TIPE_SPECIAL_JOURNAL_PETTY_CASH%>" size="35">
                                    ...
                                    <td height="25" colspan="3"><div align="center">
                                        ...
                                        <tr>
                                          ...
                                          <td><input type="hidden" readonly name="<%=frmSpecialJournalMain.fieldNames[FrmSpecialJournalMain.FRM_CONTACT_ID]%>" value="<%=objSpecialJournalMain.getContactId()%>" size="25">
                                            <% if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>
                                            		...
                                            		<a href="javascript:cmdopen()"><img border="0" src="<%=approot%>/dtree/img/folderopen.gif"></a> *) </span>
                                            <%}else{%>
                                            		<%=contactName%>
                                            <%}%>
										  </td>
                                          <td width="8%"><b><%=strTitleMain[SESS_LANGUAGE][5]%></b></td>
										  ...
										  <% if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>
												...
												<span class="fielderror">*) <font face="Verdana, Arial, Helvetica, sans-serif" >
                                        ...
                                        <tr>
                                          ...
                                          <td width="16%">
                                            ...
                                            <%}%></td>
											<td width="20%" nowrap><% if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td width="8%"><div align="left"><b><%=strTitleMain[SESS_LANGUAGE][8]%></b></div></td>
                                          <td width="2%"><strong>:</strong></td>
                                          <td colspan="6">
										  <% if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td colspan="2">&nbsp;</td>
                                          <td colspan="6"><font face="Verdana, Arial, Helvetica, sans-serif">
                                        ...
                                        <tr>
                                          ...
                                          <td colspan="6"><span class="style4">
                                            <% if(updateJournal.equalsIgnoreCase("Y") || (iCommand != Command.EDIT)){%>                                            
									...
									<%if(objectClass != null && objectClass.size() > 0){%>
									  ...
									  <tr>
                                        ...
                                        <td width="89%">
													...
													<span class="style4"><font face="Verdana, Arial, Helvetica, sans-serif"  >
