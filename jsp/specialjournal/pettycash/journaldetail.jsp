...
public static final String subMasterTitle[] = {
	"Jurnal Kas Kecil","Petty Cash Journal"
};
...
public String getAccountName(Perkiraan objPerkiraan, int language){
...
public String listJurnalDetail(int iCommand, int language,
        ...
        for(int i=0; i<objectClass.size(); i++){
			...
			dSaldoBudget = specJournalDetail.getBudgetBalance();
			...
			if(vListAccount != null && vListAccount.size() > 0){
                ...
                rowx.add("<textarea rows=\"1\" name=\"act_desc\">"+activity.getDescription()+"</textarea><a href=\"javascript:cmdopen()\" disable=\"true\"><img border=\"0\" src=\""+approot+"/dtree/img/folderopen.gif\"></a>");
				rowx.add("<input type=\"text\" size=\"40\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_BUDGET_BALANCE]+"\" value=\""+FRMHandler.userFormatStringDecimal(dSaldoBudget)+"\">");
                String name = "";
				...
				String actDesc = "";
				if(activity.getDescription() != null && activity.getDescription().length() > 30)
					actDesc = (activity.getDescription()).substring(0,30)+"......";
					else
				...
				rowx.add("<div align=\"left\"><a href=\"javascript:cmdEdit('"+i+"')\">"+actDesc+"</a></div>");
        ...
        if((iCommand==Command.ADD || (iCommand==Command.SAVE && frmSpecialJournalDetail.errorSize()>0)) && vDepartmentOid.size() > 0){
            ...
            rowx.add(ControlCombo.draw(FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_DEPARTMENT_ID], "", null, strSelectedDept, vectDeptKey, vectDeptName)); // <a href=\"javascript:cmdCheck()\">CHK</a>
            rowx.add("<textarea rows=\"1\" name=\"act_desc\">"+activity.getDescription()+"</textarea><a href=\"javascript:cmdopen()\" disable=\"true\"><img border=\"0\" src=\""+approot+"/dtree/img/folderopen.gif\"></a>");
			rowx.add("<input type=\"text\" size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_BUDGET_BALANCE]+"\" value=\"\" class=\"hiddenTextR\">");
            String name = "";
            if(contactList.getCompName()==null)
                name = contactList.getPersonName();
            else
...
public String listJurnalDetailCoA(int iCommand, int language,
                                   FrmSpecialJournalDetail  frmSpecialJournalDetail,
                                   Vector objectClass, Vector vDepartmentOid,
                                   SpecialJournalDetail specialJournalDetail,
                                   SpecialJournalDetailAssignt specialJournalDetailAssign,Vector vlistCurrencyType,
				   int index,String approot, Vector vListAccount,int errSize, 
				   int strBalanceLength, String sAccForPettyCash){
        ControlList ctrlist = new ControlList();
        ctrlist.setAreaWidth("100%");
        ctrlist.setListStyle("listgen");
        ctrlist.setTitleStyle("listgentitle");
        ...
        for(int i=0; i<objectClass.size(); i++){
            Vector temp = (Vector)objectClass.get(i);	    	
            SpecialJournalDetail specJournalDetail = (SpecialJournalDetail)temp.get(0); // if ada
            SpecialJournalDetailAssignt specialJournalDetailAssignt = new SpecialJournalDetailAssignt();
	    dSaldoBudget = specJournalDetail.getBudgetBalance();
		...
		try{
			...
			if(objPerkiraan != null){
				strCoA = getAccountName(objPerkiraan,language);
			}
		}catch(Exception e){}	
	    }		
			// getNama activity
            ...
            if(index==i && (iCommand==Command.EDIT || iCommand==Command.ASK)){
				...
				// get list account
		if(sAccForPettyCash.equalsIgnoreCase("N")){
			sSelectedAccount = ""+specialJournalDetail.getIdPerkiraan();
			if(vListAccount != null && vListAccount.size() > 0){
				for(int a=0; a < vListAccount.size(); a++){
					objPerkiraan = (Perkiraan) vListAccount.get(a);					
		...
		if(sAccForPettyCash.equalsIgnoreCase("N")){
		    ...
		    rowx.add("<input type=\"hidden\" size=\"20\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN]+"\" value=\""+specialJournalDetail.getIdPerkiraan()+"\">"+
		    "<input type=\"text\" size=\"15\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN]+"_TEXT\" value=\""+strCoA+"\" ><a href=\"javascript:cmdopenaccount()\"><img border=\"0\" src=\""+approot+"/dtree/img/folderopen.gif\"></a>");		   
		}		
		String name = "";
                if(contactList.getCompName()==null)
                    name = contactList.getPersonName();
                    ...
                    name = contactList.getCompName();
                rowx.add("<input type=\"text\" size=\"15\" name=\"cont_name\" value=\""+name+"\" class=\"hiddenText\" readOnly><a href=\"javascript:cmdopencontact()\" disable=\"true\"><img border=\"0\" src=\""+approot+"/dtree/img/folderopen.gif\"></a>");
                rowx.add(ControlCombo.draw(FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_CURRENCY_TYPE_ID], null, sSelectedCurrType, currencytypeid_key, currencytypeid_value, "onChange=\"javascript:changeCurrType()\"", ""));
                rowx.add("<input type=\"text\" size=\"10\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_CURRENCY_RATE]+"\" value=\""+FRMHandler.userFormatStringDecimal(specJournalDetail.getCurrencyRate())+"\" class=\"formElemenR\">");
		System.out.println("specJournalDetail.getAmount() :::::::::::: "+specJournalDetail.getAmount() / specJournalDetail.getCurrencyRate());		
                rowx.add("<input type=\"text\" size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_AMOUNT ]+"\" value=\""+FRMHandler.userFormatStringDecimal(specJournalDetail.getAmount()/specJournalDetail.getCurrencyRate())+"\" onKeyUp=\"javascript:getText(this)\" class=\"hiddenTextR\">");
                rowx.add("<input type=\"text\" size=\"40\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_DESCRIPTION]+"\" value=\""+specJournalDetail.getDescription()+"\">");
            }else{
		String actDesc = "";
		if(activity.getDescription() != null && activity.getDescription().length() > 30)
		    ...
		    actDesc = activity.getDescription();
                rowx.add(deptObject.getDepartment());
                rowx.add("<div align=\"left\"><a href=\"javascript:cmdEdit('"+i+"')\">"+strCoA+"</a></div>");
                rowx.add("<div align=\"left\">"+contactList.getCompName()==null?contactList.getPersonName():contactList.getCompName()+"</div>");
                rowx.add("<div align=\"center\">"+objectCurrencyType.getCode()+"</div>");
                rowx.add("<div align=\"right\">"+FRMHandler.userFormatStringDecimal(specJournalDetail.getCurrencyRate())+"</div>");
                rowx.add("<div align=\"right\">"+Formater.formatNumber((specJournalDetail.getAmount() / specJournalDetail.getCurrencyRate()), "##,###.##")+"</div>");
		...
		rowx.add("<input type=\"hidden\" size=\"20\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN]+"\" value=\"\">"+
		"<input type=\"text\" size=\"15\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN]+"_TEXT\" value=\"\"><a href=\"javascript:cmdopenaccount()\"><img border=\"0\" src=\""+approot+"/dtree/img/folderopen.gif\"></a>");
	    }
	    String name = "";
            if(contactList.getCompName()==null)
                name = contactList.getPersonName();
            ...
            rowx.add("<input type=\"text\" size=\"10\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_CURRENCY_RATE]+"\" value=\""+FRMHandler.userFormatStringDecimal(specialJournalDetail.getCurrencyRate())+"\" class=\"formElemenR\" readOnly>");
            rowx.add("<input type=\"text\" size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_AMOUNT ]+"\" value=\""+FRMHandler.userFormatStringDecimal(specialJournalDetail.getAmount()/specialJournalDetail.getCurrencyRate())+"\" onKeyUp=\"javascript:getText(this)\" class=\"hiddenTextR\" maxlength=\""+(strBalanceLength + 3)+"\">");
            rowx.add("<input type=\"text\" size=\"25\" name=\""+FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_DESCRIPTION]+"\" value=\""+specialJournalDetail.getDescription()+"\">");
        }
    ...
    public int cekDataActivity(SpecialJournalDetail specialJournalDetail,
        ...
        if(list!=null && list.size()>0){
			...
			specialJournalDetail.getDescription() == specJournalDetail.getDescription()
                        ){
                    return k;
                }
            }
...
double dEditAmount = FRMQueryString.requestDouble(request, FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_AMOUNT ]);
...
if(iCommand == Command.EDIT && dBalance == 0){
	dBalance = dEditAmount;
}
...
Vector vListAccount = new Vector(1,1);
 vListAccount = PstAccountLink.getVectObjListAccountLink(0, PstPerkiraan.ACC_GROUP_EXPENSE);
...
function cmdopenaccount(){
	var strUrl = "accountdosearch.jsp?command=<%=Command.LIST%>"+
				 "&account_group=0"+
				 "&account_number="+document.<%=FrmSpecialJournalDetail.FRM_SPECIAL_JOURNAL_DETAIL%>.<%=FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_ID_PERKIRAAN]%>_TEXT.value;				 
...
function getText(element){
	...
	parserNumber(element,false,blc,msg+' '+currCode+' '+strBalance);	
}

function cmdopen(){
	closeWindow();
	myWindow = window.open("activity.jsp","src_donor_comp_pettycash_det","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}

function cmdopencontact(){
	closeWindow();
	myWindow = window.open("donor_list.jsp?src_from=1&&command=<%=Command.LIST%>","src_donor_comp_pettycash_det","height=500,width=800,status=yes,toolbars=no,menubar=no,location=no,scrollbars=yes");
}
          ...
          <td valign="top"><!-- #BeginEditable "content" -->
            <form name="<%=FrmSpecialJournalDetail.FRM_SPECIAL_JOURNAL_DETAIL%>" method="post" action="">
			 ...
			 <input type="hidden" name="balance_amount" value="<%=dBalance%>">
              <%if(iJournalBaseOn == 0){%>
              <input type="hidden" name="<%=FrmSpecialJournalDetail.fieldNames[FrmSpecialJournalDetail.FRM_BUDGET_BALANCE]%>" value="<%=objSpecialJournalDetail.getBudgetBalance()%>" size="35">
			  <%}%>
			  <%if(iJournalBaseOn == 1){%>
                            ...
                            <tr>
                              <td width="94%" valign="top"><div align="center">
                                                ...
                                                <td width="9%"><strong>:</strong></td>
                                                  ...
                                                  <%
                                                    ...
                                                    if(vSaldoAkhir!=null && vSaldoAkhir.size()>0){
														...
														System.out.println("Double.parseDouble((String)temp.get(1) ===> "+Double.parseDouble((String)temp.get(1)));
                                                        salakhir = salakhir - objSpecialJournalMain.getAmount();
														System.out.println("objSpecialJournalMain.getAmount() ===> "+objSpecialJournalMain.getAmount());
                                                    }
                                                  %>
                                  ...
                                  <tr> 
                                    <td colspan="2">
									<%if(iJournalBaseOn == 1){%>
										<%=listJurnalDetail(iCommand,SESS_LANGUAGE,frmSpecialJournalDetail,objectClass,vDepartmentOid,objSpecialJournalDetail,specialJournalDetailAssignt,vlistCurrencyType,indexEdit,approot,vListAccount,ctrlErrDetail,strBalanceLength)%>
									<%}else{%>
										<%=listJurnalDetailCoA(iCommand,SESS_LANGUAGE,frmSpecialJournalDetail,objectClass,vDepartmentOid,objSpecialJournalDetail,specialJournalDetailAssignt,vlistCurrencyType,indexEdit,approot,vListAccount,ctrlErrDetail,strBalanceLength,sAccForPettyCash)%>
									<%}%>
									</td>
                                  </tr>
                                  <tr>
