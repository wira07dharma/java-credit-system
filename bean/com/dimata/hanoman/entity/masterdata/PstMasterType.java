  ...
  //  public static final int TYPE_ITEM_UNIT 		= 7;
   ...
   /* public static final String[] typeMaster =
    ...
    public static JSONObject fetchJSON(long oid){
            ...
            try {
                MasterType enMasterType = PstMasterType.fetchExc(oid);
                object.put(PstMasterType.fieldNames[PstMasterType.FLD_MASTER_TYPE_ID], enMasterType.getOID());
                object.put(PstMasterType.fieldNames[PstMasterType.FLD_MASTER_NAME], enMasterType.getMasterName());
                object.put(PstMasterType.fieldNames[PstMasterType.FLD_MASTER_CODE], enMasterType.getMasterCode());
                object.put(PstMasterType.fieldNames[PstMasterType.FLD_TYPE_GROUP], enMasterType.getTypeGroup());
                object.put(PstMasterType.fieldNames[PstMasterType.FLD_DESCRIPTION], enMasterType.getDescription());
            }catch(Exception exc){}
    ...
    public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstMasterType.fieldNames[PstMasterType.FLD_MASTER_TYPE_ID],0);
         if (oid > 0){
          MasterType enMasterType = new MasterType();
          enMasterType.setOID(jSONObject.optLong(PstMasterType.fieldNames[PstMasterType.FLD_MASTER_TYPE_ID],0));
          enMasterType.setMasterName(jSONObject.optString(PstMasterType.fieldNames[PstMasterType.FLD_MASTER_NAME],""));
          enMasterType.setMasterCode(jSONObject.optString(PstMasterType.fieldNames[PstMasterType.FLD_MASTER_CODE], ""));
          enMasterType.setTypeGroup(jSONObject.optInt(PstMasterType.fieldNames[PstMasterType.FLD_TYPE_GROUP],0));
          enMasterType.setDescription(jSONObject.optString(PstMasterType.fieldNames[PstMasterType.FLD_DESCRIPTION],""));

          boolean chekOidMaterial = PstMasterType.checkOID(oid);
          try{
              if(chekOidMaterial){
                  PstMasterType.updateExc(enMasterType);
              }else{
                  PstMasterType.insertByOid(enMasterType);
              }
          }catch(Exception exc){}
         }
      }
   return oid;
    ...
    public static long insertByOid(MasterType entMasterType) throws DBException {
        try {
      PstMasterType pstMasterType = new PstMasterType(0);
      pstMasterType.setString(FLD_MASTER_NAME, entMasterType.getMasterName());
      pstMasterType.setString(FLD_MASTER_CODE, entMasterType.getMasterCode());
      pstMasterType.setString(FLD_DESCRIPTION, entMasterType.getDescription());
      pstMasterType.setInt(FLD_TYPE_GROUP, entMasterType.getTypeGroup());
      pstMasterType.insertByOid(entMasterType.getOID());
    } catch (DBException dbe) {
      throw dbe;  
