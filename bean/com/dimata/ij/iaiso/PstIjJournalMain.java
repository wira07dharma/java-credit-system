...
//            System.out.println("Sql : " + sql);
  ...
  /**
   * Get OID of IjJournalMain object for specified 'RefBoDocOID' and
   * 'RefBoDocNumber'
   *
   * @param lRefBoDocOid
  ...
  public static long generateIjJournal(IjJournalMain objIjJournalMain, Vector vectOfObjIjJurDetail) {
    ...
    try {
      ...
      long oidOfIjJournalMain = PstIjJournalMain.getIjJournalMainOID(objIjJournalMain.getRefBoDocOid(), objIjJournalMain.getRefBoDocNumber());
