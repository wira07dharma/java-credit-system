...
public class SessPaymentOnLGR {
    ...
    public long genJournalOfObjPaymentOnLGR(long lLocationOid, IjPaymentOnLGRDoc objIjPaymentOnLGRDoc, int iDocTypeReference, IjEngineParam objIjEngineParam)    
    {
        ...
        Vector vectOfObjIjJurDetail = new Vector(1,1);                 
            ...
            Vector vectObjIjJDOfPayment = genVectObjIjJDOfPayment(lLocationOid, objIjPaymentOnLGRDoc, hashStandartRate);                                                            
     ...
     * @created by Edhy
     */    
    private Vector genVectObjIjJDOfPayment(long lLocationOid, IjPaymentOnLGRDoc objIjPaymentOnLGRDoc, Hashtable hashStandartRate)
    {                
    ...
    {                
        ...
        // Ambil Account Mapping Goods Received
