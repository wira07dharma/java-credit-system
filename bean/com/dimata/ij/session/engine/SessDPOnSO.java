...
public class SessDPOnSO {
    ...
    public static String strJournalNote[] =
            {
                "Transaksi DP pada saat penerimaan order, dokumen referensi : ",
    ...
    public long genJournalOfObjDPOnSO(long lLocationOid, IjDPOnSODoc objIjDPOnSODoc, int iDocTypeReference, IjEngineParam objIjEngineParam) {
        ...
        System.out.println("objIjDPOnSODoc : objIjDPOnSODoc 1 : "+objIjDPOnSODoc.getLTransCurrency());
        ...
        if (objIjEngineParam.getIConfPayment() == I_IJGeneral.CFG_PAY_DP_PI_A_P) {
            System.out.println("I_IJGeneral.CFG_PAY_DP_PI_A_P");
            // 2.2.1. pembuatan jurnal detail posisi debet (object IjJournalDetail) menggunakan Account Mapping DPonPurchaseOrder.
        ...
        if (objIjEngineParam.getIConfPayment() == I_IJGeneral.CFG_PAY_DP_PI_SALES) {
            System.out.println("I_IJGeneral.CFG_PAY_DP_PI_SALES");
            // 2.2.2. pembuatan jurnal detail posisi debet (object IjJournalDetail) menggunakan Account Mapping DPonPurchaseOrder.
            objIjJDDebet = genObjIjJDOfSalesIncome(objIjDPOnSODoc, totalTransValue, objIjEngineParam);
        }


        //System.out.println("objIjDPOnSODoc : objIjDPOnSODoc :222 "+objIjDPOnSODoc.getLTransCurrency());
        //System.out.println(objIjJDCredit.getJdetAccChart() + " - lkdjfglksdjfkgljsdflkjglksdfjg - " + objIjJDDebet.getJdetAccChart());
        ...
        if (objIjJDCredit.getJdetAccChart() != 0 && objIjJDDebet.getJdetAccChart() != 0) {
            System.out.println("masuk ..... dsfffffffffffffffffffffffffffffff");
            ...
            if ((vectOfObjIjJurDetail != null && vectOfObjIjJurDetail.size() > 1) && bJournalBalance) {
                ...
                System.out.println("masuk ..... dsfffffffffffffffffffffffffffffff 000000000");
    ...
    private IjJournalDetail genObjIjJDOfPayment(IjDPOnSODoc objDPOnSODoc, IjEngineParam objIjEngineParam) {
        ...
        System.out.println(" ayo jangan : " + strStandartRate + " - " + objDPOnSODoc.getDNominal());
        ...
        if (paymentAccChart != 0 && dDPNominal > 0) {
            System.out.println(" ayo jangan kamu error");
    ...
    private IjJournalDetail genObjIjJDOfIncomeInAdvanced(IjDPOnSODoc objDPOnSODoc, double dTotalTransValue, IjEngineParam objIjEngineParam) {
        ...
        // Ambil Account Mapping DPonSalesOrder
