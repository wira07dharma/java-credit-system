...
public class SessPaymentType {
    ...
    private IjJournalMain genObjIjJournalMain(IjPaymentTypeDoc objPaymentTypeDoc, int iDocTypeReference, long lLocationOid, IjEngineParam objIjEngineParam)    
    {
        ...
        objIjJournalMain.setJurTransDate(objPaymentTypeDoc.getDocTransDate());                 
        ...
        objIjJournalMain.setRefBoDocOid(objPaymentTypeDoc.getDocId());                
        objIjJournalMain.setRefBoDocNumber(objPaymentTypeDoc.getDocNumber());      
