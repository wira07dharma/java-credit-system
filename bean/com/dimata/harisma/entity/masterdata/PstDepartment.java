...
//                        System.out.println("prev.......................");
    ...
    public static Hashtable getListDepartment() {
        Hashtable hListDepartment = new Hashtable();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT * FROM " + TBL_HR_DEPARTMENT;
            ...
            while (rs.next()) {
                ...
                resultToObject(rs, objDepartment);
                hListDepartment.put(objDepartment.getDepartment().toUpperCase(),objDepartment);
            }
            rs.close();
            return hListDepartment;

        } catch (Exception e) {
            System.out.println("Exception on getListDepartment() :::: "+e.toString());
            e.printStackTrace();
        } finally {
            DBResultSet.close(dbrs);
        }
