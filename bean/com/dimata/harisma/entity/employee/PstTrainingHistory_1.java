...
public class PstTrainingHistory_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstTrainingHistory_1(){
	}

	public PstTrainingHistory_1(int i) throws DBException { 
		super(new PstTrainingHistory()); 
	}

	public PstTrainingHistory_1(String sOid) throws DBException { 
	...
	public PstTrainingHistory_1(long lOid) throws DBException { 
		super(new PstTrainingHistory(0)); 
		String sOid = "0"; 
		try { 
