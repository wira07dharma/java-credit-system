...
public class PstPerformanceEvaluation_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstPerformanceEvaluation_1(){
	}

	public PstPerformanceEvaluation_1(int i) throws DBException { 
		super(new PstPerformanceEvaluation()); 
	}

	public PstPerformanceEvaluation_1(String sOid) throws DBException { 
	...
	public PstPerformanceEvaluation_1(long lOid) throws DBException { 
		super(new PstPerformanceEvaluation(0)); 
		String sOid = "0"; 
		try { 
