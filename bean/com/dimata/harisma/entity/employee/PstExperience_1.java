...
public class PstExperience_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstExperience_1(){
	}

	public PstExperience_1(int i) throws DBException { 
		super(new PstExperience()); 
	}

	public PstExperience_1(String sOid) throws DBException { 
	...
	public PstExperience_1(long lOid) throws DBException { 
		super(new PstExperience(0)); 
		String sOid = "0"; 
		try { 
