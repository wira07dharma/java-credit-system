...
public class PstExpCoverage_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstExpCoverage_1(){
	}

	public PstExpCoverage_1(int i) throws DBException { 
		super(new PstExpCoverage()); 
	}

	public PstExpCoverage_1(String sOid) throws DBException { 
	...
	public PstExpCoverage_1(long lOid) throws DBException { 
		super(new PstExpCoverage(0)); 
		String sOid = "0"; 
		try { 
