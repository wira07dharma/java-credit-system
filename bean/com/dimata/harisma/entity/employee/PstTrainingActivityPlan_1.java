...
public class PstTrainingActivityPlan_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstTrainingActivityPlan_1(){
	}

	public PstTrainingActivityPlan_1(int i) throws DBException { 
		super(new PstTrainingActivityPlan()); 
	}

	public PstTrainingActivityPlan_1(String sOid) throws DBException { 
	...
	public PstTrainingActivityPlan_1(long lOid) throws DBException { 
		super(new PstTrainingActivityPlan(0)); 
		String sOid = "0"; 
		try { 
