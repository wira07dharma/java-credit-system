...
public class PstRecognition_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstRecognition_1(){
	}

	public PstRecognition_1(int i) throws DBException { 
		super(new PstRecognition()); 
	}

	public PstRecognition_1(String sOid) throws DBException { 
	...
	public PstRecognition_1(long lOid) throws DBException { 
		super(new PstRecognition(0)); 
		String sOid = "0"; 
		try { 
