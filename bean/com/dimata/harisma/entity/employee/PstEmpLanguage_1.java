...
public class PstEmpLanguage_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstEmpLanguage_1(){
	}

	public PstEmpLanguage_1(int i) throws DBException { 
		super(new PstEmpLanguage()); 
	}

	public PstEmpLanguage_1(String sOid) throws DBException { 
	...
	public PstEmpLanguage_1(long lOid) throws DBException { 
		super(new PstEmpLanguage(0)); 
		String sOid = "0"; 
		try { 
