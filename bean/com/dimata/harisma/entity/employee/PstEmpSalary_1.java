...
public class PstEmpSalary_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstEmpSalary_1(){
	}

	public PstEmpSalary_1(int i) throws DBException { 
		super(new PstEmpSalary()); 
	}

	public PstEmpSalary_1(String sOid) throws DBException { 
	...
	public PstEmpSalary_1(long lOid) throws DBException { 
		super(new PstEmpSalary(0)); 
		String sOid = "0"; 
		try { 
