...
public class PstEmpAppraisal_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstEmpAppraisal_1(){
	}

	public PstEmpAppraisal_1(int i) throws DBException { 
		super(new PstEmpAppraisal()); 
	}

	public PstEmpAppraisal_1(String sOid) throws DBException { 
	...
	public PstEmpAppraisal_1(long lOid) throws DBException { 
		super(new PstEmpAppraisal(0)); 
		String sOid = "0"; 
		try { 
