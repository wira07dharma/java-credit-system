...
public class PstSpecialAchievement_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstSpecialAchievement_1(){
	}

	public PstSpecialAchievement_1(int i) throws DBException { 
		super(new PstSpecialAchievement()); 
	}

	public PstSpecialAchievement_1(String sOid) throws DBException { 
	...
	public PstSpecialAchievement_1(long lOid) throws DBException { 
		super(new PstSpecialAchievement(0)); 
		String sOid = "0"; 
		try { 
