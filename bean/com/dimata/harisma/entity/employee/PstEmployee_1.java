...
public class PstEmployee_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstEmployee_1(){
	}

	public PstEmployee_1(int i) throws DBException { 
		super(new PstEmployee()); 
	}

	public PstEmployee_1(String sOid) throws DBException { 
	...
	public PstEmployee_1(long lOid) throws DBException { 
		super(new PstEmployee(0)); 
		String sOid = "0"; 
		try { 
