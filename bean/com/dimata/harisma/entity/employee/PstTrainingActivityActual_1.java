...
public class PstTrainingActivityActual_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstTrainingActivityActual_1(){
	}

	public PstTrainingActivityActual_1(int i) throws DBException { 
		super(new PstTrainingActivityActual()); 
	}

	public PstTrainingActivityActual_1(String sOid) throws DBException { 
	...
	public PstTrainingActivityActual_1(long lOid) throws DBException { 
		super(new PstTrainingActivityActual(0)); 
		String sOid = "0"; 
		try { 
