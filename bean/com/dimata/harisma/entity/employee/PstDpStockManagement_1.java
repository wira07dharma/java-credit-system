...
public class PstDpStockManagement_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public PstDpStockManagement_1() {
    }

    public PstDpStockManagement_1(int i) throws DBException {
        super(new PstDpStockManagement());
    }

    public PstDpStockManagement_1(String sOid) throws DBException {
    ...
    public PstDpStockManagement_1(long lOid) throws DBException {
        super(new PstDpStockManagement(0));
        String sOid = "0";
        try {
