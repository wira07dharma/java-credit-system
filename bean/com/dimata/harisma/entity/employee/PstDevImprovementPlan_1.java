...
public class PstDevImprovementPlan_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstDevImprovementPlan_1(){
	}

	public PstDevImprovementPlan_1(int i) throws DBException { 
		super(new PstDevImprovementPlan()); 
	}

	public PstDevImprovementPlan_1(String sOid) throws DBException { 
	...
	public PstDevImprovementPlan_1(long lOid) throws DBException { 
		super(new PstDevImprovementPlan(0)); 
		String sOid = "0"; 
		try { 
