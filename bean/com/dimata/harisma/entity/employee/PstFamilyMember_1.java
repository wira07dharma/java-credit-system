...
public class PstFamilyMember_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstFamilyMember_1(){
	}

	public PstFamilyMember_1(int i) throws DBException { 
		super(new PstFamilyMember()); 
	}

	public PstFamilyMember_1(String sOid) throws DBException { 
	...
	public PstFamilyMember_1(long lOid) throws DBException { 
		super(new PstFamilyMember(0)); 
		String sOid = "0"; 
		try { 
