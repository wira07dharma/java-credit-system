...
public class PstEmpEducation_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstEmpEducation_1(){
	}

	public PstEmpEducation_1(int i) throws DBException { 
		super(new PstEmpEducation()); 
	}

	public PstEmpEducation_1(String sOid) throws DBException { 
	...
	public PstEmpEducation_1(long lOid) throws DBException { 
		super(new PstEmpEducation(0)); 
		String sOid = "0"; 
		try { 
