...
public class PstCareerPath_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstCareerPath_1(){
	}

	public PstCareerPath_1(int i) throws DBException { 
		super(new PstCareerPath()); 
	}

	public PstCareerPath_1(String sOid) throws DBException { 
	...
	public PstCareerPath_1(long lOid) throws DBException { 
		super(new PstCareerPath(0)); 
		String sOid = "0"; 
		try { 
