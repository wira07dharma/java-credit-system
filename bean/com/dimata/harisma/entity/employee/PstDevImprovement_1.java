...
public class PstDevImprovement_1 extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
	...
	public PstDevImprovement_1(){
	}

	public PstDevImprovement_1(int i) throws DBException { 
		super(new PstDevImprovement()); 
	}

	public PstDevImprovement_1(String sOid) throws DBException { 
	...
	public PstDevImprovement_1(long lOid) throws DBException { 
		super(new PstDevImprovement(0)); 
		String sOid = "0"; 
		try { 
