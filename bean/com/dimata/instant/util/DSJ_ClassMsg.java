...
public class DSJ_ClassMsg
{
    public static final int OK                   = 0;
    public static final int ERR_UNKNOWN          = 1;
    public static final int ERR_NOT_FOUND        = 2;
	public static final int ERR_ALREADY_EXISTS   = 3;
    public static final int ERR_PROCESS_FAIL     = 4;
    public static final int ERR_IN_PARAM_LACK    = 5;
    public static final int ERR_OBJECT_NOT_FOUND = 6;

    public static final int USER_ALREADY_EXIST 	= 7;
	...
	*/
    ...
    {
	        if ( (idx>-1) && (idx < DSJ_ClassMsg.errMessages.length))
