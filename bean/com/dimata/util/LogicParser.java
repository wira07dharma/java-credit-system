...
public class LogicParser 
{
    ...
    public static Vector textSentence(String sentence) 
    {
        ...
        // replace all "atau" with OR
        // edited by Edhy
        sentence = StringReplace.replaceString(sentence, "atau", ENGLISH[WORD_OR]);
        
        // replace all commas with OR
        String strTemp1 = "";
        String strTemp2 = "";
        String strSentence = "";                
        StringTokenizer st0 = new StringTokenizer(sentence,",");                             
        int iTemp=0;
        ...
        while (st.hasMoreTokens()) 
        {
            ...
            else 
            {
                ...
                {
                    if( (strTemp1.equals(ENGLISH[WORD_OR])) ||  (strTemp1.equals(ENGLISH[WORD_AND])) || (strTemp1.equals(ENGLISH[WORD_LIKE]))) 
                    {
                        vct.add(strWord);
                        strWord="";
                        vct.add(strTemp1);
