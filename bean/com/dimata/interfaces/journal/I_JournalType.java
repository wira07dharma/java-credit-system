...
{    
    ...
    public static final int TIPE_SPECIAL_JOURNAL_CASH          = 4;
    public static final int TIPE_SPECIAL_JOURNAL_BANK          = 5;
    public static final int TIPE_SPECIAL_JOURNAL_PETTY_CASH    = 6;
    public static final int TIPE_SPECIAL_JOURNAL_REPLACEMENT   = 7;
    public static final int TIPE_SPECIAL_JOURNAL_BANK_TRANSFER = 8;
    public static final int TIPE_SPECIAL_JOURNAL_NON_CASH      = 9;
    public static final int TIPE_SPECIAL_JOURNAL_FUND          = 10;
    public static final int TIPE_SPECIAL_JOURNAL_PAYMENT       = 11;
