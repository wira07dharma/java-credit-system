...
public class DBHandler implements I_DBType {
    ...
    public static int DBSVR_TYPE  = DBSVR_MYSQL;  // this is a DB Handler for PostgreSQL
    ...
    throws DBException {
        if(!configLoaded) {
            ...
            try {
                ...
                configLoaded = true;
                System.out.println("#*********************************************************#");
                System.out.println("                        LOAD DBCONFIG POS");
                System.out.println("");
    ...
    throws DBException {
        loadConfig();
        return getDetailsInt("", this.fieldNames[i]);
    }
    ...
    throws DBException {
        ...
        return execQuery(sql, this.pstName);
    }
