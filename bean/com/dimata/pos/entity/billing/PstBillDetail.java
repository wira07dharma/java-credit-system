...
public class PstBillDetail extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language, I_BillingDetail {
    ...
    public static final int FLD_TOTAL_SERVICE = 17;
    public static final int FLD_TOTAL_TAX = 18;
    ...
    public static ArrayList listFromApi(int limitStart, int recordToGet, String whereClause, String order) {
        ...
        try {
            ...
            JSONObject jo = WebServices.getAPIWithParam("", posApiUrl + "/bill/billdetail-param/list", param);
            try {
    ...
    public static JSONObject fetchJSON(long oid){
        ...
        try {
            ...
            object.put(PstBillDetail.fieldNames[PstBillDetail.FLD_TOTAL_TAX], ""+billdetail.getTotalTax());
            object.put(PstBillDetail.fieldNames[PstBillDetail.FLD_TOTAL_SERVICE], ""+billdetail.getTotalSvc());
        } catch (Exception exc) {
        }
        return object;
    }
    ...
    public static void jsonToObject(JSONObject jo, Billdetail billdetail){
        try {
            billdetail.setOID(jo.optLong(PstBillDetail.fieldNames[PstBillDetail.FLD_BILL_DETAIL_ID],0));
            billdetail.setBillMainId(jo.optLong(PstBillDetail.fieldNames[PstBillDetail.FLD_BILL_MAIN_ID],0));
            billdetail.setUnitId(jo.optLong(PstBillDetail.fieldNames[PstBillDetail.FLD_UNIT_ID],0));
            billdetail.setMaterialId(jo.optLong(PstBillDetail.fieldNames[PstBillDetail.FLD_MATERIAL_ID],0));
            billdetail.setItemName(jo.optString(PstBillDetail.fieldNames[PstBillDetail.FLD_ITEM_NAME],""));
            billdetail.setItemPrice(jo.optDouble(PstBillDetail.fieldNames[PstBillDetail.FLD_ITEM_PRICE],0));
            billdetail.setQty(jo.optDouble(PstBillDetail.fieldNames[PstBillDetail.FLD_QUANTITY],0));
            billdetail.setTotalPrice(jo.optDouble(PstBillDetail.fieldNames[PstBillDetail.FLD_TOTAL_PRICE],0));
            billdetail.setSku(jo.optString(PstBillDetail.fieldNames[PstBillDetail.FLD_SKU],""));
            billdetail.setCost(jo.optDouble(PstBillDetail.fieldNames[PstBillDetail.FLD_COST],0));
            billdetail.setTotalTax(jo.optDouble(PstBillDetail.fieldNames[PstBillDetail.FLD_TOTAL_TAX],0));
            billdetail.setTotalSvc(jo.optDouble(PstBillDetail.fieldNames[PstBillDetail.FLD_TOTAL_SERVICE],0));
        } catch (Exception e) {
            System.out.println(e.toString());
        }
    }
