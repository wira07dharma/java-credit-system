...
public class PstBillMain  extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_APP_USER_SALES_ID = 59;
    public static final int FLD_FLIGHT_NUMBER = 60;
    public static final int FLD_SHIPPING_FEE = 61;
    public static final int FLD_ADMIN_FEE = 62;
    public static final int FLD_TAX_INCLUDE = 63;
    public static final int FLD_FIRST_PAYMENT_DATE = 64;
    ...
    public static BillMain fetchExc(long oid) throws DBException {
        try {
            ...
            billMain.setShippingFee(pstBillMain.getdouble(FLD_SHIPPING_FEE));
            billMain.setAdminFee(pstBillMain.getdouble(FLD_ADMIN_FEE));
            billMain.setTaxInclude(pstBillMain.getInt(FLD_TAX_INCLUDE));
            billMain.setFirstPaymentDate(pstBillMain.getDate(FLD_FIRST_PAYMENT_DATE));
    ...
    public static long insertExc(BillMain billMain) throws DBException {
        try {
            ...
            pstBillMain.setDouble(FLD_SHIPPING_FEE, billMain.getShippingFee());
            pstBillMain.setDouble(FLD_ADMIN_FEE, billMain.getAdminFee());            
            pstBillMain.setInt(FLD_TAX_INCLUDE, billMain.getTaxInclude());
            pstBillMain.setDate(FLD_FIRST_PAYMENT_DATE, billMain.getFirstPaymentDate());
    ...
    public static void resultToObject(ResultSet rs, BillMain billMain) {
        try {
            ...
            billMain.setShippingFee(rs.getDouble(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_FEE]));
            billMain.setAdminFee(rs.getDouble(PstBillMain.fieldNames[PstBillMain.FLD_ADMIN_FEE]));
            billMain.setTaxInclude(rs.getInt(PstBillMain.fieldNames[PstBillMain.FLD_TAX_INCLUDE]));
   ...
   public static Vector getCountShortcut(int limitStart, BillMain bMain, int recordToGet, String whereClause, String order) {
    ...
    public static long syncExc(JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            ...
            if (oid > 0) {
                ...
                billMain.setBillDate(Formater.formatDate(jSONObject.optString(PstBillMain.fieldNames[PstBillMain.FLD_BILL_DATE],  "0000-00-00"), "yyyy-MM-dd"));
                ...
                billMain.setStatus(jSONObject.optInt(PstBillMain.fieldNames[PstBillMain.FLD_BILL_STATUS], 0));
                ...
                billMain.setOrderDate(Formater.formatDate(jSONObject.optString(PstBillMain.fieldNames[PstBillMain.FLD_IS_SERVICE],  "0000-00-00"), "yyyy-MM-dd"));
                ...
                billMain.setShippingFee(jSONObject.optDouble(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_FEE], 0));
                billMain.setAdminFee(jSONObject.optDouble(PstBillMain.fieldNames[PstBillMain.FLD_ADMIN_FEE], 0));

                boolean checkOid = PstBillMain.checkOID(oid);
                try {
                    if (checkOid) {
    ...
    public static JSONObject fetchJSON(long oid){
      ...
      try {
         ...
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID], billMain.getOID());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_CASH_CASHIER_ID], billMain.getCashCashierId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_LOCATION_ID], billMain.getLocationId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_BILL_DATE], billMain.getBillDate());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_INVOICE_NO], billMain.getInvoiceNo());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_APPUSER_ID], billMain.getAppUserId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIFT_ID], billMain.getShiftId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_DISC_TYPE], billMain.getDiscType());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_DISCOUNT], billMain.getDiscount());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_TAX_PERCENTAGE], billMain.getTaxPercentage());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_TAX_VALUE], billMain.getTaxValue());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SERVICE_PCT], billMain.getServicePct());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SERVICE_VALUE], billMain.getServiceValue());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_BILL_STATUS], billMain.getBillStatus());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SALES_CODE], billMain.getSalesCode());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_INVOICE_NUMBER], billMain.getInvoiceNumber());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_INVOICE_COUNTER], billMain.getInvoiceCounter());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_TRANS_TYPE], billMain.getTransType());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_DOC_TYPE], billMain.getDocType());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_CASH_PENDING_ORDER_ID], billMain.getCashPendingOrderId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_CUSTOMER_ID], billMain.getCustomerId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_TRANSCATION_TYPE], billMain.getTransctionType());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_TRANSACTION_STATUS], billMain.getTransactionStatus());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_COVER_NUMBER], billMain.getCoverNumber());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SPECIAL_ID], billMain.getSpecialId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SPECIAL_FLAG], billMain.getSpecialFlag());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_PARENT_ID], billMain.getParentId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_GUEST_NAME], billMain.getGuestName());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_NOTES], billMain.getNotes());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_CURRENCY_ID], billMain.getCurrencyId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_RATE], billMain.getRate());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_ADDRESS], billMain.getShippingAddress());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_CITY], billMain.getShippingCity());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_PROVINCE], billMain.getShippingProvince());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_COUNTRY], billMain.getShippingCountry());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_ZIP], billMain.getShippingZipCode());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_PH_NUMBER], billMain.getShippingPhoneNumber());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_MOBILE_NUMBER], billMain.getShippingMobilePhone());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_FAX], billMain.getShippingFax());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_AMOUNT], billMain.getAmount());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_PAID_AMOUNT], billMain.getPaidAmount());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_DISC_PCT], billMain.getDiscPct());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_INVOICING_ID], billMain.getInvoicingId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_STATUS_INVOICING], billMain.getStatusInv());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_DO_PERSON_ID], billMain.getDoPersonId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_TYPE_SALES_ORDER], billMain.getTypeSalesOrder());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_PARENT_SALES_ORDER_ID], billMain.getParentSalesOrderId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_DATE_TERM_OF_PAYMENT], billMain.getDateTermOfPayment());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_STOCK_LOCATION_ID], billMain.getStockLocationId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_ROOM_ID], billMain.getRoomID());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_TABLE_ID], billMain.getTableId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_PAX_NUMBER], billMain.getPaxNumber());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_EVENT_NAME], billMain.getEventName());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_ORDER_DATE], billMain.getOrderDate());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_IS_SERVICE], billMain.getIsService());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_ID_NEGARA], billMain.getNegaraId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_GENDER], billMain.getGender());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_STATUS], billMain.getStatus());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_DATE], billMain.getShippingDate());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_APP_USER_SALES_ID], billMain.getAppUserSalesId());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_FLIGHT_NUMBER], billMain.getFlightNumber());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_SHIPPING_FEE], billMain.getShippingFee());
         object.put(PstBillMain.fieldNames[PstBillMain.FLD_ADMIN_FEE], billMain.getAdminFee());
      }catch(Exception exc){}
      return object;
   }
