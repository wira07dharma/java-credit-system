...
public class FrmBillMain extends FRMHandler implements I_FRMInterface, I_FRMType {
	...
	public static final int FRM_FIELD_BILL_DATE =  2 ;
        ...
        public static final int FRM_FIELD_APP_USER_SALES_ID = 56;
        public static final int FRM_FIELD_ADMIN_FEE = 57;
        public static final int FRM_FIELD_SHIPPING_FEE = 58;
	...
	public void requestEntityObject(BillMain billMain)
		...
		try
			...
			this.requestParam();
                        ...
                        billMain.setAppUserSalesId(getInt(FRM_FIELD_APP_USER_SALES_ID));
                        billMain.setAdminFee(getInt(FRM_FIELD_ADMIN_FEE));
                        billMain.setShippingFee(getInt(FRM_FIELD_SHIPPING_FEE));
		}
                catch(Exception e)
                {
