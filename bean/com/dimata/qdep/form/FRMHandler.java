...
public class FRMHandler implements I_FRMType {
    ...
    public static String SYSTEM_DECIMAL_SYMBOL 	= ".";
    public static String SYSTEM_DIGIT_GROUP 	= ",";
        ...
        try{
            for(int i = 0; i < fieldNames.length; i++) {
                ...
                try{
                   ...
                   System.out.println("Exception on check param ::::: "+e.toString());
                }
                /**/
            }
        }catch(Exception e){
           System.out.println("Exception on request param :::: "+e.toString());
        }    
    }
   ...
   /* protected Date getDate(int idx) {
    ...
    private String getParamDate(String baseName) {
        try {
            ...
            System.out.println("FrmHandler.getParamDate 3 :::::::::::::::::::::::::::::::::::::::::::::: ");
            if(yr<1 || mn<1 || dy<1){
                return "";
            }
    ...
    //Added by DWI 2007-11-07
    //Overide variable value for variabel "SYSTEM_DECIMAL_SYMBOL"
    public void setDecimalSystemSeparator(String decSeparator){
        this.SYSTEM_DECIMAL_SYMBOL = decSeparator;
    }
    
    //Overide variable value for variabel "SYSTEM_DIGIT_GROUP"
     public void setDigitSystemSeparator(String decDigit){
        this.SYSTEM_DIGIT_GROUP = decDigit;
    }
     
    public static void main(String args[]){
        String result = userFormatStringDecimal(1000000.25);
