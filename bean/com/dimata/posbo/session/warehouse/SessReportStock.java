...
//
            ...
            while (rs.next()) {
                ...
                material.setAveragePrice(rs.getDouble(9));// * standarRate);
                material.setOID(rs.getLong(10));
                material.setGondolaCode(rs.getString(14));
                vectTemp.add(material); 
    ...
    public static Vector getReportStockAllBarcode(SrcReportStock srcReportStock, boolean isZero, int limitStart, int recordToGet) {
        DBResultSet dbrs = null;
        Vector result = new Vector(1, 1);
        try {
            String sql = "SELECT M." + PstMaterial.fieldNames[PstMaterial.FLD_SKU] + // SKU
...
//
    ...
    public static Vector getStockValueBarcode(SrcReportStock srcReportStock, boolean isZero) {
        DBResultSet dbrs = null;
        Vector result = new Vector(1, 1);
        try {
    ...
    public static int getItemCountMaterial(SrcReportStock srcReportStock) {
        DBResultSet dbrs = null;
        int count=0;
        try {
            String sql = "SELECT COUNT(M." + PstMaterial.fieldNames[PstMaterial.FLD_MATERIAL_ID] + ") AS COUNT_LIST" +
