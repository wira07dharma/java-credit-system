...
public class SessMatStockOpname {
    ...
    //Report Lost Correction Stock
    //public static Vector searchMatStockOpnameLost(SrcMatStockOpname srcmatstockopname, int start, int recordToGet) {
        //return getListLostCorrectionStok(srcmatstockopname, start, recordToGet,locationOpname, categoryOpname);
    //}
