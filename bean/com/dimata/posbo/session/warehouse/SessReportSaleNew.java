...
import com.dimata.pos.form.search.*; 
...
public class SessReportSaleNew {
    ...
    public static final String SESS_SRC_REPORT_SALE_NEW = "SESSION_SRC_REPORT_SALE_NEW";
    public static final String SESS_SRC_REPORT_SALE_REKAP_NEW = "SESSION_SRC_REPORT_SALE_REKAP_NEW";
    public static final String SESS_SRC_REPORT_SALE_REKAP_KATEGORI_NEW = "SESSION_SRC_REPORT_SALE_KATEGORI_NEW";
    public static final String SESS_SRC_REPORT_SALE_REKAP_SUPPLIER_NEW = "SESSION_SRC_REPORT_SALE_SUPPLIER_NEW";
    public static final String SESS_SRC_REPORT_SALE_CASH_NEW = "SESSION_SRC_REPORT_SALE_CASH_NEW";
    public static final String SESS_SRC_REPORT_SALE_CC_NEW = "SESSION_SRC_REPORT_SALE_CC_NEW";
    public static final String SESS_SRC_REPORT_SALE_GRAFIK_BARANG_NEW = "SESSION_SRC_REPORT_SALE_GRAFIK_BARANG_NEW";
    public static final String SESS_SRC_REPORT_SALE_GRAFIK_KATEGORI_NEW = "SESSION_SRC_REPORT_SALE_GRAFIK_KATEGORI_NEW";
     ...
     * @return
     */
    public static Vector getReportSaleNew(SrcReportSale srcReportSale) {
        DBResultSet dbrs = null;
        Vector result = new Vector(1, 1);
        try {   
            String sql = " SELECT " +
    ...
    public static Vector getReportSaleRekapTanggal(SrcReportSale srcReportSale) {
        ...
        try {
            String sql = "SELECT SUM(CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_TOTAL_PRICE] + ") AS SUM_PRICE" + // TOTAL_PRICE
                    ", SUM(CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_QUANTITY] + " * CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_COST] + ") AS HPP" + // QTY * COST
                    ", SUM((CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_QUANTITY] + " * CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_ITEM_PRICE] + ") - CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_TOTAL_PRICE] + ") AS DISC" + // QTY * ITEM_PRICE - TOTAL_PRICE
            ...
            while (rs.next()) {
                ...
                temp.add(Formater.formatDate(rs.getDate(4), "dd-MM-yyyy"));
     ...
     * @return
     */
    public static Vector getReportSaleRekapKategoriNew(SrcReportSale srcReportSale) {
        DBResultSet dbrs = null;
        Vector result = new Vector(1, 1);
        try {
            /*String sql = "SELECT "+
            ...
            String sql = "SELECT " +
                    ...
                    ", CAT." + PstCategory.fieldNames[PstCategory.FLD_NAME] + " AS NM_CATEG " + // NAME" +
                    //", SCAT." + PstSubCategory.fieldNames[PstSubCategory.FLD_NAME] + " AS NM_SUB_CATEG " + // name 
                    ", MAT." + PstMaterial.fieldNames[PstMaterial.FLD_MERK_ID] +" AS MERK_ID "+ // MERK_ID" +
                    ", MERK." + PstMerk.fieldNames[PstMerk.FLD_NAME]+ " AS MERK_NAME "+//MERK_NAME 
                    " FROM " + PstMaterial.TBL_MATERIAL + " MAT" + // material
                    //" INNER JOIN " + PstSubCategory.TBL_SUB_CATEGORY + " SCAT" + // sub_category
                    //" ON SCAT." + PstSubCategory.fieldNames[PstSubCategory.FLD_SUB_CATEGORY_ID] + //SUB_CATEGORY_ID+
                    //" = MAT." + PstMaterial.fieldNames[PstMaterial.FLD_SUB_CATEGORY_ID] + // SUB_CATEGORY_ID+ 
                    ...
                    " ON CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_BILL_MAIN_ID] + // CASH_BILL_MAIN_ID+
                    " = CBM." + PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID]+" " + // CASH_BILL_MAIN_ID;
                    " INNER JOIN "+PstMerk.TBL_MAT_MERK+" MERK " +
            ...
            //System.out.println("start using doctype");
            String strDocType= "";
            if ((srcReportSale.getDocType ()>= 0)) {
                //System.out.println("using doctype");
                int [] transMode= getTransMode (srcReportSale);  
                strDocType= " CBM." + PstBillMain.fieldNames[PstBillMain.FLD_DOC_TYPE]+"="+transMode[DOC_TYPE]+" " +
                    " AND " +
                    " CBM." + PstBillMain.fieldNames[PstBillMain.FLD_TRANSCATION_TYPE]+"="+transMode[TRANSACTION_TYPE]+" " +
            ...
            while (rs.next()) {
                ...
                temp.add(new Long(rs.getLong("MERK_ID"))); 
                temp.add(rs.getString("MERK_NAME"));
                result.add(temp); 
     ...
     * @return
     */
    public static Vector getReportSaleRekapSupplierByDoc(SrcReportSale srcReportSale) {
        DBResultSet dbrs = null;
        Vector result = new Vector(1, 1);
        try {
            String sql = " SELECT " +
                    ...
                    "(" +
                    "(" +  
                    "(" + PstBillDetail.TBL_CASH_BILL_DETAIL + " CBD" + // cash_bill_detail
                    " INNER JOIN " + PstBillMain.TBL_CASH_BILL_MAIN + " CBM" + //  cash_bill_main
                    " ON CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_BILL_MAIN_ID] + // CASH_BILL_MAIN_ID
                    " = CBM." + PstBillMain.fieldNames[PstBillMain.FLD_BILL_MAIN_ID] + // CASH_BILL_MAIN_ID
                    " ) INNER JOIN " + PstMaterial.TBL_MATERIAL + " MAT" + // material
                    " ON CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_MATERIAL_ID] + // MATERIAL_ID
                    " = MAT." + PstMaterial.fieldNames[PstMaterial.FLD_MATERIAL_ID] + // MATERIAL_ID
                    " ) INNER JOIN " + PstMerk.TBL_MAT_MERK+ " MERK" + // merk
                    " ON MAT." + PstMaterial.fieldNames[PstMaterial.FLD_MERK_ID] + // MERK_ID
                    " = MERK." + PstMerk.fieldNames[PstMerk.FLD_MERK_ID] + // MERK_ID
...
//            }
 ...
 /**wsutaya
    ...
    public static Vector getReportSaleAllNew(SrcReportSale srcReportSale) {
        ...
        try {
            String sql = " SELECT " +
                    ...
                    ", CBD."+PstBillDetail.fieldNames[PstBillDetail.FLD_COST]+ " AS BUYPRC "+ //HARGA BELI
                    ", CBD."+PstBillDetail.fieldNames[PstBillDetail.FLD_ITEM_NAME]+ " AS ITEM_NAME "+ //ITEM BARANG
                    ", CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_ITEM_PRICE] + " AS ITEMPRC" +  //HARGA JUAL
                    ", SUM(CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_TOTAL_PRICE] + ") AS TOTALPRC" + //TOTAL JUAL
                    ", SUM((CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_QUANTITY] + // QTY
                    " * CBD." + PstBillDetail.fieldNames[PstBillDetail.FLD_ITEM_PRICE] + // ITEM_PRICE
            ...
            while (rs.next()) {
                ...
                cbd.setItemName(rs.getString("ITEM_NAME"));
     ...
     * @return
     */
    private static double sumCategorySale(long oidLocation, Date filterDate, long oidCategory
                                          , Connection koneksi) {
        double hasil = 0.00;
        DBResultSet dbrs = null;
        try {
     ...
     * @created by edhy continued by widi
     */
...
//                    " AS SUB_" + PstSubCategory.fieldNames[PstSubCategory.FLD_NAME] +
                    ", MERK." + PstMerk.fieldNames[PstMerk.FLD_NAME] + 
                    " AS MERK_" + PstMerk.fieldNames[PstMerk.FLD_NAME] +
...
//                    " = SUB." + PstSubCategory.fieldNames[PstSubCategory.FLD_SUB_CATEGORY_ID];
            ...
            sql += " GROUP BY MERK." + PstMerk.fieldNames[PstMerk.FLD_MERK_ID]+ 
            ...
            while (rs.next()) {
                ...
                merk.setName (rs.getString("MERK_" + PstMerk.fieldNames[PstMerk.FLD_NAME])); 
    ...
    public static Vector getDataRekapPenjualan(SrcReportSale srcReportSale) {
        ...
        try {
            ...
            String sQL = "SELECT " +
                    ...
                    " BETWEEN '" + Formater.formatDate(srcReportSale.getDateFrom(), "yyyy-MM-dd")
                    + " "+stTime+"' AND '" + Formater.formatDate(srcReportSale.getDateTo(), "yyyy-MM-dd")
                    + " "+edTime+"'";
    ...
    public static Vector getDataRekapPenjualanByDoc(SrcReportSale srcReportSale) {
        ...
        try {
          Shift shift = PstShift.fetchExc(srcReportSale.getShiftId());
            ...
            String sQL = "SELECT " +
                    ...
                    " WHERE CBM." + PstBillMain.fieldNames[PstBillMain.FLD_BILL_DATE]+"" +
                    " BETWEEN '" + Formater.formatDate(srcReportSale.getDateFrom(), "yyyy-MM-dd")
                    + " "+stTime+"' AND '" + Formater.formatDate(srcReportSale.getDateFrom(), "yyyy-MM-dd") 
                    + " "+edTime+"'"+
        ...
        //System.out.println("==>> SUCCESS getDataRekapPenjualan" );
        return list;
