...
public class SrcSaleReport implements Serializable, Cloneable {
    ...
    public static final int GROUP_BY_SUB_CATEGORY = 6;
    
    
    public static String groupMethod[][] = {
        {"Nama Barang", "Sales", "Supplier", "Kategori", "Lokasi", "Shift", "Tanggal", "Merk"},
        {"Item", "Sales", "Supplier", "Category", "Location", "Shift", "Date", "Mark"}
        
    };
    public static String reportType[][] = {
        {"Penjualan", "Retur", "Hadiah", "Pembayaran Pending Order", "Kredit", "Open Bill"},
        {"Sale", "Return", "Gift", "Pending Order Payment", "Credit Sale", "Open Bill"}
    };
