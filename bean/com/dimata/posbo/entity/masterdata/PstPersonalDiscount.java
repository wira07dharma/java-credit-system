...
public class PstPersonalDiscount extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstPersonalDiscount.fieldNames[PstPersonalDiscount.FLD_PERSONAL_DISC_ID],0);
         if (oid > 0){
          PersonalDiscount personalDiscount = new PersonalDiscount();
          personalDiscount.setOID(jSONObject.optLong(PstPersonalDiscount.fieldNames[PstPersonalDiscount.FLD_PERSONAL_DISC_ID],0));
          personalDiscount.setMaterialId(jSONObject.optLong(PstPersonalDiscount.fieldNames[PstPersonalDiscount.FLD_MATERIAL_ID],0));
          personalDiscount.setPersDiscVal(jSONObject.optDouble(PstPersonalDiscount.fieldNames[PstPersonalDiscount.FLD_PERS_DISC_VALUE],0));
          personalDiscount.setContactId(jSONObject.optLong(PstPersonalDiscount.fieldNames[PstPersonalDiscount.FLD_CONTACT_ID],0));
          personalDiscount.setPersDiscPct(jSONObject.optDouble(PstPersonalDiscount.fieldNames[PstPersonalDiscount.FLD_PERS_DISC_PCT],0));
         boolean checkOidPersonalDiscount = PstPersonalDiscount.checkOID(oid);
          try{
            if(checkOidPersonalDiscount){
               PstPersonalDiscount.updateExc(personalDiscount);
            }else{
               PstPersonalDiscount.insertByOid(personalDiscount);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(PersonalDiscount personalDiscount) throws DBException {
      try {
         PstPersonalDiscount pstPersonalDiscount = new PstPersonalDiscount(0);
         pstPersonalDiscount.setLong(FLD_PERSONAL_DISC_ID, personalDiscount.getOID());
         pstPersonalDiscount.setLong(FLD_MATERIAL_ID, personalDiscount.getMaterialId());
         pstPersonalDiscount.setDouble(FLD_PERS_DISC_VALUE, personalDiscount.getPersDiscVal());
         pstPersonalDiscount.setLong(FLD_CONTACT_ID, personalDiscount.getContactId());
         pstPersonalDiscount.setDouble(FLD_PERS_DISC_PCT, personalDiscount.getPersDiscPct());
         pstPersonalDiscount.insertByOid(personalDiscount.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstPersonalDiscount(0), DBException.UNKNOWN);
