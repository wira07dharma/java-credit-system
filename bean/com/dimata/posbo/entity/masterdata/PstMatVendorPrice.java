...
public static long insertUpdateExc(MatVendorPrice matVdrPrc) throws DBException {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         ...
         object.put(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_LAST_VAT], matVendorPrice.getCurrBuyingPrice());
         object.put(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_CURR_BUYING_PRICE], matVendorPrice.getLastVat());
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_VENDOR_PRICE_ID],0);
         if (oid > 0){
          MatVendorPrice matVendorPrice = new MatVendorPrice();
          matVendorPrice.setOID(jSONObject.optLong(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_VENDOR_PRICE_ID],0));
          matVendorPrice.setMaterialId(jSONObject.optLong(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_MATERIAL_ID],0));
          matVendorPrice.setBuyingUnitId(jSONObject.optLong(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_BUYING_UNIT_ID],0));
          matVendorPrice.setVendorId(jSONObject.optLong(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_VENDOR_ID],0));
          matVendorPrice.setVendorPriceCode(jSONObject.optString(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_VENDOR_PRICE_CODE], ""));
          matVendorPrice.setVendorPriceBarcode(jSONObject.optString(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_VENDOR_PRICE_BARCODE], ""));
          matVendorPrice.setPriceCurrency(jSONObject.optLong(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_PRICE_CURRENCY],0));
          matVendorPrice.setOrgBuyingPrice(jSONObject.optDouble(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_ORG_BUYING_PRICE],0));
          matVendorPrice.setLastDiscount(jSONObject.optDouble(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_LAST_DISCOUNT],0));
          matVendorPrice.setCurrBuyingPrice(jSONObject.optDouble(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_LAST_VAT],0));
          matVendorPrice.setLastVat(jSONObject.optDouble(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_CURR_BUYING_PRICE],0));
          matVendorPrice.setDescription(jSONObject.optString(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_DESCRIPTION], ""));
          matVendorPrice.setLastCostCargo(jSONObject.optDouble(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_LAST_COST_CARGO],0));
          matVendorPrice.setLastDiscount1(jSONObject.optDouble(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_LAST_DISCOUNT_1],0));
          matVendorPrice.setLastDiscount2(jSONObject.optDouble(PstMatVendorPrice.fieldNames[PstMatVendorPrice.FLD_LAST_DISCOUNT_2],0));
         boolean checkOidMatVendorPrice = PstMatVendorPrice.checkOID(oid);
         try{
            if(checkOidMatVendorPrice){
               PstMatVendorPrice.updateExc(matVendorPrice);
            }else{
               PstMatVendorPrice.insertByOid(matVendorPrice);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(MatVendorPrice matVendorPrice) throws DBException {
      try {
         PstMatVendorPrice pstMatVendorPrice = new PstMatVendorPrice(0);
         pstMatVendorPrice.setLong(FLD_VENDOR_PRICE_ID, matVendorPrice.getOID());
         pstMatVendorPrice.setLong(FLD_MATERIAL_ID, matVendorPrice.getMaterialId());
         pstMatVendorPrice.setLong(FLD_BUYING_UNIT_ID, matVendorPrice.getBuyingUnitId());
         pstMatVendorPrice.setLong(FLD_VENDOR_ID, matVendorPrice.getVendorId());
         pstMatVendorPrice.setString(FLD_VENDOR_PRICE_CODE, matVendorPrice.getVendorPriceCode());
         pstMatVendorPrice.setString(FLD_VENDOR_PRICE_BARCODE, matVendorPrice.getVendorPriceBarcode());
         pstMatVendorPrice.setLong(FLD_PRICE_CURRENCY, matVendorPrice.getPriceCurrency());
         pstMatVendorPrice.setDouble(FLD_ORG_BUYING_PRICE, matVendorPrice.getOrgBuyingPrice());
         pstMatVendorPrice.setDouble(FLD_LAST_DISCOUNT, matVendorPrice.getLastDiscount());
         pstMatVendorPrice.setDouble(FLD_LAST_VAT, matVendorPrice.getLastVat());
         pstMatVendorPrice.setDouble(FLD_CURR_BUYING_PRICE, matVendorPrice.getCurrBuyingPrice());
         pstMatVendorPrice.setString(FLD_DESCRIPTION , matVendorPrice.getDescription());
         pstMatVendorPrice.setDouble(FLD_LAST_COST_CARGO, matVendorPrice.getLastCostCargo());
         pstMatVendorPrice.setDouble(FLD_LAST_DISCOUNT , matVendorPrice.getLastDiscount());
         pstMatVendorPrice.setDouble(FLD_LAST_DISCOUNT, matVendorPrice.getLastDiscount());
         pstMatVendorPrice.insertByOid(matVendorPrice.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstMatVendorPrice(0), DBException.UNKNOWN);
      }
      return matVendorPrice.getOID();
   }
}
