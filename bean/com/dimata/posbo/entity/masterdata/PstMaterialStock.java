...
public class PstMaterialStock extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static int refreshCatalogStock(){
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstMaterialStock.fieldNames[PstMaterialStock.FLD_MATERIAL_STOCK_ID],0);
         if (oid > 0){
          MaterialStock materialStock = new MaterialStock();
          materialStock.setOID(jSONObject.optLong(PstMaterialStock.fieldNames[PstMaterialStock.FLD_MATERIAL_STOCK_ID],0));
          materialStock.setPeriodeId(jSONObject.optLong(PstMaterialStock.fieldNames[PstMaterialStock.FLD_PERIODE_ID],0));
          materialStock.setMaterialUnitId(jSONObject.optLong(PstMaterialStock.fieldNames[PstMaterialStock.FLD_MATERIAL_UNIT_ID],0));
          materialStock.setLocationId(jSONObject.optLong(PstMaterialStock.fieldNames[PstMaterialStock.FLD_LOCATION_ID],0));
          materialStock.setQty(jSONObject.optDouble(PstMaterialStock.fieldNames[PstMaterialStock.FLD_QTY],0));
          materialStock.setQtyMin(jSONObject.optDouble(PstMaterialStock.fieldNames[PstMaterialStock.FLD_QTY_MIN],0));
          materialStock.setQtyMax(jSONObject.optDouble(PstMaterialStock.fieldNames[PstMaterialStock.FLD_QTY_MAX],0));
          materialStock.setQtyIn(jSONObject.optDouble(PstMaterialStock.fieldNames[PstMaterialStock.FLD_QTY_IN],0));
          materialStock.setQtyOut(jSONObject.optDouble(PstMaterialStock.fieldNames[PstMaterialStock.FLD_QTY_OUT],0));
          materialStock.setOpeningQty(jSONObject.optDouble(PstMaterialStock.fieldNames[PstMaterialStock.FLD_OPENING_QTY],0));
          materialStock.setClosingQty(jSONObject.optDouble(PstMaterialStock.fieldNames[PstMaterialStock.FLD_CLOSING_QTY],0));
         boolean checkOidMaterialStock = PstMaterialStock.checkOID(oid);
          try{
            if(checkOidMaterialStock){
               PstMaterialStock.updateExc(materialStock);
            }else{
               PstMaterialStock.insertByOid(materialStock);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(MaterialStock materialStock) throws DBException {
      try {
         PstMaterialStock pstMaterialStock = new PstMaterialStock(0);
         pstMaterialStock.setLong(FLD_MATERIAL_STOCK_ID, materialStock.getOID());
         pstMaterialStock.setLong(FLD_PERIODE_ID, materialStock.getPeriodeId());
         pstMaterialStock.setLong(FLD_MATERIAL_UNIT_ID, materialStock.getMaterialUnitId());
         pstMaterialStock.setLong(FLD_LOCATION_ID, materialStock.getLocationId());
         pstMaterialStock.setDouble(FLD_QTY, materialStock.getQty());
         ...
         pstMaterialStock.setDouble(FLD_OPENING_QTY, materialStock.getOpeningQty());
         pstMaterialStock.setDouble(FLD_CLOSING_QTY, materialStock.getClosingQty());
         pstMaterialStock.insertByOid(materialStock.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstMaterialStock(0), DBException.UNKNOWN);
