...
public class PstMemberPoin extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language, I_PersistentExcSynch {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         ...
         object.put(PstMemberPoin.fieldNames[PstMemberPoin.FLD_MEMBER_POINT_ID], memberPoin.getOID());
         object.put(PstMemberPoin.fieldNames[PstMemberPoin.FLD_CASH_BILL_MAIN_ID], memberPoin.getCashBillMainId());
         object.put(PstMemberPoin.fieldNames[PstMemberPoin.FLD_MEMBER_ID], memberPoin.getMemberId());
         object.put(PstMemberPoin.fieldNames[PstMemberPoin.FLD_TRANSACTION_DATE], memberPoin.getTransactionDate());
         object.put(PstMemberPoin.fieldNames[PstMemberPoin.FLD_DEBET], memberPoin.getDebet());
         object.put(PstMemberPoin.fieldNames[PstMemberPoin.FLD_CREDIT], memberPoin.getCredit());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstMemberPoin.fieldNames[PstMemberPoin.FLD_MEMBER_POINT_ID],0);
         if (oid > 0){
          MemberPoin memberPoin = new MemberPoin();
          memberPoin.setOID(jSONObject.optLong(PstMemberPoin.fieldNames[PstMemberPoin.FLD_MEMBER_POINT_ID],0));
          memberPoin.setCashBillMainId(jSONObject.optLong(PstMemberPoin.fieldNames[PstMemberPoin.FLD_CASH_BILL_MAIN_ID],0));
          memberPoin.setMemberId(jSONObject.optLong(PstMemberPoin.fieldNames[PstMemberPoin.FLD_MEMBER_ID],0));
          memberPoin.setTransactionDate(Formater.formatDate(jSONObject.optString(PstMemberPoin.fieldNames[PstMemberPoin.FLD_TRANSACTION_DATE],"0000-00-00"),"yyyy-MM-dd"));
          memberPoin.setDebet(jSONObject.optInt(PstMemberPoin.fieldNames[PstMemberPoin.FLD_DEBET],0));
          memberPoin.setCredit(jSONObject.optInt(PstMemberPoin.fieldNames[PstMemberPoin.FLD_CREDIT],0));
         boolean checkOidPstMemberPoin = PstMemberPoin.checkOID(oid);
          try{
            if(checkOidPstMemberPoin){
               PstMemberPoin.updateExc(memberPoin);
            }else{
               PstMemberPoin.insertByOid(memberPoin);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(MemberPoin memberPoin) throws DBException {
      try {
         PstMemberPoin pstMemberPoin = new PstMemberPoin(0);
         pstMemberPoin.setLong(FLD_MEMBER_POINT_ID, memberPoin.getOID());
         pstMemberPoin.setLong(FLD_CASH_BILL_MAIN_ID, memberPoin.getCashBillMainId());
         pstMemberPoin.setLong(FLD_MEMBER_ID, memberPoin.getMemberId());
         pstMemberPoin.setDate(FLD_TRANSACTION_DATE, memberPoin.getTransactionDate());
         pstMemberPoin.setInt(FLD_DEBET, memberPoin.getDebet());
         pstMemberPoin.setInt(FLD_CREDIT, memberPoin.getCredit());
         pstMemberPoin.insertByOid(memberPoin.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstMemberPoin(0), DBException.UNKNOWN);
