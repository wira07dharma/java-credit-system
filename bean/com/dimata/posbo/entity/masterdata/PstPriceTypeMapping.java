...
public class PstPriceTypeMapping extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static long syncExc(JSONObject jSONObject){
      ...
      long oid = 0;
      if (jSONObject != null){
       priceTypeId = jSONObject.optLong(PstPriceTypeMapping.fieldNames[PstPriceTypeMapping.FLD_PRICE_TYPE_ID],0);
       materialId   = jSONObject.optLong(PstPriceTypeMapping.fieldNames[PstPriceTypeMapping.FLD_MATERIAL_ID],0);
       standartRateId   = jSONObject.optLong(PstPriceTypeMapping.fieldNames[PstPriceTypeMapping.FLD_STANDART_RATE_ID],0);
         if (oid > 0){
          PriceTypeMapping priceTypeMapping = new PriceTypeMapping();
          priceTypeMapping.setPriceTypeId(jSONObject.optLong(PstPriceTypeMapping.fieldNames[PstPriceTypeMapping.FLD_PRICE_TYPE_ID],0));
          priceTypeMapping.setMaterialId(jSONObject.optLong(PstPriceTypeMapping.fieldNames[PstPriceTypeMapping.FLD_MATERIAL_ID],0));
          priceTypeMapping.setStandartRateId(jSONObject.optLong(PstPriceTypeMapping.fieldNames[PstPriceTypeMapping.FLD_STANDART_RATE_ID],0));
          priceTypeMapping.setPrice(jSONObject.optDouble(PstPriceTypeMapping.fieldNames[PstPriceTypeMapping.FLD_PRICE],0));
         boolean checkOidPriceTypeMapping = PstPriceTypeMapping.checkOID(priceTypeId, materialId, standartRateId);
          try{
            if(checkOidPriceTypeMapping){
               PstPriceTypeMapping.updateExc(priceTypeMapping);
            }else{
               PstPriceTypeMapping.insertByOid(priceTypeMapping);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(PriceTypeMapping priceTypeMapping) throws DBException {
      try {
         PstPriceTypeMapping pstPriceTypeMapping = new PstPriceTypeMapping(0);
         pstPriceTypeMapping.setLong(FLD_PRICE_TYPE_ID, priceTypeMapping.getPriceTypeId());
         pstPriceTypeMapping.setLong(FLD_MATERIAL_ID, priceTypeMapping.getMaterialId());
         pstPriceTypeMapping.setLong(FLD_STANDART_RATE_ID, priceTypeMapping.getStandartRateId());
         pstPriceTypeMapping.setDouble(FLD_PRICE, priceTypeMapping.getPrice());
         pstPriceTypeMapping.insertByOid(priceTypeMapping.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstPriceTypeMapping(0), DBException.UNKNOWN);
