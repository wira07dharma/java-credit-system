  ...
  // public PstDiscountQtyMapping(long lOid) throws DBException {
    ...
    public long deleteExc(Entity ent) throws Exception{
      ...
      //public static DiscountQtyMapping fetchExc(long oid) throws DBException{
        try{
            ...
            discountqtymapping.setDiscountValue(pstDiscountQtyMapping.getInt(FLD_DISCOUNT_VALUE));
   ...
   public static JSONObject fetchJSON(long discountTypeId, long currencyTypeId, long locationId, long materialId){
      ...
      try {
         ...
         object.put(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_CURRENCY_TYPE_ID], discountQtyMapping.getCurrencyTypeId());
         object.put(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_LOCATION_ID], discountQtyMapping.getLocationId());
   ...
   public static long syncExc(JSONObject jSONObject){
     // long oid = 0;
      ...
      long currencyTypeId = 0;
      long locationId     = 0;
      long materialId     = 0;
      if (jSONObject != null){
       discountTypeId = jSONObject.optLong(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_DISCOUNT_TYPE_ID],0);
       currencyTypeId = jSONObject.optLong(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_CURRENCY_TYPE_ID],0);
       locationId     = jSONObject.optLong(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_LOCATION_ID],0);
       materialId     = jSONObject.optLong(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_MATERIAL_ID],0);
         if (discountTypeId > 0){
          DiscountQtyMapping discountQtyMapping = new DiscountQtyMapping();
          discountQtyMapping.setDiscountTypeId(jSONObject.optLong(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_DISCOUNT_TYPE_ID],0));
          discountQtyMapping.setCurrencyTypeId(jSONObject.optLong(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_CURRENCY_TYPE_ID],0));
          discountQtyMapping.setLocationId(jSONObject.optLong(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_LOCATION_ID],0));
          discountQtyMapping.setMaterialId(jSONObject.optLong(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_MATERIAL_ID],0));
          discountQtyMapping.setStartQty(jSONObject.optDouble(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_START_QTY],0));
          discountQtyMapping.setToQty(jSONObject.optDouble(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_TO_QTY],0));
          discountQtyMapping.setDiscountValue(jSONObject.optDouble(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_DISCOUNT_VALUE],0));
          discountQtyMapping.setDiscountType(jSONObject.optInt(PstDiscountQtyMapping.fieldNames[PstDiscountQtyMapping.FLD_DISCOUNT_TYPE],0));
        boolean checkOidDiscountQtyMapping = PstDiscountQtyMapping.checkOID(discountTypeId, currencyTypeId, locationId, materialId );
          try{
            if(checkOidDiscountQtyMapping){
               PstDiscountQtyMapping.updateExc(discountQtyMapping);
            }else{
               PstDiscountQtyMapping.insertByOid(discountQtyMapping);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(DiscountQtyMapping discountQtyMapping) throws DBException {
      try {
         PstDiscountQtyMapping pstDiscountQtyMapping = new PstDiscountQtyMapping(0);
         pstDiscountQtyMapping.setLong(FLD_DISCOUNT_TYPE_ID, discountQtyMapping.getDiscountTypeId());
         pstDiscountQtyMapping.setLong(FLD_CURRENCY_TYPE_ID, discountQtyMapping.getCurrencyTypeId());
         ...
         pstDiscountQtyMapping.setDouble(FLD_DISCOUNT_VALUE, discountQtyMapping.getDiscountValue());
         pstDiscountQtyMapping.setInt(FLD_DISCOUNT_TYPE, discountQtyMapping.getDiscountType());
         pstDiscountQtyMapping.insertByOid(discountQtyMapping.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstDiscountQtyMapping(0), DBException.UNKNOWN);
