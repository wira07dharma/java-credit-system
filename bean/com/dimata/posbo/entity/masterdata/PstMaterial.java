...
public class PstMaterial extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language, I_Catalog {
    ...
    public static final int FLD_MATERIAL_DESCRIPTION =33;
    public static final int FLD_COLOR_ID=34;
    ...
    public static Material fetchExc(long oid) throws DBException {
        try {
            ...
            try{material.setGondolaCode(pstMaterial.getString(FLD_GONDOLA_CODE));
            }catch(Exception exc){}
            //for update date
           // try{material.setUpdateDate(pstMaterial.getDate(FLD_UPDATE_DATE));
            //}catch(Exception exc){}
            try{material.setDescription(pstMaterial.getString(FLD_MATERIAL_DESCRIPTION));
            material.setColorId(pstMaterial.getlong(FLD_COLOR_ID));
            }catch(Exception exc){}
    ...
    public static long insertExc(Material material) throws DBException {
        try {
            ...
            pstMaterial.setString(FLD_MATERIAL_DESCRIPTION,  material.getDescription());
            pstMaterial.setLong(FLD_COLOR_ID,  material.getColorId());
    ...
    public static void resultToObject(ResultSet rs, Material material) {
        try {
            ...
            material.setDescription(rs.getString(PstMaterial.fieldNames[PstMaterial.FLD_MATERIAL_DESCRIPTION]));
            material.setColorId(rs.getLong(PstMaterial.fieldNames[PstMaterial.FLD_COLOR_ID]));
        } catch (Exception e) {
        }
    }
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         ...
         object.put(PstMaterial.fieldNames[PstMaterial.FLD_MATERIAL_DESCRIPTION], material.getDescription());
         object.put(PstMaterial.fieldNames[PstMaterial.FLD_COLOR_ID], material.getColorId());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_MATERIAL_ID],0);
         if (oid > 0){
          Material material = new Material();
          material.setOID(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_MATERIAL_ID],0));
          material.setSku(jSONObject.optString(PstMaterial.fieldNames[PstMaterial.FLD_SKU], ""));
          material.setBarCode(jSONObject.optString(PstMaterial.fieldNames[PstMaterial.FLD_BARCODE], ""));
          material.setName(jSONObject.optString(PstMaterial.fieldNames[PstMaterial.FLD_NAME], ""));
          material.setMerkId(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_MERK_ID],0));
          material.setCategoryId(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_CATEGORY_ID],0));
          material.setSubCategoryId(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_SUB_CATEGORY_ID],0));
          material.setDefaultStockUnitId(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_DEFAULT_STOCK_UNIT_ID],0));
          material.setDefaultPrice(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_DEFAULT_PRICE],0));
          material.setDefaultPriceCurrencyId(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_DEFAULT_PRICE_CURRENCY_ID],0));
          material.setDefaultCost(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_DEFAULT_COST],0));
          material.setDefaultCostCurrencyId(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_DEFAULT_COST_CURRENCY_ID],0));
          material.setDefaultSupplierType(jSONObject.optInt(PstMaterial.fieldNames[PstMaterial.FLD_DEFAULT_SUPPLIER_TYPE],0));
          material.setSupplierId(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_SUPPLIER_ID],0));
          material.setPriceType01(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_PRICE_TYPE_01],0));
          material.setPriceType02(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_PRICE_TYPE_02],0));
          material.setPriceType03(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_PRICE_TYPE_03],0));
          material.setMaterialType(jSONObject.optInt(PstMaterial.fieldNames[PstMaterial.FLD_MATERIAL_TYPE],0));
          material.setLastDiscount(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_LAST_DISCOUNT],0));
          material.setLastVat(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_LAST_VAT],0));
          material.setCurrBuyPrice(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_CURR_BUY_PRICE],0));
          material.setExpiredDate(Formater.formatDate(jSONObject.optString(PstMaterial.fieldNames[PstMaterial.FLD_EXPIRED_DATE], "0000-00-00"), "yyyy-MM-dd" ));
          material.setBuyUnitId(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_BUY_UNIT_ID],0));
          material.setProfit(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_PROFIT],0));
          material.setCurrSellPriceRecomentation(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_CURR_SELL_PRICE_RECOMENTATION],0));
          material.setAveragePrice(jSONObject.optDouble(PstMaterial.fieldNames[PstMaterial.FLD_AVERAGE_PRICE],0));
          material.setMinimumPoint(jSONObject.optInt(PstMaterial.fieldNames[PstMaterial.FLD_MINIMUM_POINT],0));
          material.setLastUpdate(Formater.formatDate(jSONObject.optString(PstMaterial.fieldNames[PstMaterial.FLD_LAST_UPDATE], "0000-00-00"), "yyyy-MM-dd"));
          material.setRequiredSerialNumber(jSONObject.optInt(PstMaterial.fieldNames[PstMaterial.FLD_REQUIRED_SERIAL_NUMBER],0));
          material.setProcessStatus(jSONObject.optInt(PstMaterial.fieldNames[PstMaterial.FLD_PROCESS_STATUS],0));
          material.setMatTypeConsig(jSONObject.optInt(PstMaterial.fieldNames[PstMaterial.FLD_CONSIGMENT_TYPE],0));
          material.setGondolaCode(jSONObject.optString(PstMaterial.fieldNames[PstMaterial.FLD_GONDOLA_CODE], ""));
          material.setUpdateDate(Formater.formatDate(jSONObject.optString(PstMaterial.fieldNames[PstMaterial.FLD_UPDATE_DATE], "0000-00-00"), "yyyy-MM-dd"));
          material.setDescription(jSONObject.optString(PstMaterial.fieldNames[PstMaterial.FLD_MATERIAL_DESCRIPTION], ""));
          material.setColorId(jSONObject.optLong(PstMaterial.fieldNames[PstMaterial.FLD_COLOR_ID],0));

          boolean chekOidMaterial = PstMaterial.checkOID(oid);
          try{
              if(chekOidMaterial){
                  PstMaterial.updateExc(material);
              }else{
                  PstMaterial.insertByOid(material);
              }
          }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(Material material) throws DBException {
      try {
         PstMaterial pstMaterial = new PstMaterial(0);
//         pstMaterial.setLong(FLD_MATERIAL_ID, material.getOID());
         pstMaterial.setString(FLD_SKU, material.getSku());
         pstMaterial.setString(FLD_BARCODE, material.getBarCode());
         pstMaterial.setString(FLD_NAME, material.getName());
         pstMaterial.setLong(FLD_MERK_ID, material.getMerkId());
...
//         pstMaterial.setDate(FLD_UPDATE_DATE, material.getUpdateDate());
         pstMaterial.setString(FLD_MATERIAL_DESCRIPTION, material.getDescription());
         pstMaterial.setLong(FLD_COLOR_ID, material.getColorId());
         pstMaterial.insertByOid(material.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstMaterial(0), DBException.UNKNOWN);
