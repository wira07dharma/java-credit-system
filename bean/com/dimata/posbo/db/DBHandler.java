...
public class DBHandler implements I_DBType {
    ...
    public static int DBSVR_TYPE  = DBSVR_MYSQL;  // this is a DB Handler for MySQL
    ...
    /**
     * @return the data_sync1
     */
    

    /**
     * @param aData_sync1 the data_sync1 to set
     */
    ...
    throws DBException {
        if(!configLoaded) {
            ...
            try {
                ...
                configLoaded = true;
                System.out.println("#*********************************************************#");
                System.out.println("                        LOAD DBCONFIG POSBO");
                System.out.println("");
   ...
   protected String getFieldSetList() {
            ...
            switch(getFieldType(i)) {
                ...
                case I_DBType.TYPE_FLOAT: // '\002'
                    if(!fieldValues.elementAt(i).getClass().getName().equals("java.lang.String")) {
                        ...
                        //System.out.println("------TYPE_FLOAT format : "+s);
    ...
    throws DBException {
        ...
        try {
           ...
           // if(isData_sync()){
                ...
                //insert ke table data_sync_sql
            //    String q =getInsertSQL();
            //    DataSyncSql datasyncsql = new DataSyncSql();
           //     PstDataSyncSql pstdatasyncsql = new PstDataSyncSql(0);
           //     datasyncsql.setQuery(q);
           //     pstdatasyncsql.insertExc(datasyncsql);
          //  }
    ...
    /**
     *      DENGEROUS....!!!
     *      Delete this fuction in next dev ' 080416-df-sto iii-200
     */
   ...
   public int execUpdateDyn(String sql)
    throws DBException {
        Connection connection = null;
        Statement statement = null;
    ...
    /**
     * @return the data_sync
     */
    public boolean isData_sync() {
        return data_sync;
    }

    /**
     * @param data_sync the data_sync to set
     */
    public void setData_sync(boolean data_sync) {
