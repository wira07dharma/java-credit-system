...
public class FrmAppUser extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_ASSIGN_LOCATION_ID = 12;
    public static final int FRM_EMPLOYEE_ID = 13;
    ...
    public static final String[] fieldNames = {
        ...
        , "USER_GROUP", "ASSIGN_LOCATION_ID", "EMPLOYEE_ID"
    };
    ...
    public static int[] fieldTypes = {
        ...
        TYPE_DATE, TYPE_DATE, TYPE_INT, TYPE_DATE, TYPE_STRING, TYPE_COLLECTION, TYPE_LONG, TYPE_LONG
    };
    ...
    public void requestEntityObject(AppUser entObj) {
        try {
			...
			entObj.setAssignLocationId(this.getLong(FRM_ASSIGN_LOCATION_ID)); 
