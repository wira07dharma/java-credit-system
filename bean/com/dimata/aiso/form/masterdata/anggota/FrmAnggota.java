...
public class FrmAnggota extends FRMHandler implements I_Language, I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_MARITAL_ID = 29;
    public static final int FRM_LATITUDE = 30;
    public static final int FRM_LONGITUDE = 31;
...
//            anggota.setNoRekening(this.getString(FRM_NO_REKENING));
            ...
            anggota.setMaritalId(this.getLong(FRM_MARITAL_ID));
            anggota.setAddrLat(this.getDouble(FRM_LATITUDE));
            anggota.setAddrLong(this.getLong(FRM_LONGITUDE));
