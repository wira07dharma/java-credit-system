...
public class AppObjInfo {
    ...
    public static final int COMMAND_ANALISA 			= 8;
    public static final int COMMAND_ACCEPT 			= 9;
    public static final int COMMAND_DRAFT 			= 10;
    public static final int COMMAND_DECLINE 			= 11;
    public static final int COMMAND_CANCEL 			= 12;
    public static final int COMMAND_CLOSED 			= 13;
    
    public static final String[] strCommand = {
        "View", "Add", "Update", "Delete", "Print", "Submit","Start", "Stop", "Analisa", "Accept", "Draft", "Tidak Accept", "Cancel", "Closed"
    };
    ...
    public static final int G1_SEDANA = 6;        
        ...
        public static final int G2_MASTER_KREDIT = 2;
            ...
            public static final int OBJ_ANALISA_MASTER_GROUP = 4;
            public static final int OBJ_ANALISA_MASTER = 5;
        ...
        public static final int G2_TRANSACTION = 3;
            ...
            public static final int OBJ_ANALISA_FORM_5C = 9;
            public static final int OBJ_CHANGE_KOLEKTOR_MODULE = 10;
            public static final int OBJ_RETURN_KREDIT = 11;
            public static final int OBJ_PENGHAPUSAN_KREDIT = 12;
        ...
        public static final int G2_REPORT = 4;
            ...
            public static final int OBJ_RIWAYAT_PEMBAYARAN_KREDIT = 5;
            public static final int OBJ_KREDIT_PER_SHIFT = 6;
            public static final int OBJ_KOLEKTOR = 7;
            public static final int OBJ_KOMISI_SALES = 8;
            public static final int OBJ_KOLEKTOR_PENCAPAIAN = 9;
        ...
        public static final int G2_MASTER_APPROVAL = 8;
            public static final int OBJ_APPROVAL_PENILAIAN_KREDIT = 0;
            public static final int OBJ_APPROVAL_ANALISA_FORM_5C = 1;
            public static final int OBJ_APPROVAL_DAFTAR_TRANSAKSI = 2;
    ...
    public static final String[][][] objectTitles = {
        ...
        { //g3 sedana
            ...
            //masterdata kredit
            {"Jenis Kredit", "Sumber Dana", "Kolektibilitas Pembayaran", "Penjamin Kredit", "Analisa Kredit Group", "Analisa Kredit"},
            //transaction
            {"Penambahan Tabungan", "Penarikan Tabungan", "Mutasi", "Pengajuan Kredit", "Penilaian Kredit",
                "Pencairan Kredit", "Pembayaran Kredit", "Daftar Transaksi", "Sistem Kredit", "Analisa Form 5C", 
                "Ganti Kolektor", "Return Kredit", "Penghapusan Kredit"
            },
            //laporan
            {"Report Per Pinjaman", "Tabungan Wajib", "Sisa Pinjaman", "Kolektibilitas",
                "Rangkuman Kolektibilitas", "Riwayat Pembayaran Kredit", "Kredit per Shift", "Daftar Tagihan Kolektor",
                "Komisi Sales", "Daftar Pencapaian Kolektor"},
            //teller shift
            ...
            //approval
            {"Penilaian Kredit", "Analisa Form 5C", "Daftar Transaksi"},
        }
    };
    ...
    public static final int[][][][] objectCommands = {
        ...
        {//sedana
            ...
            {//master kredit
                ...
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // Analisa Kredit Master
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // Analisa Kredit
            },
            {//transaksi
                ...
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // analisa form 5c
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // ganti kolektor
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // return kredit
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // penghapusan kredit
            },
            {// laporan
                ...
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // riwatat pembayaran kredit
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // kredit per shift
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // kolektor daftar tagihan
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // komisi sales
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE}, // kolektor daftar pencapaian
            },
            {// teller shift
            ...
            {
                {COMMAND_VIEW, COMMAND_DRAFT, COMMAND_ANALISA, COMMAND_ACCEPT, COMMAND_DECLINE, COMMAND_CANCEL}, // analisa kredit
                {COMMAND_VIEW, COMMAND_DRAFT, COMMAND_CLOSED}, // form 5c
                {COMMAND_VIEW, COMMAND_CLOSED} // form 5c
            }
        }
    };
