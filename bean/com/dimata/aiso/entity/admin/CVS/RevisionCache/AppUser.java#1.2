...
public class AppUser extends Entity {
	...
	private long assignLocationId = 0;
	...
	/**
	 * @return the assignLocationId
	 */
	public long getAssignLocationId() {
		return assignLocationId;
	}

	/**
	 * @param assignLocationId the assignLocationId to set
	 */
	public void setAssignLocationId(long assignLocationId) {
