...
public class PstMappingUserGroup extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static void resultToObjectJson(ResultSet rs, JSONObject obj) {
    try {
      obj.put(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_MAPPING_USER_GROUP_ID], rs.getLong(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_MAPPING_USER_GROUP_ID]));
      obj.put(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_USER_ID], rs.getLong(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_USER_ID]));
      obj.put(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_GROUP_USER_ID], rs.getLong(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_GROUP_USER_ID]));
      obj.put(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_COMPANY_ID], rs.getLong(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_COMPANY_ID]));
    } catch (Exception e) {
    }
  }

  public static void convertJsonToObject(JSONObject obj, MappingUserGroup entMappingUserGroup) {
    try {
      entMappingUserGroup.setOID(obj.optLong(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_MAPPING_USER_GROUP_ID]));
      entMappingUserGroup.setUserId(obj.optLong(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_USER_ID]));
      entMappingUserGroup.setGroupUserId(obj.optLong(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_GROUP_USER_ID]));
      entMappingUserGroup.setCompanyId(obj.optLong(PstMappingUserGroup.fieldNames[PstMappingUserGroup.FLD_COMPANY_ID]));
    } catch (Exception e) {
    }
  }
}
