...
public class PstAppUser extends DBHandler implements I_DBInterface, I_DBType, I_Persintent  {
    ...
    public static final int FLD_USER_GROUP		= 12;
    ...
    public static int[] fieldTypes = {
        ...
        TYPE_DATE, TYPE_DATE, TYPE_INT, TYPE_DATE, TYPE_STRING, TYPE_LONG, TYPE_LONG
    };
 ...
 public static long update(AppUser entObj)
    {
        if(( (entObj!=null) && (entObj.getOID() != 0))&&(entObj.getLoginId() != null && entObj.getPassword() != null ))
        {
            try
            {
                PstAppUser pstObj = new PstAppUser(entObj.getOID());
    ...
    public static Vector listFullObj(int start , int recordToGet, String whereClause, String loginID, String password) {
        ...
        try {
            ...
            PreparedStatement pst = DBHandler.getPreparedStatement(sql, conn);
