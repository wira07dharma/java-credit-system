...
public class PstCurrencyType extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final String TBL_CURRENCY_TYPE = "currency_type";
    ...
    public static Vector list_Old(int limitStart, int recordToGet, String whereClause, String order) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT * FROM " + TBL_CURRENCY_TYPE;
    ...
    private static void resultToObject(ResultSet rs, CurrencyType currencytype) {
        try {
