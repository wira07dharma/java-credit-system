...
public class PstContactList extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_KTP_NO = 60;
    public static final int FLD_HOME_ADDRESS = 61;
    public static final int FLD_COMP_ADDRESS = 62;
    public static final int FLD_MEMBER_VOCATION_ID = 63;
    public static final int FLD_POSITION_ID = 64;
    public static final int FLD_MARITAL_ID = 65;
    public static final int FLD_ADDR_LAT = 66;
    public static final int FLD_ADDR_LONG = 67;
    public static final int FLD_NO_REKENING = 68;
    ...
    public static ContactList fetchExc(long oid) throws DBException{
        try{
            ...
            contactlist.setKtpNo(pstContactList.getString(FLD_KTP_NO));
            contactlist.setHomeAddress(pstContactList.getString(FLD_HOME_ADDRESS));
            contactlist.setCompAddress(pstContactList.getString(FLD_COMP_ADDRESS));
            contactlist.setMemberVocationId(pstContactList.getlong(FLD_MEMBER_VOCATION_ID));
            contactlist.setPositionId(pstContactList.getlong(FLD_POSITION_ID));
            contactlist.setMaritalId(pstContactList.getlong(FLD_MARITAL_ID));
            contactlist.setAddrLat(pstContactList.getdouble(FLD_ADDR_LAT));
            contactlist.setAddrLong(pstContactList.getdouble(FLD_ADDR_LONG));
            contactlist.setNoRekening(pstContactList.getString(FLD_NO_REKENING));
    ...
    public static long insertExc(ContactList contactlist) throws DBException{
        try{
            ...
            pstContactList.setString(FLD_KTP_NO, contactlist.getKtpNo());
            pstContactList.setString(FLD_HOME_ADDRESS, contactlist.getHomeAddress());
            pstContactList.setString(FLD_COMP_ADDRESS, contactlist.getCompAddress());
            pstContactList.setLong(FLD_MEMBER_VOCATION_ID, contactlist.getMemberVocationId());
            pstContactList.setLong(FLD_POSITION_ID, contactlist.getPositionId());
            pstContactList.setLong(FLD_MARITAL_ID, contactlist.getMaritalId());
            pstContactList.setDouble(FLD_ADDR_LAT, contactlist.getAddrLat());
            pstContactList.setDouble(FLD_ADDR_LONG, contactlist.getAddrLong());
            pstContactList.setString(FLD_NO_REKENING, contactlist.getNoRekening());
    ...
    public static long insertExcByOid(ContactList contactlist) throws DBException {
        try {
            PstContactList pstContactList = new PstContactList(0);
            ...
            pstContactList.insertByOid(contactlist.getOID());
    ...
    public static Vector listTabungan(int limitStart,int recordToGet, String whereClause, String order){
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT BANK_ACC	, BANK_ACC2	, BUSS_ADDRESS	, CIN	, CIN_COUNTER	, COMP_ADDRESS	, COMP_CITY	, COMP_COUNTRY	, COMP_EMAIL	, COMP_FAX	, COMP_NAME	, COMP_PH_NUMBER1	, COMP_PH_NUMBER2	, COMP_PO_BOX	, COMP_PROVINCE	, COMP_REGENCY	, COMP_STATE	, COMP_WEBSITE	, COMP_ZIP_CODE	, COMPANY_BANK_ACC	, CONSIGMENT_LIMIT	, CONTACT_CODE	, CONTACT_ID	, CONTACT_ID_AHLI_WARIS	, CONTACT_TYPE	, COUNTRY	, COUNTRY_ID	, CREDIT_LIMIT	, CURRENCY_TYPE_ID_CONSIGMENT_LIMIT	, CURRENCY_TYPE_ID_CREDIT_LIMIT	, DATE_OF_BIRTH	, DAYS_TERM_OF_PAYMENT	, DIRECTION	, DIRECTIONS	, DRIVING_LICENCE_NO	, EMAIL	, EMAIL1	, EMAIL_COMPANY	, EMPLOYEE_ID	, EXPIRED_DATE_KTP	, FAX	, FULL_NAME	, HOME_ADDR	, HOME_ADDRESS	, HOME_CITY	, HOME_COUNTRY	, HOME_EMAIL	, HOME_FAX	, HOME_MOBILE_PHONE	, HOME_PH_NUMBER	, HOME_PO_BOX	, HOME_PROVINCE	, HOME_STATE	, HOME_TELP	, HOME_TOWN	, HOME_WEBSITE	, HOME_ZIP_CODE	, IGNORE_BIRTH_DATE	, KTP_NO	, LAST_UPDATE	, LOCATION_ID	, MEMBER_BARCODE	, MEMBER_BIRTH_DATE	, MEMBER_BIRTH_PLACE	, MEMBER_CITY_ID	, MEMBER_COMP_CITY	, MEMBER_COUNTER	, MEMBER_GROUP_ID	, MEMBER_ID_CARD_NUMBER	, MEMBER_LAST_UPDATE	, MEMBER_PASSWORD	, MEMBER_PASSWORD_ID	, MEMBER_PMNT_REGENCY_ID	, MEMBER_PMNT_SUBREGENCY_ID	, MEMBER_PROVINCE_ID	, MEMBER_RELIGION_ID	, MEMBER_SEX	, MEMBER_STATUS	, MEMBER_USER_ID	, MEMBER_VOCATION_ID	, MESSAGE	, MOTHER_NAME	, NATIONALITY	, NO_NPWP	, NOTES	, OCCUPATION	, PASSPORT_NO	, PERSON_NAME	, POSITION_ID	, POSITION_PERSON	, POSTAL_CODE_COMPANY	, POSTAL_CODE_HOME	, PROCESS_STATUS	, PROVINCE	, REFERENCE	, REG_DATE	, REGDATE	, SALUTATION	, SISTEM_OF_PAYMENT	, TELP_MOBILE	, TELP_NR	, TERM_OF_DELIVERY	, TERM_OF_PAYMENT	, TOWN	, WARD_ID	, WEBSITE_COMPANY	, WEEK_DAY_OF_PAYMENT	, WEEK_DAY_OF_SALES_VISIT, "+
                         "CONCAT("+fieldNames[FLD_PERSON_NAME]+", ' - ', "+PstMasterTabungan.fieldNames[PstMasterTabungan.FLD_NAMA_TABUNGAN]+") AS PERSON_LASTNAME, "+
                         PstAssignContact.fieldNames[PstAssignContact.FLD_NO_TABUNGAN]+" AS NO_REKENING, " +
                         PstAssignContact.fieldNames[PstAssignContact.FLD_ASSIGN_TABUNGAN_ID]+" AS PARENT_ID "+
                         "FROM " + TBL_CONTACT_LIST + " " +
                         "JOIN "+PstAssignContact.TBL_ASSIGNCONTACT+" USING("+fieldNames[FLD_CONTACT_ID]+") " +
                         "JOIN "+PstMasterTabungan.TBL_MASTERTABUNGAN+" USING("+PstAssignContact.fieldNames[PstAssignContact.FLD_MASTER_TABUNGAN_ID]+") " + " " 
            ;
            if(whereClause != null && whereClause.length() > 0)
                sql = sql + " WHERE " + whereClause;
            //sql += " GROUP BY "+PstMasterTabungan.fieldNames[PstMasterTabungan.FLD_MASTER_TABUNGAN_ID]+", CONTACT_ID ";
            if(order != null && order.length() > 0)
                sql = sql + " ORDER BY " + order;
    ...
    public static void resultToObject(ResultSet rs, ContactList contactlist){
        try{
            ...
            contactlist.setKtpNo(rs.getString(PstContactList.fieldNames[PstContactList.FLD_KTP_NO]));
            contactlist.setHomeAddress(rs.getString(PstContactList.fieldNames[PstContactList.FLD_HOME_ADDRESS]));
            contactlist.setCompAddress(rs.getString(PstContactList.fieldNames[PstContactList.FLD_COMP_ADDRESS]));
            contactlist.setMemberVocationId(rs.getLong(PstContactList.fieldNames[PstContactList.FLD_MEMBER_VOCATION_ID]));
            contactlist.setPositionId(rs.getLong(PstContactList.fieldNames[PstContactList.FLD_POSITION_ID]));
            contactlist.setMaritalId(rs.getLong(PstContactList.fieldNames[PstContactList.FLD_MARITAL_ID]));
            contactlist.setAddrLat(rs.getDouble(PstContactList.fieldNames[PstContactList.FLD_ADDR_LAT]));
            contactlist.setAddrLong(rs.getDouble(PstContactList.fieldNames[PstContactList.FLD_ADDR_LONG]));
            contactlist.setNoRekening(rs.getString(PstContactList.fieldNames[PstContactList.FLD_NO_REKENING]));
    ...
    public static Vector getListContact(Vector vectName, Vector vectType, int start, int recordToGet){
        ...
        try{
            ...
            while(rs.next()){
                ...
                //New
                cntList.setCompanyBankAcc(rs.getString(PstContactList.fieldNames[PstContactList.FLD_COMPANY_BANK_ACC]));
                cntList.setPositionPerson(rs.getString(PstContactList.fieldNames[PstContactList.FLD_POSITION_PERSON]));
                cntList.setPostalCodeCompany(rs.getString(PstContactList.fieldNames[PstContactList.FLD_POSTAL_CODE_COMPANY]));          
                cntList.setWebsiteCompany(rs.getString(PstContactList.fieldNames[PstContactList.FLD_WEBSITE_COMPANY]));
                cntList.setEmailCompany(rs.getString(PstContactList.fieldNames[PstContactList.FLD_EMAIL_COMPANY]));
                cntList.setPostalCodeHome(rs.getString(PstContactList.fieldNames[PstContactList.FLD_POSTAL_CODE_HOME]));
                cntList.setNoRekening(rs.getString(PstContactList.fieldNames[PstContactList.FLD_NO_REKENING]));
...
//            System.out.println("sql : " + sql);
    ...
    */
    ...
    /*
     * This Method Use to fetch Contact data
     * @return hashtable
     */
    ...
    public static Hashtable fetchExcHashtable(long oid) throws DBException {
        ...
        try {
            ...
            contactList.setContactCode(pstContactList.getString(FLD_CONTACT_CODE));
            hashtableContact.put(fieldNames[FLD_CONTACT_CODE], (contactList.getContactCode() != null ? contactList.getContactCode() : "-"));
            
            contactList.setContactType(pstContactList.getInt(FLD_CONTACT_TYPE));
            hashtableContact.put(fieldNames[FLD_CONTACT_TYPE], contactList.getContactType());
            
            contactList.setRegdate(pstContactList.getDate(FLD_REGDATE));
            hashtableContact.put(fieldNames[FLD_REGDATE], (contactList.getRegdate() != null ? contactList.getRegdate() : "-"));
            
            contactList.setCompName(pstContactList.getString(FLD_COMP_NAME));
            hashtableContact.put(fieldNames[FLD_COMP_NAME], (contactList.getCompName() != null ? contactList.getCompName() : "-"));
            
            contactList.setPersonName(pstContactList.getString(FLD_PERSON_NAME));
            hashtableContact.put(fieldNames[FLD_PERSON_NAME], (contactList.getPersonName() != null ? contactList.getPersonName() : "-"));
            
            contactList.setPersonLastname(pstContactList.getString(FLD_PERSON_LASTNAME));
            hashtableContact.put(fieldNames[FLD_PERSON_LASTNAME], (contactList.getPersonLastname() != null ? contactList.getPersonLastname() : "-"));
            
            contactList.setBussAddress(pstContactList.getString(FLD_BUSS_ADDRESS));
            hashtableContact.put(fieldNames[FLD_BUSS_ADDRESS], (contactList.getBussAddress() != null ? contactList.getBussAddress() : "-"));
            
            contactList.setTown(pstContactList.getString(FLD_TOWN));
            hashtableContact.put(fieldNames[FLD_TOWN], (contactList.getTown() != null ? contactList.getTown() : "-"));
            
            contactList.setProvince(pstContactList.getString(FLD_PROVINCE));
            hashtableContact.put(fieldNames[FLD_PROVINCE], (contactList.getProvince() != null ? contactList.getProvince() : "-"));
            
            contactList.setCountry(pstContactList.getString(FLD_COUNTRY));
            hashtableContact.put(fieldNames[FLD_COUNTRY], (contactList.getCountry() != null ? contactList.getCountry() : "-"));
            
            contactList.setTelpNr(pstContactList.getString(FLD_TELP_NR));
            hashtableContact.put(fieldNames[FLD_TELP_NR], (contactList.getTelpNr() != null ? contactList.getTelpNr() : "-"));
            
            contactList.setTelpMobile(pstContactList.getString(FLD_TELP_MOBILE));
            hashtableContact.put(fieldNames[FLD_TELP_MOBILE], (contactList.getTelpMobile() != null ? contactList.getTelpMobile() : "-"));
            
            contactList.setFax(pstContactList.getString(FLD_FAX));
            hashtableContact.put(fieldNames[FLD_FAX], (contactList.getFax() != null ? contactList.getFax() : "-"));
            
            contactList.setHomeAddr(pstContactList.getString(FLD_HOME_ADDR));
            hashtableContact.put(fieldNames[FLD_HOME_ADDR], (contactList.getHomeAddr() != null ? contactList.getHomeAddr() : "-"));
            
            contactList.setHomeTown(pstContactList.getString(FLD_HOME_TOWN));
            hashtableContact.put(fieldNames[FLD_HOME_TOWN], (contactList.getHomeTown() != null ? contactList.getHomeTown() : "-"));
            
            contactList.setHomeProvince(pstContactList.getString(FLD_HOME_PROVINCE));
            hashtableContact.put(fieldNames[FLD_HOME_PROVINCE], (contactList.getHomeProvince() != null ? contactList.getHomeProvince() : "-"));
            
            contactList.setHomeCountry(pstContactList.getString(FLD_HOME_COUNTRY));
            hashtableContact.put(fieldNames[FLD_HOME_COUNTRY], (contactList.getHomeCountry() != null ? contactList.getHomeCountry() : "-"));
            
            contactList.setHomeTelp(pstContactList.getString(FLD_HOME_TELP));
            hashtableContact.put(fieldNames[FLD_HOME_TELP], (contactList.getHomeTelp() != null ? contactList.getHomeTelp() : "-"));
            
            contactList.setHomeFax(pstContactList.getString(FLD_HOME_FAX));
            hashtableContact.put(fieldNames[FLD_HOME_FAX], (contactList.getHomeFax() != null ? contactList.getHomeFax() : "-"));
            
            contactList.setNotes(pstContactList.getString(FLD_NOTES));
            hashtableContact.put(fieldNames[FLD_NOTES], (contactList.getNotes() != null ? contactList.getNotes() : "-"));
            
            contactList.setBankAcc(pstContactList.getString(FLD_BANK_ACC));
            hashtableContact.put(fieldNames[FLD_BANK_ACC], (contactList.getBankAcc() != null ? contactList.getBankAcc() : "-"));
            
            contactList.setBankAcc2(pstContactList.getString(FLD_BANK_ACC2));
            hashtableContact.put(fieldNames[FLD_BANK_ACC2], (contactList.getBankAcc2() != null ? contactList.getBankAcc2() : "-"));
            
            contactList.setEmail(pstContactList.getString(FLD_EMAIL));
            hashtableContact.put(fieldNames[FLD_EMAIL], (contactList.getEmail() != null ? contactList.getEmail() : "-"));
            
            contactList.setDirections(pstContactList.getString(FLD_DIRECTIONS));
            hashtableContact.put(fieldNames[FLD_DIRECTIONS], (contactList.getDirections() != null ? contactList.getDirections() : "-"));
            
            contactList.setCompanyBankAcc(pstContactList.getString(FLD_COMPANY_BANK_ACC));
            hashtableContact.put(fieldNames[FLD_COMPANY_BANK_ACC], (contactList.getCompanyBankAcc() != null ? contactList.getCompanyBankAcc() : "-"));
            
            contactList.setPositionPerson(pstContactList.getString(FLD_POSITION_PERSON));
            hashtableContact.put(fieldNames[FLD_POSITION_PERSON], (contactList.getPositionPerson() != null ? contactList.getPositionPerson() : "-"));
            
            contactList.setPostalCodeCompany(pstContactList.getString(FLD_POSTAL_CODE_COMPANY));
            hashtableContact.put(fieldNames[FLD_POSTAL_CODE_COMPANY], (contactList.getPostalCodeCompany() != null ? contactList.getPostalCodeCompany() : "-"));
                    
            contactList.setWebsiteCompany(pstContactList.getString(FLD_WEBSITE_COMPANY));
            hashtableContact.put(fieldNames[FLD_WEBSITE_COMPANY], (contactList.getWebsiteCompany() != null ? contactList.getWebsiteCompany() : "-"));
            
            contactList.setEmailCompany(pstContactList.getString(FLD_EMAIL_COMPANY));
            hashtableContact.put(fieldNames[FLD_EMAIL_COMPANY], (contactList.getEmailCompany() != null ? contactList.getEmailCompany() : "-"));
            
            contactList.setPostalCodeHome(pstContactList.getString(FLD_POSTAL_CODE_HOME));
            hashtableContact.put(fieldNames[FLD_POSTAL_CODE_HOME], (contactList.getPostalCodeHome() != null ? contactList.getPostalCodeHome() : "-"));
            
            contactList.setNoRekening(pstContactList.getString(FLD_NO_REKENING));
            hashtableContact.put(fieldNames[FLD_NO_REKENING], (contactList.getNoRekening() != null ? contactList.getNoRekening() : "-"));
 
            return hashtableContact;
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
            throw new DBException(new PstContactList(0), DBException.UNKNOWN);
    ...
    public static long insertByOid(ContactList contactList) throws DBException {
        try {
            PstContactList pstContactList = new PstContactList(0);
            pstContactList.setString(FLD_CONTACT_CODE, contactList.getContactCode());
            pstContactList.setLong(FLD_EMPLOYEE_ID, contactList.getEmployeeId());
            ...
            pstContactList.setString(FLD_MEMBER_ID_CARD_NUMBER, contactList.getMemberIdCardNumber());
            pstContactList.setLong(FLD_CURRENCY_TYPE_ID_MEMBER_CONSIGMENT_LIMIT, contactList.getCurrencyTypeIdMemberConsigmentLimit());
            pstContactList.setDouble(FLD_MEMBER_CONSIGMENT_LIMIT, contactList.getMemberConsigmentLimit());
            pstContactList.setLong(FLD_CURRENCY_TYPE_ID_MEMBER_CREDIT_LIMIT, contactList.getCurrencyTypeIdMemberCreditLimit());
            pstContactList.setDouble(FLD_MEMBER_CREDIT_LIMIT, contactList.getMemberCreditLimit());
            pstContactList.setInt(FLD_DAY_OF_PAYMENT, contactList.getDayOfPayment());
            pstContactList.setString(FLD_COMP_STATE, contactList.getCompState());
            pstContactList.setString(FLD_COMP_EMAIL, contactList.getCompEmail());
            pstContactList.setString(FLD_POSTAL_CODE, contactList.getPostalCode());
    ...
    public static JSONObject fetchJSON(long oid) {
        ...
        try {
            ...
            object.put(PstContactList.fieldNames[PstContactList.FLD_CONTACT_ID], contactList.getOID());
            object.put(PstContactList.fieldNames[PstContactList.FLD_CONTACT_CODE], contactList.getContactCode());
            object.put(PstContactList.fieldNames[PstContactList.FLD_EMPLOYEE_ID], contactList.getEmployeeId());
            object.put(PstContactList.fieldNames[PstContactList.FLD_PARENT_ID], contactList.getParentId());
            object.put(PstContactList.fieldNames[PstContactList.FLD_CONTACT_TYPE], contactList.getContactType());
            object.put(PstContactList.fieldNames[PstContactList.FLD_REGDATE], contactList.getRegdate());
            object.put(PstContactList.fieldNames[PstContactList.FLD_COMP_NAME], contactList.getCompName());
            object.put(PstContactList.fieldNames[PstContactList.FLD_PERSON_NAME], contactList.getPersonName());
            object.put(PstContactList.fieldNames[PstContactList.FLD_PERSON_LASTNAME], contactList.getPersonLastname());
            object.put(PstContactList.fieldNames[PstContactList.FLD_BUSS_ADDRESS], contactList.getBussAddress());
            object.put(PstContactList.fieldNames[PstContactList.FLD_TOWN], contactList.getTown());
            object.put(PstContactList.fieldNames[PstContactList.FLD_PROVINCE], contactList.getProvince());
            object.put(PstContactList.fieldNames[PstContactList.FLD_COUNTRY], contactList.getCountry());
            object.put(PstContactList.fieldNames[PstContactList.FLD_TELP_NR], contactList.getTelpNr());
            object.put(PstContactList.fieldNames[PstContactList.FLD_TELP_MOBILE], contactList.getTelpMobile());
            object.put(PstContactList.fieldNames[PstContactList.FLD_FAX], contactList.getFax());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_ADDR], contactList.getHomeAddr());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_TOWN], contactList.getHomeTown());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_PROVINCE], contactList.getHomeProvince());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_COUNTRY], contactList.getHomeCountry());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_TELP], contactList.getHomeTelp());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_FAX], contactList.getHomeFax());
            object.put(PstContactList.fieldNames[PstContactList.FLD_NOTES], contactList.getNotes());
            object.put(PstContactList.fieldNames[PstContactList.FLD_BANK_ACC], contactList.getBankAcc());
            object.put(PstContactList.fieldNames[PstContactList.FLD_BANK_ACC], contactList.getBankAcc());
            object.put(PstContactList.fieldNames[PstContactList.FLD_EMAIL], contactList.getEmail());
            object.put(PstContactList.fieldNames[PstContactList.FLD_DIRECTIONS], contactList.getDirections());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MEMBER_LAST_UPDATE], contactList.getLastUpdate());
            object.put(PstContactList.fieldNames[PstContactList.FLD_PROCESS_STATUS], contactList.getProcessStatus());
            object.put(PstContactList.fieldNames[PstContactList.FLD_COMPANY_BANK_ACC], contactList.getCompanyBankAcc());
            object.put(PstContactList.fieldNames[PstContactList.FLD_POSITION_PERSON], contactList.getPositionPerson());
            object.put(PstContactList.fieldNames[PstContactList.FLD_POSTAL_CODE_COMPANY], contactList.getPostalCodeCompany());
            object.put(PstContactList.fieldNames[PstContactList.FLD_WEBSITE_COMPANY], contactList.getWebsiteCompany());
            object.put(PstContactList.fieldNames[PstContactList.FLD_EMAIL_COMPANY], contactList.getEmailCompany());
            object.put(PstContactList.fieldNames[PstContactList.FLD_POSTAL_CODE_HOME], contactList.getPostalCodeHome());
            object.put(PstContactList.fieldNames[PstContactList.FLD_LOCATION_ID], contactList.getLocationId());
            object.put(PstContactList.fieldNames[PstContactList.FLD_TERM_OF_DELIVERY], contactList.getTermOfDelivery());
            object.put(PstContactList.fieldNames[PstContactList.FLD_COMP_COUNTRY], contactList.getCompCountry());
            object.put(PstContactList.fieldNames[PstContactList.FLD_COMP_PROVINCE], contactList.getCompProvince());
            object.put(PstContactList.fieldNames[PstContactList.FLD_COMP_REGENCY], contactList.getCompRegency());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_MOBILE_PHONE], contactList.getHomeMobilePhone());
            object.put(PstContactList.fieldNames[PstContactList.FLD_TITLE], contactList.getTitle());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_STATE], contactList.getHomeState());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MEMBER_BIRTH_DATE], contactList.getMemberBirthDate());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MEMBER_SEX], contactList.getMemberSex());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MEMBER_RELIGION_ID], contactList.getMemberReligionId());
            object.put(PstContactList.fieldNames[PstContactList.FLD_NATIONALITY], contactList.getNationality());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MEMBER_OCCUPATION], contactList.getMemberOccupation());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_EMAIL], contactList.getHomeEmail());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MEMBER_ID_CARD_NUMBER], contactList.getMemberIdCardNumber());
            object.put(PstContactList.fieldNames[PstContactList.FLD_CURRENCY_TYPE_ID_MEMBER_CONSIGMENT_LIMIT], contactList.getCurrencyTypeIdMemberConsigmentLimit());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MEMBER_CONSIGMENT_LIMIT], contactList.getMemberConsigmentLimit());
            object.put(PstContactList.fieldNames[PstContactList.FLD_CURRENCY_TYPE_ID_MEMBER_CREDIT_LIMIT], contactList.getCurrencyTypeIdMemberCreditLimit());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MEMBER_CREDIT_LIMIT], contactList.getMemberCreditLimit());
            object.put(PstContactList.fieldNames[PstContactList.FLD_DAY_OF_PAYMENT], contactList.getDayOfPayment());
            object.put(PstContactList.fieldNames[PstContactList.FLD_COMP_STATE], contactList.getCompState());
            object.put(PstContactList.fieldNames[PstContactList.FLD_COMP_EMAIL], contactList.getCompEmail());
            object.put(PstContactList.fieldNames[PstContactList.FLD_POSTAL_CODE], contactList.getPostalCode());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_CITY], contactList.getHomeCity());
            object.put(PstContactList.fieldNames[PstContactList.FLD_PASSPORT_NO], contactList.getPassportNo());
            object.put(PstContactList.fieldNames[PstContactList.FLD_KTP_NO], contactList.getKtpNo());
            object.put(PstContactList.fieldNames[PstContactList.FLD_HOME_ADDRESS], contactList.getHomeAddress());
            object.put(PstContactList.fieldNames[PstContactList.FLD_COMP_ADDRESS], contactList.getCompAddress());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MEMBER_VOCATION_ID], contactList.getMemberVocationId());
            object.put(PstContactList.fieldNames[PstContactList.FLD_POSITION_ID], contactList.getPositionId());
            object.put(PstContactList.fieldNames[PstContactList.FLD_MARITAL_ID], contactList.getMaritalId());
            object.put(PstContactList.fieldNames[PstContactList.FLD_ADDR_LAT], contactList.getAddrLat());
            object.put(PstContactList.fieldNames[PstContactList.FLD_ADDR_LONG], contactList.getAddrLong());
        } catch (Exception exc) {
        }
        return object;
    }
     ...
     public static long syncExc(JSONObject jSONObject){
        long oid = 0;
        if (jSONObject != null) {
            oid = jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_CONTACT_ID], 0);
            if (oid > 0) {
                ContactList contactList = new ContactList();
                contactList.setOID(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_CONTACT_ID], 0));
                contactList.setContactCode(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_CONTACT_CODE], ""));
                contactList.setEmployeeId(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_EMPLOYEE_ID], 0));
                contactList.setParentId(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_PARENT_ID], 0));
                contactList.setContactType(jSONObject.optInt(PstContactList.fieldNames[PstContactList.FLD_CONTACT_TYPE], 0));
                contactList.setRegdate(Formater.formatDate(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_REGDATE],  "0000-00-00"), "yyyy-MM-dd"));
                contactList.setCompName(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_COMP_NAME], ""));
                contactList.setPersonName(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_PERSON_NAME], ""));
                contactList.setPersonLastname(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_PERSON_LASTNAME], ""));
                contactList.setBussAddress(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_BUSS_ADDRESS], ""));
                contactList.setTown(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_TOWN], ""));
                contactList.setProvince(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_PROVINCE], ""));
                contactList.setCountry(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_COUNTRY], ""));
                contactList.setTelpNr(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_TELP_NR], ""));
                contactList.setTelpMobile(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_TELP_MOBILE], ""));
                contactList.setFax(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_FAX], ""));
                contactList.setHomeAddr(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_ADDR], ""));
                contactList.setHomeTown(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_TOWN], ""));
                contactList.setHomeProvince(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_PROVINCE], ""));
                contactList.setHomeCountry(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_COUNTRY], ""));
                contactList.setHomeTelp(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_TELP], ""));
                contactList.setHomeFax(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_FAX], ""));
                contactList.setNotes(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_NOTES], ""));
                contactList.setBankAcc(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_BANK_ACC], ""));
                contactList.setEmail(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_EMAIL], ""));
                contactList.setDirections(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_DIRECTIONS], ""));
                contactList.setLastUpdate(Formater.formatDate(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_MEMBER_LAST_UPDATE],  "0000-00-00"), "yyyy-MM-dd"));
                contactList.setProcessStatus(jSONObject.optInt(PstContactList.fieldNames[PstContactList.FLD_PROCESS_STATUS], 0));
                contactList.setCompanyBankAcc(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_COMPANY_BANK_ACC], ""));
                contactList.setPositionPerson(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_POSITION_PERSON], ""));
                contactList.setPostalCodeCompany(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_POSTAL_CODE_COMPANY], ""));
                contactList.setWebsiteCompany(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_WEBSITE_COMPANY], ""));
                contactList.setEmailCompany(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_EMAIL_COMPANY], ""));
                contactList.setPostalCodeHome(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_POSTAL_CODE_HOME], ""));
                contactList.setLocationId(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_LOCATION_ID], 0));
                contactList.setTermOfDelivery(jSONObject.optInt(PstContactList.fieldNames[PstContactList.FLD_TERM_OF_DELIVERY], 0));
                contactList.setCompCountry(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_COMP_COUNTRY], ""));
                contactList.setCompProvince(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_COMP_PROVINCE], ""));
                contactList.setCompRegency(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_COMP_REGENCY], ""));
                contactList.setHomeMobilePhone(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_MOBILE_PHONE], ""));
                contactList.setTitle(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_TITLE], ""));
                contactList.setHomeState(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_STATE], ""));
                contactList.setMemberBirthDate(Formater.formatDate(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_MEMBER_BIRTH_DATE],  "0000-00-00"), "yyyy-MM-dd"));
                contactList.setMemberSex(jSONObject.optInt(PstContactList.fieldNames[PstContactList.FLD_MEMBER_SEX],0));
                contactList.setMemberReligionId(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_MEMBER_RELIGION_ID], 0));
                contactList.setNationality(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_NATIONALITY], ""));
                contactList.setMemberOccupation(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_MEMBER_OCCUPATION], ""));
                contactList.setHomeEmail(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_EMAIL], ""));
                contactList.setMemberIdCardNumber(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_MEMBER_ID_CARD_NUMBER], ""));
                contactList.setCurrencyTypeIdMemberConsigmentLimit(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_CURRENCY_TYPE_ID_MEMBER_CONSIGMENT_LIMIT], 0));
                contactList.setMemberConsigmentLimit(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_MEMBER_CONSIGMENT_LIMIT], 0));
                contactList.setCurrencyTypeIdMemberCreditLimit(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_CURRENCY_TYPE_ID_MEMBER_CREDIT_LIMIT], 0));
                contactList.setMemberCreditLimit(jSONObject.optDouble(PstContactList.fieldNames[PstContactList.FLD_MEMBER_CREDIT_LIMIT], 0));
                contactList.setDayOfPayment(jSONObject.optInt(PstContactList.fieldNames[PstContactList.FLD_DAY_OF_PAYMENT], 0));
                contactList.setCompState(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_COMP_STATE], ""));
                contactList.setCompEmail(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_COMP_EMAIL], ""));
                contactList.setPostalCode(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_POSTAL_CODE], ""));
                contactList.setHomeCity(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_CITY], ""));
                contactList.setPassportNo(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_PASSPORT_NO], ""));
                contactList.setKtpNo(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_KTP_NO], ""));
                contactList.setHomeAddress(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_HOME_ADDRESS], ""));
                contactList.setCompAddress(jSONObject.optString(PstContactList.fieldNames[PstContactList.FLD_COMP_ADDRESS], ""));
                contactList.setMemberVocationId(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_MEMBER_VOCATION_ID], 0));
                contactList.setPositionId(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_POSITION_ID], 0));
                contactList.setMaritalId(jSONObject.optLong(PstContactList.fieldNames[PstContactList.FLD_MARITAL_ID], 0));
                contactList.setAddrLat(jSONObject.optDouble(PstContactList.fieldNames[PstContactList.FLD_ADDR_LAT],0));
                contactList.setAddrLong(jSONObject.optDouble(PstContactList.fieldNames[PstContactList.FLD_ADDR_LONG], 0));
                boolean checkOidContactList = PstContactList.checkOID(oid);
                try {
                    if (checkOidContactList) {
                        PstContactList.updateExc(contactList);
                    } else {
                        PstContactList.insertByOid(contactList);
                    }
                } catch (Exception exc) {
                }
            }
