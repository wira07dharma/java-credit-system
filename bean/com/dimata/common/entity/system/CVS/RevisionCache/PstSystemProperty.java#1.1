...
public class PstSystemProperty extends DBHandler implements I_DBInterface, I_DBType, I_Persintent {
  ...
  public static String getValueByName(String name, AppValue appValue) {
    String val = appValue.getValueByKey(name);
    if (val == null || val.length() < 1) {
      System.out.println("--- RELOAD VALUE : " + name + ", no result :: -- re-reload begin");
      appValue.loadSystemProperty();
      val = appValue.getValueByKey(name);
    }
  ...
  public static int loadFromDbToHash(String[] systemPropNames) {
