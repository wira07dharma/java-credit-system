...
public class SessDataTables {
    ...
    public void addColumnCustom(Column c) {
        this.cols.add(c);
    }

    public void addColumnAction(String colName) {
        this.addColumn(colName, true);
    }

    public void addColumn(String colName, boolean action) {
        this.addColumn(colName, I_DBType.TYPE_STRING, "@", action);
    }

    public void addColumn(String colName) {
        this.addColumn(colName, I_DBType.TYPE_STRING);
    }

    public void addColumn(String colName, int dbtype) {
        this.addColumn(colName, dbtype, "@", false);
    }

    public void addColumn(String colName, String pattern) {
        this.addColumn(colName, I_DBType.TYPE_STRING, pattern, false);
    }
    ...
    private void getRequestValues() {
        ...
        if (cols != null && this.cols.size() > 0) {
            ...
            for (Column col : cols) {
                this.whereClause += " OR " + this.getAlias(col.getColName()) + " LIKE '%" + searchTerm + "%' ";
            }
            this.whereClause += " ) ";
        }
    }
