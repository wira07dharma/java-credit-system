...
public class PstAssignSumberDana extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         AssignSumberDana assignSumberDana = PstAssignSumberDana.fetchExc(oid);
         object.put(PstAssignSumberDana.fieldNames[PstAssignSumberDana.FLD_ASSIGN_SUMBER_DANA_JENIS_KREDIT_ID], assignSumberDana.getOID());
         object.put(PstAssignSumberDana.fieldNames[PstAssignSumberDana.FLD_SUMBER_DANA_ID], assignSumberDana.getSumberDanaId());
         object.put(PstAssignSumberDana.fieldNames[PstAssignSumberDana.FLD_TYPE_KREDIT_ID], assignSumberDana.getTypeKreditId());
         object.put(PstAssignSumberDana.fieldNames[PstAssignSumberDana.FLD_MAX_PRESENTASE_PENGGUNAAN], assignSumberDana.getMaxPresentasePenggunaan());
      }catch(Exception exc){}
      return object;
   }
     ...
     public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstAssignSumberDana.fieldNames[PstAssignSumberDana.FLD_ASSIGN_SUMBER_DANA_JENIS_KREDIT_ID],0);
         if (oid > 0){
          AssignSumberDana assignSumberDana = new AssignSumberDana();
          assignSumberDana.setOID(jSONObject.optLong(PstAssignSumberDana.fieldNames[PstAssignSumberDana.FLD_ASSIGN_SUMBER_DANA_JENIS_KREDIT_ID],0));
          assignSumberDana.setSumberDanaId(jSONObject.optLong(PstAssignSumberDana.fieldNames[PstAssignSumberDana.FLD_SUMBER_DANA_ID],0));
          assignSumberDana.setTypeKreditId(jSONObject.optLong(PstAssignSumberDana.fieldNames[PstAssignSumberDana.FLD_TYPE_KREDIT_ID],0));
          assignSumberDana.setMaxPresentasePenggunaan(Float.valueOf(jSONObject.optString(PstAssignSumberDana.fieldNames[PstAssignSumberDana.FLD_MAX_PRESENTASE_PENGGUNAAN],"")));
         boolean checkOidAssignSumberDana = PstAssignSumberDana.checkOID(oid);
          try{
            if(checkOidAssignSumberDana){
               PstAssignSumberDana.updateExc(assignSumberDana);
            }else{
               PstAssignSumberDana.insertByOid(assignSumberDana);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(AssignSumberDana assignSumberDana) throws DBException {
      try {
         PstAssignSumberDana pstAssignSumberDana = new PstAssignSumberDana(0);
         pstAssignSumberDana.setLong(FLD_ASSIGN_SUMBER_DANA_JENIS_KREDIT_ID, assignSumberDana.getOID());
         pstAssignSumberDana.setLong(FLD_SUMBER_DANA_ID, assignSumberDana.getSumberDanaId());
         pstAssignSumberDana.setLong(FLD_TYPE_KREDIT_ID, assignSumberDana.getTypeKreditId());
         pstAssignSumberDana.setDouble(FLD_MAX_PRESENTASE_PENGGUNAAN, assignSumberDana.getMaxPresentasePenggunaan());
         pstAssignSumberDana.insertByOid(assignSumberDana.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstAssignSumberDana(0), DBException.UNKNOWN);
      }
      return assignSumberDana.getOID();
   }
}
