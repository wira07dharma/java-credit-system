...
public class PstPersentaseJaminan extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         PersentaseJaminan persentaseJaminan = PstPersentaseJaminan.fetchExc(oid);
         object.put(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_ID_PERSENTASE_JAMINAN], persentaseJaminan.getOID());
         object.put(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_ID_PENJAMIN], persentaseJaminan.getIdPenjamin());
         object.put(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_JANGKA_WAKTU], persentaseJaminan.getJangkaWaktu());
         object.put(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_PERSENTASE_COVERAGE], persentaseJaminan.getPersentaseCoverage());
         object.put(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_PERSENTASE_DIJAMIN], persentaseJaminan.getPersentaseDijamin());
      }catch(Exception exc){}
      return object;
   }
      ...
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_ID_PERSENTASE_JAMINAN],0);
         if (oid > 0){
          PersentaseJaminan persentaseJaminan = new PersentaseJaminan();
          persentaseJaminan.setOID(jSONObject.optLong(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_ID_PERSENTASE_JAMINAN],0));
          persentaseJaminan.setIdPenjamin(jSONObject.optLong(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_ID_PENJAMIN],0));
          persentaseJaminan.setJangkaWaktu(jSONObject.optInt(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_JANGKA_WAKTU],0));
          persentaseJaminan.setPersentaseCoverage(jSONObject.optDouble(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_PERSENTASE_COVERAGE],0));
          persentaseJaminan.setPersentaseDijamin(jSONObject.optDouble(PstPersentaseJaminan.fieldNames[PstPersentaseJaminan.FLD_PERSENTASE_DIJAMIN],0));
         boolean checkOidPersentaseJaminan = PstPersentaseJaminan.checkOID(oid);
          try{
            if(checkOidPersentaseJaminan){
               PstPersentaseJaminan.updateExc(persentaseJaminan);
            }else{
               PstPersentaseJaminan.insertByOid(persentaseJaminan);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(PersentaseJaminan persentaseJaminan) throws DBException {
      try {
         PstPersentaseJaminan pstPersentaseJaminan = new PstPersentaseJaminan(0);
         pstPersentaseJaminan.setLong(FLD_ID_PERSENTASE_JAMINAN, persentaseJaminan.getOID());
         pstPersentaseJaminan.setLong(FLD_ID_PENJAMIN, persentaseJaminan.getIdPenjamin());
         pstPersentaseJaminan.setInt(FLD_JANGKA_WAKTU, persentaseJaminan.getJangkaWaktu());
         pstPersentaseJaminan.setDouble(FLD_PERSENTASE_COVERAGE, persentaseJaminan.getPersentaseCoverage());
         pstPersentaseJaminan.setDouble(FLD_PERSENTASE_DIJAMIN, persentaseJaminan.getPersentaseDijamin());
         pstPersentaseJaminan.insertByOid(persentaseJaminan.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstPersentaseJaminan(0), DBException.UNKNOWN);
      }
      return persentaseJaminan.getOID();
   }
}
