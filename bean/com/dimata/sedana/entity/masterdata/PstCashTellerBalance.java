...
public class PstCashTellerBalance extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         CashTellerBalance cashTellerBalance = PstCashTellerBalance.fetchExc(oid);
         object.put(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_CASH_BALANCE_ID], cashTellerBalance.getCashBalanceId());
         object.put(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_TELLER_SHIFT_ID], cashTellerBalance.getTellerShiftId());
         object.put(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_CURRENCY_ID], cashTellerBalance.getCurrencyId());
         object.put(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_TYPE], cashTellerBalance.getType());
         object.put(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_BALANCE_DATE], cashTellerBalance.getBalanceDate());
         object.put(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_BALANCE_VALUE], cashTellerBalance.getBalanceValue());
         object.put(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_SHOULD_VALUE], cashTellerBalance.getShouldValue());
         object.put(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_PAYMENT_SYSTEM_ID], cashTellerBalance.getPaymentSystemId());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_CASH_BALANCE_ID],0);
         if (oid > 0){
          CashTellerBalance cashTellerBalance = new CashTellerBalance();
          cashTellerBalance.setCashBalanceId(jSONObject.optLong(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_CASH_BALANCE_ID],0));
          cashTellerBalance.setTellerShiftId(jSONObject.optLong(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_TELLER_SHIFT_ID],0));
          cashTellerBalance.setCurrencyId(jSONObject.optLong(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_CURRENCY_ID],0));
          cashTellerBalance.setType(jSONObject.optInt(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_TYPE],0));
          cashTellerBalance.setBalanceDate(Formater.formatDate(jSONObject.optString(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_BALANCE_DATE],"0000-00-00"),"yyyy-MM-dd"));
          cashTellerBalance.setBalanceValue(jSONObject.optDouble(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_BALANCE_VALUE],0));
          cashTellerBalance.setShouldValue(jSONObject.optDouble(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_SHOULD_VALUE],0));
          cashTellerBalance.setPaymentSystemId(jSONObject.optLong(PstCashTellerBalance.fieldNames[PstCashTellerBalance.FLD_PAYMENT_SYSTEM_ID],0));
         boolean checkOidCashTellerBalance = PstCashTellerBalance.checkOID(oid);
          try{
            if(checkOidCashTellerBalance){
               PstCashTellerBalance.updateExc(cashTellerBalance);
            }else{
               PstCashTellerBalance.insertByOid(cashTellerBalance);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(CashTellerBalance cashTellerBalance) throws DBException {
      try {
         PstCashTellerBalance pstCashTellerBalance = new PstCashTellerBalance(0);
         pstCashTellerBalance.setLong(FLD_CASH_BALANCE_ID, cashTellerBalance.getCashBalanceId());
         pstCashTellerBalance.setLong(FLD_TELLER_SHIFT_ID, cashTellerBalance.getTellerShiftId());
         pstCashTellerBalance.setLong(FLD_CURRENCY_ID, cashTellerBalance.getCurrencyId());
         pstCashTellerBalance.setInt(FLD_TYPE, cashTellerBalance.getType());
         pstCashTellerBalance.setDate(FLD_BALANCE_DATE, cashTellerBalance.getBalanceDate());
         pstCashTellerBalance.setDouble(FLD_BALANCE_VALUE, cashTellerBalance.getBalanceValue());
         pstCashTellerBalance.setDouble(FLD_SHOULD_VALUE, cashTellerBalance.getShouldValue());
         pstCashTellerBalance.setLong(FLD_PAYMENT_SYSTEM_ID, cashTellerBalance.getPaymentSystemId());
         pstCashTellerBalance.insertByOid(cashTellerBalance.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstCashTellerBalance(0), DBException.UNKNOWN);
      }
      return cashTellerBalance.getOID();
   }
}
