...
public class PstBiayaTransaksi extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static final int FLD_ID_VALUE = 6;
  ...
  public static BiayaTransaksi fetchExc(long oid) throws DBException {
    try {
      ...
      entBiayaTransaksi.setIdTransaksi(pstBiayaTransaksi.getInt(FLD_TRANSAKSI_ID));
  ...
  public static synchronized long updateExc(BiayaTransaksi entBiayaTransaksi) throws DBException {
    try {
      if (entBiayaTransaksi.getOID() != 0) {
        ...
        pstBiayaTransaksi.setLong(FLD_TRANSAKSI_ID, entBiayaTransaksi.getIdTransaksi());
  ...
  public static void resultToObject(ResultSet rs, BiayaTransaksi entBiayaTransaksi) {
    try {
      ...
      entBiayaTransaksi.setIdTransaksi(rs.getLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TRANSAKSI_ID]));
    } catch (Exception e) {
    }
  }
  ...
  public static Vector listJoinJenisTransaksi(int limitStart, int recordToGet, String whereClause, String order) {
	...
	public static void resultToObjectJson(ResultSet rs, JSONObject obj) {
		try {
			obj.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_BIAYA_TRANSAKSI], rs.getLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_BIAYA_TRANSAKSI]));
			obj.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_JENIS_TRANSAKSI], rs.getLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_JENIS_TRANSAKSI]));
			obj.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_PINJAMAN], rs.getLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_PINJAMAN]));
			obj.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_VALUE_BIAYA], rs.getLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_VALUE_BIAYA]));
			obj.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TIPE_BIAYA], rs.getLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TIPE_BIAYA]));
			obj.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_VALUE], rs.getLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_VALUE]));
			obj.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TRANSAKSI_ID], rs.getLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TRANSAKSI_ID]));
		} catch (Exception e) {
		}
	}
  public static JSONArray listBiayaTransaksi(int limitStart, int recordToGet, String whereClause, String order) {
		JSONArray lists = new JSONArray();
    DBResultSet dbrs = null;
    try {
      String sql = "SELECT "
              + " jt." + PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_JENIS_TRANSAKSI]
              + ", bt."+fieldNames[FLD_VALUE_BIAYA]
              + ", bt."+fieldNames[FLD_TIPE_BIAYA]
              + " FROM " + TBL_BIAYA_TRANSAKSI + " AS bt "
              + " INNER JOIN " + PstJenisTransaksi.TBL_JENISTRANSAKSI + " AS jt "
              + " ON bt." + fieldNames[FLD_ID_JENIS_TRANSAKSI] + " = jt." + PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_JENIS_TRANSAKSI_ID]
              + "";
      if (whereClause != null && whereClause.length() > 0) {
      ...
      JSONObject objBiaya = new JSONObject();
       ...
       objTransaksi.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_JENIS_TRANSAKSI], rs.getString(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_JENIS_TRANSAKSI]));
       data.put(objTransaksi);
        
       objBiaya.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_VALUE_BIAYA], rs.getDouble(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_VALUE_BIAYA]));
       objBiaya.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TIPE_BIAYA], rs.getInt(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TIPE_BIAYA]));
       data.put(objBiaya);
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         BiayaTransaksi biayaTransaksi = PstBiayaTransaksi.fetchExc(oid);
         object.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_BIAYA_TRANSAKSI], biayaTransaksi.getOID());
         object.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_JENIS_TRANSAKSI], biayaTransaksi.getIdJenisTransaksi());
         object.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_PINJAMAN], biayaTransaksi.getIdPinjaman());
         object.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_VALUE_BIAYA], biayaTransaksi.getValueBiaya());
         object.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TIPE_BIAYA], biayaTransaksi.getTipeBiaya());
         object.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_VALUE], biayaTransaksi.getIdValue());
         object.put(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TRANSAKSI_ID], biayaTransaksi.getIdTransaksi());
      }catch(Exception exc){}
      return object;
   }
public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_BIAYA_TRANSAKSI],0);
         if (oid > 0){
          BiayaTransaksi biayaTransaksi = new BiayaTransaksi();
          biayaTransaksi.setOID(jSONObject.optLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_BIAYA_TRANSAKSI],0));
          biayaTransaksi.setIdJenisTransaksi(jSONObject.optLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_JENIS_TRANSAKSI],0));
          biayaTransaksi.setIdPinjaman(jSONObject.optLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_PINJAMAN],0));
          biayaTransaksi.setValueBiaya(jSONObject.optDouble(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_VALUE_BIAYA],0));
          biayaTransaksi.setTipeBiaya(jSONObject.optInt(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TIPE_BIAYA],0));
          biayaTransaksi.setIdValue(jSONObject.optLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_ID_VALUE],0));
          biayaTransaksi.setIdTransaksi(jSONObject.optLong(PstBiayaTransaksi.fieldNames[PstBiayaTransaksi.FLD_TRANSAKSI_ID],0));
         boolean checkOidBiayaTransaksi = PstBiayaTransaksi.checkOID(oid);
          try{
            if(checkOidBiayaTransaksi){
               PstBiayaTransaksi.updateExc(biayaTransaksi);
            }else{
               PstBiayaTransaksi.insertByOid(biayaTransaksi);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(BiayaTransaksi biayaTransaksi) throws DBException {
      try {
         PstBiayaTransaksi pstBiayaTransaksi = new PstBiayaTransaksi(0);
         pstBiayaTransaksi.setLong(FLD_ID_BIAYA_TRANSAKSI, biayaTransaksi.getOID());
         pstBiayaTransaksi.setLong(FLD_ID_JENIS_TRANSAKSI, biayaTransaksi.getIdJenisTransaksi());
         pstBiayaTransaksi.setLong(FLD_ID_PINJAMAN, biayaTransaksi.getIdPinjaman());
         pstBiayaTransaksi.setDouble(FLD_VALUE_BIAYA, biayaTransaksi.getValueBiaya());
         pstBiayaTransaksi.setInt(FLD_TIPE_BIAYA, biayaTransaksi.getTipeBiaya());
         pstBiayaTransaksi.setLong(FLD_ID_VALUE, biayaTransaksi.getIdValue());
         pstBiayaTransaksi.setLong(FLD_TRANSAKSI_ID, biayaTransaksi.getIdTransaksi());
         pstBiayaTransaksi.insertByOid(biayaTransaksi.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstBiayaTransaksi(0), DBException.UNKNOWN);
      }
      return biayaTransaksi.getOID();
   }
}
