...
public class PstKolektibilitasPembayaran extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static void resultToObject(ResultSet rs, KolektibilitasPembayaran entKolektibilitasPembayaran) {
    try {
      ...
      entKolektibilitasPembayaran.setMaxHariTunggakanPokok(rs.getInt(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_MAX_HARI_TUNGGAKAN_POKOK]));
    } catch (Exception e) {
    }
  }
  ...
  public static Vector listJoin(int limitStart, int recordToGet, String whereClause, String order) {
    ...
    try {
      String sql = "SELECT "
              + "kolek."+PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_KOLEKTIBILITAS_ID]
              + ",kolek."+PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_JUDUL_KOLEKTIBILITAS]
              + ",kolek."+PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_KODE_KOLEKTIBILITAS]
              + ",kolek."+PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_TINGKAT_KOLEKTIBILITAS]
              + ",kolek."+PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_TINGKAT_RESIKO]
              + ",det."+PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_MAXHARITUNGGAKANPOKOK]
              + " FROM " + TBL_KOLEKTIBILITASPEMBAYARAN +" as kolek "
                + " INNER JOIN "+PstKolektibilitasPembayaranDetails.TBL_KOLEKTIBILITASPEMBAYARANDETAILS+" det "
                    + " ON kolek."+PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_KOLEKTIBILITAS_ID]
                    + " = det."+PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_KOLEKTIBILITASID];
      if (whereClause != null && whereClause.length() > 0) {
        sql = sql + " WHERE " + whereClause;
      }
      if (order != null && order.length() > 0) {
  ...
  public static int findLimitCommand(int start, int recordToGet, int vectSize) {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         KolektibilitasPembayaran kolektibilitasPembayaran = PstKolektibilitasPembayaran.fetchExc(oid);
         object.put(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_KOLEKTIBILITAS_ID], kolektibilitasPembayaran.getOID());
         object.put(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_KODE_KOLEKTIBILITAS], kolektibilitasPembayaran.getKodeKolektibilitas());
         object.put(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_TINGKAT_KOLEKTIBILITAS], kolektibilitasPembayaran.getTingkatKolektibilitas());
         object.put(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_JUDUL_KOLEKTIBILITAS], kolektibilitasPembayaran.getJudulKolektibilitas());
         object.put(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_MAX_HARI_TUNGGAKAN_POKOK], kolektibilitasPembayaran.getMaxHariTunggakanPokok());
         object.put(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_MAX_HARI_JUMLAH_TUNGGAKAN_BUNGA], kolektibilitasPembayaran.getMaxHariJumlahTunggakanBunga());
         object.put(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_TINGKAT_RESIKO], kolektibilitasPembayaran.getTingkatResiko());
      }catch(Exception exc){}
      return object;
   }
      ...
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_KOLEKTIBILITAS_ID],0);
         if (oid > 0){
          KolektibilitasPembayaran kolektibilitasPembayaran = new KolektibilitasPembayaran();
          kolektibilitasPembayaran.setOID(jSONObject.optLong(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_KOLEKTIBILITAS_ID],0));
          kolektibilitasPembayaran.setKodeKolektibilitas(jSONObject.optString(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_KODE_KOLEKTIBILITAS], ""));
          kolektibilitasPembayaran.setTingkatKolektibilitas(jSONObject.optInt(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_TINGKAT_KOLEKTIBILITAS],0));
          kolektibilitasPembayaran.setJudulKolektibilitas(jSONObject.optString(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_JUDUL_KOLEKTIBILITAS], ""));
          kolektibilitasPembayaran.setMaxHariTunggakanPokok(jSONObject.optInt(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_MAX_HARI_TUNGGAKAN_POKOK],0));
          kolektibilitasPembayaran.setMaxHariJumlahTunggakanBunga(jSONObject.optInt(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_MAX_HARI_JUMLAH_TUNGGAKAN_BUNGA],0));
          kolektibilitasPembayaran.setTingkatResiko(Float.valueOf(jSONObject.optString(PstKolektibilitasPembayaran.fieldNames[PstKolektibilitasPembayaran.FLD_TINGKAT_RESIKO],"")));
         boolean checkOidKolektibilitasPembayaran = PstKolektibilitasPembayaran.checkOID(oid);
          try{
            if(checkOidKolektibilitasPembayaran){
               PstKolektibilitasPembayaran.updateExc(kolektibilitasPembayaran);
            }else{
               PstKolektibilitasPembayaran.insertByOid(kolektibilitasPembayaran);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(KolektibilitasPembayaran kolektibilitasPembayaran) throws DBException {
      try {
         PstKolektibilitasPembayaran pstKolektibilitasPembayaran = new PstKolektibilitasPembayaran(0);
         pstKolektibilitasPembayaran.setLong(FLD_KOLEKTIBILITAS_ID, kolektibilitasPembayaran.getOID());
         pstKolektibilitasPembayaran.setString(FLD_KODE_KOLEKTIBILITAS, kolektibilitasPembayaran.getKodeKolektibilitas());
         pstKolektibilitasPembayaran.setInt(FLD_TINGKAT_KOLEKTIBILITAS, kolektibilitasPembayaran.getTingkatKolektibilitas());
         pstKolektibilitasPembayaran.setString(FLD_JUDUL_KOLEKTIBILITAS, kolektibilitasPembayaran.getJudulKolektibilitas());
         pstKolektibilitasPembayaran.setInt(FLD_MAX_HARI_TUNGGAKAN_POKOK, kolektibilitasPembayaran.getMaxHariTunggakanPokok());
         pstKolektibilitasPembayaran.setInt(FLD_MAX_HARI_JUMLAH_TUNGGAKAN_BUNGA, kolektibilitasPembayaran.getMaxHariJumlahTunggakanBunga());
         pstKolektibilitasPembayaran.setDouble(FLD_TINGKAT_RESIKO, kolektibilitasPembayaran.getTingkatResiko());
         pstKolektibilitasPembayaran.insertByOid(kolektibilitasPembayaran.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstKolektibilitasPembayaran(0), DBException.UNKNOWN);
      }
      return kolektibilitasPembayaran.getOID();
   }
}
