...
public class PstCashTeller extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static boolean isClosingTime(long oidUser) {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         CashTeller cashTeller = PstCashTeller.fetchExc(oid);
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_TELLER_SHIFT_ID], cashTeller.getOID());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_MASTER_LOKET_ID], cashTeller.getMasterLoketId());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_APP_USER_ID], cashTeller.getAppUserId());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_OPEN_DATE], cashTeller.getOpenDate());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_SPV_OPEN_ID], cashTeller.getSpvOpenId());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_SPV_OPEN_NAME], cashTeller.getSpvOpenName());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_SPV_CLOSE_ID], cashTeller.getSpvCloseId());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_SPV_CLOSE_NAME], cashTeller.getSpvCloseName());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_SHIFT_ID], cashTeller.getShiftId());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_CLOSE_DATE], cashTeller.getCloseDate());
         object.put(PstCashTeller.fieldNames[PstCashTeller.FLD_STATUS], cashTeller.getStatus());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstCashTeller.fieldNames[PstCashTeller.FLD_TELLER_SHIFT_ID],0);
         if (oid > 0){
          CashTeller cashTeller = new CashTeller();
          cashTeller.setOID(jSONObject.optLong(PstCashTeller.fieldNames[PstCashTeller.FLD_TELLER_SHIFT_ID],0));
          cashTeller.setMasterLoketId(jSONObject.optLong(PstCashTeller.fieldNames[PstCashTeller.FLD_MASTER_LOKET_ID],0));
          cashTeller.setAppUserId(jSONObject.optLong(PstCashTeller.fieldNames[PstCashTeller.FLD_APP_USER_ID],0));
          cashTeller.setOpenDate(Formater.formatDate(jSONObject.optString(PstCashTeller.fieldNames[PstCashTeller.FLD_OPEN_DATE],"0000-00-00"),"yyyy-MM-dd"));
          cashTeller.setSpvOpenId(jSONObject.optLong(PstCashTeller.fieldNames[PstCashTeller.FLD_SPV_OPEN_ID],0));
          cashTeller.setSpvOpenName(jSONObject.optString(PstCashTeller.fieldNames[PstCashTeller.FLD_SPV_OPEN_NAME], ""));
          cashTeller.setSpvCloseId(jSONObject.optLong(PstCashTeller.fieldNames[PstCashTeller.FLD_SPV_CLOSE_ID],0));
          cashTeller.setSpvCloseName(jSONObject.optString(PstCashTeller.fieldNames[PstCashTeller.FLD_SPV_CLOSE_NAME], ""));
          cashTeller.setShiftId(jSONObject.optLong(PstCashTeller.fieldNames[PstCashTeller.FLD_SHIFT_ID],0));
          cashTeller.setCloseDate(Formater.formatDate(jSONObject.optString(PstCashTeller.fieldNames[PstCashTeller.FLD_CLOSE_DATE],"0000-00-00"),"yyyy-MM-dd"));
          cashTeller.setStatus(jSONObject.optInt(PstCashTeller.fieldNames[PstCashTeller.FLD_STATUS],0));
         boolean checkOidCashTeller = PstCashTeller.checkOID(oid);
          try{
            if(checkOidCashTeller){
               PstCashTeller.updateExc(cashTeller);
            }else{
               PstCashTeller.insertByOid(cashTeller);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(CashTeller cashTeller) throws DBException {
      try {
         PstCashTeller pstCashTeller = new PstCashTeller(0);
         pstCashTeller.setLong(FLD_TELLER_SHIFT_ID, cashTeller.getOID());
         pstCashTeller.setLong(FLD_MASTER_LOKET_ID, cashTeller.getMasterLoketId());
         pstCashTeller.setLong(FLD_APP_USER_ID, cashTeller.getAppUserId());
         pstCashTeller.setDate(FLD_OPEN_DATE, cashTeller.getOpenDate());
         pstCashTeller.setLong(FLD_SPV_OPEN_ID, cashTeller.getSpvOpenId());
         pstCashTeller.setString(FLD_SPV_OPEN_NAME, cashTeller.getSpvOpenName());
         pstCashTeller.setLong(FLD_SPV_CLOSE_ID, cashTeller.getSpvCloseId());
         pstCashTeller.setString(FLD_SPV_CLOSE_NAME, cashTeller.getSpvCloseName());
         pstCashTeller.setLong(FLD_SHIFT_ID, cashTeller.getShiftId());
         pstCashTeller.setDate(FLD_CLOSE_DATE, cashTeller.getCloseDate());
         pstCashTeller.setInt(FLD_STATUS, cashTeller.getStatus());
         pstCashTeller.insertByOid(cashTeller.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstCashTeller(0), DBException.UNKNOWN);
      }
      return cashTeller.getOID();
   }
}
