...
public class PstKolektibilitasPembayaranDetails extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static int findLimitCommand(int start, int recordToGet, int vectSize) {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         KolektibilitasPembayaranDetails kolektibilitasPembayaranDetails = PstKolektibilitasPembayaranDetails.fetchExc(oid);
         object.put(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_KOLEKTIBILITASDETAILID], kolektibilitasPembayaranDetails.getOID());
         object.put(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_KOLEKTIBILITASID], kolektibilitasPembayaranDetails.getKolektibilitasId());
         object.put(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_TIPEKREIDT], kolektibilitasPembayaranDetails.getTipeKreidt());
         object.put(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_MAXHARITUNGGAKANPOKOK], kolektibilitasPembayaranDetails.getMaxHariTunggakanPokok());
         object.put(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_MAXHARIJUMLAHTUNGGAKANBUNGA], kolektibilitasPembayaranDetails.getMaxHariJumlahTunggakanBunga());
      }catch(Exception exc){}
      return object;
   }
     ...
     public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_KOLEKTIBILITASDETAILID],0);
         if (oid > 0){
          KolektibilitasPembayaranDetails kolektibilitasPembayaranDetails = new KolektibilitasPembayaranDetails();
          kolektibilitasPembayaranDetails.setOID(jSONObject.optLong(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_KOLEKTIBILITASDETAILID],0));
          kolektibilitasPembayaranDetails.setKolektibilitasId(jSONObject.optLong(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_KOLEKTIBILITASID],0));
          kolektibilitasPembayaranDetails.setTipeKreidt(jSONObject.optInt(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_TIPEKREIDT],0));
          kolektibilitasPembayaranDetails.setMaxHariTunggakanPokok(jSONObject.optInt(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_MAXHARITUNGGAKANPOKOK],0));
          kolektibilitasPembayaranDetails.setMaxHariJumlahTunggakanBunga(jSONObject.optInt(PstKolektibilitasPembayaranDetails.fieldNames[PstKolektibilitasPembayaranDetails.FLD_MAXHARIJUMLAHTUNGGAKANBUNGA],0));
         boolean checkOidKolektibilitasPembayaranDetails = PstKolektibilitasPembayaranDetails.checkOID(oid);
          try{
            if(checkOidKolektibilitasPembayaranDetails){
               PstKolektibilitasPembayaranDetails.updateExc(kolektibilitasPembayaranDetails);
            }else{
               PstKolektibilitasPembayaranDetails.insertByOid(kolektibilitasPembayaranDetails);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(KolektibilitasPembayaranDetails kolektibilitasPembayaranDetails) throws DBException {
      try {
         PstKolektibilitasPembayaranDetails pstKolektibilitasPembayaranDetails = new PstKolektibilitasPembayaranDetails(0);
         pstKolektibilitasPembayaranDetails.setLong(FLD_KOLEKTIBILITASDETAILID, kolektibilitasPembayaranDetails.getOID());
         pstKolektibilitasPembayaranDetails.setLong(FLD_KOLEKTIBILITASID, kolektibilitasPembayaranDetails.getKolektibilitasId());
         pstKolektibilitasPembayaranDetails.setInt(FLD_TIPEKREIDT, kolektibilitasPembayaranDetails.getTipeKreidt());
         pstKolektibilitasPembayaranDetails.setInt(FLD_MAXHARITUNGGAKANPOKOK, kolektibilitasPembayaranDetails.getMaxHariTunggakanPokok());
         pstKolektibilitasPembayaranDetails.setInt(FLD_MAXHARIJUMLAHTUNGGAKANBUNGA, kolektibilitasPembayaranDetails.getMaxHariJumlahTunggakanBunga());
         pstKolektibilitasPembayaranDetails.insertByOid(kolektibilitasPembayaranDetails.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstKolektibilitasPembayaranDetails(0), DBException.UNKNOWN);
      }
      return kolektibilitasPembayaranDetails.getOID();
   }
}
