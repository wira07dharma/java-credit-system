...
//        entAssignContactTabungan.setSimpananId(rs.getLong(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_SIMPANAN]));
  ...
  public static int findLimitCommand(int start, int recordToGet, int vectSize) {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         AssignContactTabungan assignContactTabungan = PstAssignContactTabungan.fetchExc(oid);
         object.put(PstAssignContactTabungan.fieldNames[PstAssignContactTabungan.FLD_ASSIGN_TABUNGAN_ID], assignContactTabungan.getOID());
         object.put(PstAssignContactTabungan.fieldNames[PstAssignContactTabungan.FLD_MASTER_TABUNGAN_ID], assignContactTabungan.getMasterTabunganId());
         object.put(PstAssignContactTabungan.fieldNames[PstAssignContactTabungan.FLD_CONTACT_ID], assignContactTabungan.getContactId());
         object.put(PstAssignContactTabungan.fieldNames[PstAssignContactTabungan.FLD_NO_TABUNGAN], assignContactTabungan.getNoTabungan());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstAssignContactTabungan.fieldNames[PstAssignContactTabungan.FLD_ASSIGN_TABUNGAN_ID],0);
         if (oid > 0){
          AssignContactTabungan assignContactTabungan = new AssignContactTabungan();
          assignContactTabungan.setOID(jSONObject.optLong(PstAssignContactTabungan.fieldNames[PstAssignContactTabungan.FLD_ASSIGN_TABUNGAN_ID],0));
          assignContactTabungan.setMasterTabunganId(jSONObject.optLong(PstAssignContactTabungan.fieldNames[PstAssignContactTabungan.FLD_MASTER_TABUNGAN_ID],0));
          assignContactTabungan.setContactId(jSONObject.optLong(PstAssignContactTabungan.fieldNames[PstAssignContactTabungan.FLD_CONTACT_ID],0));
          assignContactTabungan.setNoTabungan(jSONObject.optString(PstAssignContactTabungan.fieldNames[PstAssignContactTabungan.FLD_NO_TABUNGAN], ""));
         boolean checkOidAssignContactTabungan = PstAssignContactTabungan.checkOID(oid);
          try{
            if(checkOidAssignContactTabungan){
               PstAssignContactTabungan.updateExc(assignContactTabungan);
            }else{
               PstAssignContactTabungan.insertByOid(assignContactTabungan);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(AssignContactTabungan assignContactTabungan) throws DBException {
      try {
         PstAssignContactTabungan pstAssignContactTabungan = new PstAssignContactTabungan(0);
         pstAssignContactTabungan.setLong(FLD_ASSIGN_TABUNGAN_ID, assignContactTabungan.getOID());
         pstAssignContactTabungan.setLong(FLD_MASTER_TABUNGAN_ID, assignContactTabungan.getMasterTabunganId());
         pstAssignContactTabungan.setLong(FLD_CONTACT_ID, assignContactTabungan.getContactId());
         pstAssignContactTabungan.setString(FLD_NO_TABUNGAN, assignContactTabungan.getNoTabungan());
         pstAssignContactTabungan.insertByOid(assignContactTabungan.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstAssignContactTabungan(0), DBException.UNKNOWN);
      }
      return assignContactTabungan.getOID();
   }
}
