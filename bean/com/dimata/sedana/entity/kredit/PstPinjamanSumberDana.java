...
public class PstPinjamanSumberDana extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         PinjamanSumberDana pinjamanSumberDana = PstPinjamanSumberDana.fetchExc(oid);
         object.put(PstPinjamanSumberDana.fieldNames[PstPinjamanSumberDana.FLD_AISO_PINJAMAN_SUMBER_DANA_ID], pinjamanSumberDana.getOID());
         object.put(PstPinjamanSumberDana.fieldNames[PstPinjamanSumberDana.FLD_PINJAMAN_ID], pinjamanSumberDana.getPinjamanId());
         object.put(PstPinjamanSumberDana.fieldNames[PstPinjamanSumberDana.FLD_SUMBER_DANA_ID], pinjamanSumberDana.getSumberDanaId());
         object.put(PstPinjamanSumberDana.fieldNames[PstPinjamanSumberDana.FLD_JUMLAH_DANA], pinjamanSumberDana.getJumlahDana());
      }catch(Exception exc){}
      return object;
   }
      ...
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstPinjamanSumberDana.fieldNames[PstPinjamanSumberDana.FLD_AISO_PINJAMAN_SUMBER_DANA_ID],0);
         if (oid > 0){
          PinjamanSumberDana pinjamanSumberDana = new PinjamanSumberDana();
          pinjamanSumberDana.setOID(jSONObject.optLong(PstPinjamanSumberDana.fieldNames[PstPinjamanSumberDana.FLD_AISO_PINJAMAN_SUMBER_DANA_ID],0));
          pinjamanSumberDana.setPinjamanId(jSONObject.optLong(PstPinjamanSumberDana.fieldNames[PstPinjamanSumberDana.FLD_PINJAMAN_ID],0));
          pinjamanSumberDana.setSumberDanaId(jSONObject.optLong(PstPinjamanSumberDana.fieldNames[PstPinjamanSumberDana.FLD_SUMBER_DANA_ID],0));
          pinjamanSumberDana.setJumlahDana(jSONObject.optDouble(PstPinjamanSumberDana.fieldNames[PstPinjamanSumberDana.FLD_JUMLAH_DANA],0));
         boolean checkOidPinjamanSumberDana = PstPinjamanSumberDana.checkOID(oid);
          try{
            if(checkOidPinjamanSumberDana){
               PstPinjamanSumberDana.updateExc(pinjamanSumberDana);
            }else{
               PstPinjamanSumberDana.insertByOid(pinjamanSumberDana);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(PinjamanSumberDana pinjamanSumberDana) throws DBException {
      try {
         PstPinjamanSumberDana pstPinjamanSumberDana = new PstPinjamanSumberDana(0);
         pstPinjamanSumberDana.setLong(FLD_AISO_PINJAMAN_SUMBER_DANA_ID, pinjamanSumberDana.getOID());
         pstPinjamanSumberDana.setLong(FLD_PINJAMAN_ID, pinjamanSumberDana.getPinjamanId());
         pstPinjamanSumberDana.setLong(FLD_SUMBER_DANA_ID, pinjamanSumberDana.getSumberDanaId());
         pstPinjamanSumberDana.setDouble(FLD_JUMLAH_DANA, pinjamanSumberDana.getJumlahDana());
         pstPinjamanSumberDana.insertByOid(pinjamanSumberDana.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstPinjamanSumberDana(0), DBException.UNKNOWN);
      }
      return pinjamanSumberDana.getOID();
   }
