...
public class PstAssignSumberDanaJenisKredit extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static int findLimitCommand(int start, int recordToGet, int vectSize) {
    ...
    public static JSONObject fetchJSON(long oid){
      ...
      try {
         AssignSumberDanaJenisKredit assignSumberDanaJenisKredit = PstAssignSumberDanaJenisKredit.fetchExc(oid);
         object.put(PstAssignSumberDanaJenisKredit.fieldNames[PstAssignSumberDanaJenisKredit.FLD_ASSIGN_SUMBER_DANA_JENIS_KREDIT_ID], assignSumberDanaJenisKredit.getOID());
         object.put(PstAssignSumberDanaJenisKredit.fieldNames[PstAssignSumberDanaJenisKredit.FLD_SUMBER_DANA_ID], assignSumberDanaJenisKredit.getSumberDanaId());
         object.put(PstAssignSumberDanaJenisKredit.fieldNames[PstAssignSumberDanaJenisKredit.FLD_TYPE_KREDIT_ID], assignSumberDanaJenisKredit.getTypeKreditId());
         object.put(PstAssignSumberDanaJenisKredit.fieldNames[PstAssignSumberDanaJenisKredit.FLD_MAX_PERSENTASE_PENGGUNAAN], assignSumberDanaJenisKredit.getMaxPersentasePenggunaan());
      }catch(Exception exc){}
      return object;
   }
      ...
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstAssignSumberDanaJenisKredit.fieldNames[PstAssignSumberDanaJenisKredit.FLD_ASSIGN_SUMBER_DANA_JENIS_KREDIT_ID],0);
         if (oid > 0){
          AssignSumberDanaJenisKredit assignSumberDanaJenisKredit = new AssignSumberDanaJenisKredit();
          assignSumberDanaJenisKredit.setOID(jSONObject.optLong(PstAssignSumberDanaJenisKredit.fieldNames[PstAssignSumberDanaJenisKredit.FLD_ASSIGN_SUMBER_DANA_JENIS_KREDIT_ID],0));
          assignSumberDanaJenisKredit.setSumberDanaId(jSONObject.optLong(PstAssignSumberDanaJenisKredit.fieldNames[PstAssignSumberDanaJenisKredit.FLD_SUMBER_DANA_ID],0));
          assignSumberDanaJenisKredit.setTypeKreditId(jSONObject.optLong(PstAssignSumberDanaJenisKredit.fieldNames[PstAssignSumberDanaJenisKredit.FLD_TYPE_KREDIT_ID],0));
          assignSumberDanaJenisKredit.setMaxPersentasePenggunaan(Float.valueOf(jSONObject.optString(PstAssignSumberDanaJenisKredit.fieldNames[PstAssignSumberDanaJenisKredit.FLD_MAX_PERSENTASE_PENGGUNAAN],"")));
         boolean checkOidAssignSumberDanaJenisKredit = PstAssignSumberDanaJenisKredit.checkOID(oid);
          try{
            if(checkOidAssignSumberDanaJenisKredit){
               PstAssignSumberDanaJenisKredit.updateExc(assignSumberDanaJenisKredit);
            }else{
               PstAssignSumberDanaJenisKredit.insertByOid(assignSumberDanaJenisKredit);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(AssignSumberDanaJenisKredit assignSumberDanaJenisKredit) throws DBException {
      try {
         PstAssignSumberDanaJenisKredit pstAssignSumberDanaJenisKredit = new PstAssignSumberDanaJenisKredit(0);
         pstAssignSumberDanaJenisKredit.setLong(FLD_ASSIGN_SUMBER_DANA_JENIS_KREDIT_ID, assignSumberDanaJenisKredit.getOID());
         pstAssignSumberDanaJenisKredit.setLong(FLD_SUMBER_DANA_ID, assignSumberDanaJenisKredit.getSumberDanaId());
         pstAssignSumberDanaJenisKredit.setLong(FLD_TYPE_KREDIT_ID, assignSumberDanaJenisKredit.getTypeKreditId());
         pstAssignSumberDanaJenisKredit.setDouble(FLD_MAX_PERSENTASE_PENGGUNAAN, assignSumberDanaJenisKredit.getMaxPersentasePenggunaan());
         pstAssignSumberDanaJenisKredit.insertByOid(assignSumberDanaJenisKredit.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstAssignSumberDanaJenisKredit(0), DBException.UNKNOWN);
      }
      return assignSumberDanaJenisKredit.getOID();
   }
}
