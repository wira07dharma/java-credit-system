...
public class PstTypeKredit extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_CATEGORY_ID = 22;
    ...
    public static JenisKredit fetchExc(long oid) throws DBException {
        try {
            ...
            entTypeKredit.setCategoryId(pstTypeKredit.getlong(FLD_CATEGORY_ID));
    ...
    public static synchronized long updateExc(JenisKredit entTypeKredit) throws DBException {
        try {
            if (entTypeKredit.getOID() != 0) {
                ...
                pstTypeKredit.setLong(FLD_CATEGORY_ID, entTypeKredit.getCategoryId());
    ...
    public static void resultToObject(ResultSet rs, TypeKredit entTypeKredit) {
        try {
            ...
            entTypeKredit.setCategoryId(rs.getLong(PstTypeKredit.fieldNames[PstTypeKredit.FLD_CATEGORY_ID]));
        } catch (Exception e) {
        }
    }
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         JenisKredit jenisKredit = PstTypeKredit.fetchExc(oid);
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TYPE_KREDIT_ID], jenisKredit.getOID());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_NAME_KREDIT], jenisKredit.getNamaKredit());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_MIN_KREDIT], jenisKredit.getMinKredit());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_MAX_KREDIT], jenisKredit.getMaxKredit());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TIPE_BUNGA], jenisKredit.getTipeBunga());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BUNGA_MIN], jenisKredit.getBungaMin());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BUNGA_MAX], jenisKredit.getBungaMax());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BIAYA_ADMIN], jenisKredit.getBiayaAdmin());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_PROVISI], jenisKredit.getProvisi());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_DENDA], jenisKredit.getDenda());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BERLAKU_MULAI], jenisKredit.getBerlakuMulai());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BERLAKU_SAMPAI], jenisKredit.getBerlakuSampai());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_JANGKA_WAKTU_MIN], jenisKredit.getJangkaWaktuMin());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_JANGKA_WAKTU_MAX], jenisKredit.getJangkaWaktuMax());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_KEGUNAAN], jenisKredit.getKegunaan());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_PERIODE_PEMBAYARAN], jenisKredit.getPeriodePembayaran());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_KATEGORI_KREDIT_ID], jenisKredit.getKategoriKreditId());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TIPE_DENDA_BERLAKU], jenisKredit.getDendaToleransi());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TIPE_PERHITUNGAN_DENDA], jenisKredit.getTipeDendaBerlaku());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_FREKUENSI_DENDA], jenisKredit.getTipePerhitunganDenda());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_SATUAN_FREKUANSI_DENDA], jenisKredit.getPersentaseWajib());
         object.put(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TIPE_FREKUENSI_POKOK], jenisKredit.getFrekuensiDenda());
      }catch(Exception exc){}
      return object;
   }
      ...
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TYPE_KREDIT_ID],0);
         if (oid > 0){
          JenisKredit jenisKredit = new JenisKredit();
          jenisKredit.setOID(jSONObject.optLong(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TYPE_KREDIT_ID],0));
          jenisKredit.setNamaKredit(jSONObject.optString(PstTypeKredit.fieldNames[PstTypeKredit.FLD_NAME_KREDIT], ""));
          jenisKredit.setMinKredit(jSONObject.optLong(PstTypeKredit.fieldNames[PstTypeKredit.FLD_MIN_KREDIT],0));
          jenisKredit.setMaxKredit(jSONObject.optLong(PstTypeKredit.fieldNames[PstTypeKredit.FLD_MAX_KREDIT],0));
          jenisKredit.setTipeBunga(jSONObject.optInt(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TIPE_BUNGA],0));
          jenisKredit.setBungaMin(jSONObject.optDouble(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BUNGA_MIN],0));
          jenisKredit.setBungaMax(jSONObject.optDouble(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BUNGA_MAX],0));
          jenisKredit.setBiayaAdmin(jSONObject.optLong(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BIAYA_ADMIN],0));
          jenisKredit.setProvisi(jSONObject.optLong(PstTypeKredit.fieldNames[PstTypeKredit.FLD_PROVISI],0));
          jenisKredit.setDenda(jSONObject.optDouble(PstTypeKredit.fieldNames[PstTypeKredit.FLD_DENDA],0));
          jenisKredit.setBerlakuMulai(Formater.formatDate(jSONObject.optString(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BERLAKU_MULAI],"0000-00-00"),"yyyy-MM-dd"));
          jenisKredit.setBerlakuSampai(Formater.formatDate(jSONObject.optString(PstTypeKredit.fieldNames[PstTypeKredit.FLD_BERLAKU_SAMPAI],"0000-00-00"),"yyyy-MM-dd"));
          jenisKredit.setJangkaWaktuMin(Float.valueOf(jSONObject.optString(PstTypeKredit.fieldNames[PstTypeKredit.FLD_JANGKA_WAKTU_MIN],"")));
          jenisKredit.setJangkaWaktuMax(Float.valueOf(jSONObject.optString(PstTypeKredit.fieldNames[PstTypeKredit.FLD_JANGKA_WAKTU_MAX],"")));
          jenisKredit.setKegunaan(jSONObject.optString(PstTypeKredit.fieldNames[PstTypeKredit.FLD_KEGUNAAN], ""));
          jenisKredit.setPeriodePembayaran(jSONObject.optInt(PstTypeKredit.fieldNames[PstTypeKredit.FLD_PERIODE_PEMBAYARAN],0));
          jenisKredit.setKategoriKreditId(jSONObject.optLong(PstTypeKredit.fieldNames[PstTypeKredit.FLD_KATEGORI_KREDIT_ID],0));
          jenisKredit.setTipeDendaBerlaku(jSONObject.optInt(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TIPE_DENDA_BERLAKU],0));
          jenisKredit.setTipePerhitunganDenda(jSONObject.optInt(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TIPE_PERHITUNGAN_DENDA],0));
          jenisKredit.setFrekuensiDenda(jSONObject.optInt(PstTypeKredit.fieldNames[PstTypeKredit.FLD_FREKUENSI_DENDA],0));
          jenisKredit.setSatuanFrekuensiDenda(jSONObject.optInt(PstTypeKredit.fieldNames[PstTypeKredit.FLD_SATUAN_FREKUANSI_DENDA],0));
          jenisKredit.setTipeFrekuensiPokok(jSONObject.optInt(PstTypeKredit.fieldNames[PstTypeKredit.FLD_TIPE_FREKUENSI_POKOK],0));
         boolean checkOidJenisKredit = PstTypeKredit.checkOID(oid);
          try{
            if(checkOidJenisKredit){
               PstTypeKredit.updateExc(jenisKredit);
            }else{
               PstTypeKredit.insertByOid(jenisKredit);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(JenisKredit jenisKredit) throws DBException {
      try {
         PstTypeKredit pstTypeKredit = new PstTypeKredit(0);
         pstTypeKredit.setLong(FLD_TYPE_KREDIT_ID, jenisKredit.getOID());
         pstTypeKredit.setString(FLD_NAME_KREDIT, jenisKredit.getNamaKredit());
         pstTypeKredit.setDouble(FLD_MIN_KREDIT, jenisKredit.getMinKredit());
         pstTypeKredit.setDouble(FLD_MAX_KREDIT, jenisKredit.getMaxKredit());
         pstTypeKredit.setInt(FLD_TIPE_BUNGA, jenisKredit.getTipeBunga());
         pstTypeKredit.setDouble(FLD_BUNGA_MIN, jenisKredit.getBungaMin());
         pstTypeKredit.setDouble(FLD_BUNGA_MAX, jenisKredit.getBungaMax());
         pstTypeKredit.setDouble(FLD_BIAYA_ADMIN, jenisKredit.getBiayaAdmin());
         pstTypeKredit.setDouble(FLD_PROVISI, jenisKredit.getProvisi());
         pstTypeKredit.setDouble(FLD_DENDA, jenisKredit.getDenda());
         pstTypeKredit.setDate(FLD_BERLAKU_MULAI, jenisKredit.getBerlakuMulai());
         pstTypeKredit.setDate(FLD_BERLAKU_SAMPAI, jenisKredit.getBerlakuSampai());
         pstTypeKredit.setDouble(FLD_JANGKA_WAKTU_MIN, jenisKredit.getJangkaWaktuMin());
         pstTypeKredit.setDouble(FLD_JANGKA_WAKTU_MAX, jenisKredit.getJangkaWaktuMax());
         pstTypeKredit.setString(FLD_KEGUNAAN, jenisKredit.getKegunaan());
         pstTypeKredit.setInt(FLD_PERIODE_PEMBAYARAN, jenisKredit.getPeriodePembayaran());
         pstTypeKredit.setLong(FLD_KATEGORI_KREDIT_ID, jenisKredit.getKategoriKreditId());
         pstTypeKredit.setInt(FLD_TIPE_DENDA_BERLAKU, jenisKredit.getTipeDendaBerlaku());
         pstTypeKredit.setInt(FLD_TIPE_PERHITUNGAN_DENDA, jenisKredit.getTipePerhitunganDenda());
         pstTypeKredit.setInt(FLD_FREKUENSI_DENDA, jenisKredit.getFrekuensiDenda());
         pstTypeKredit.setInt(FLD_SATUAN_FREKUANSI_DENDA, jenisKredit.getSatuanFrekuensiDenda());
         pstTypeKredit.setInt(FLD_TIPE_FREKUENSI_POKOK, jenisKredit.getTipeFrekuensiPokok());
         pstTypeKredit.insertByOid(jenisKredit.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstTypeKredit(0), DBException.UNKNOWN);
      }
      return jenisKredit.getOID();
   }
