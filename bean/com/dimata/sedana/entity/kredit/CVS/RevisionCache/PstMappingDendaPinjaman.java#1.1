...
public class PstMappingDendaPinjaman extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         MappingDendaPinjaman mappingDendaPinjaman = PstMappingDendaPinjaman.fetchExc(oid);
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_ID_MAPPING_DENDA], mappingDendaPinjaman.getOID());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_NILAI_DENDA], mappingDendaPinjaman.getNilaiDenda());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_TIPE_DENDA_BERLAKU], mappingDendaPinjaman.getTipeDendaBerlaku());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_TIPE_PERHITUNGAN_DENDA], mappingDendaPinjaman.getTipePerhitunganDenda());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_FREKUENSI_DENDA], mappingDendaPinjaman.getFrekuensiDenda());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_SATUAN_FREKUENSI_DENDA], mappingDendaPinjaman.getSatuanFrekuensiDenda());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_PINJAMAN_ID], mappingDendaPinjaman.getPinjamanId());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_DENDA_TOLERANSI], mappingDendaPinjaman.getDendaToleransi());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_VARIABEL_DENDA], mappingDendaPinjaman.getVariabelDenda());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_JENIS_ANGSURAN], mappingDendaPinjaman.getJenisAngsuran());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_TIPE_VARIABEL_DENDA], mappingDendaPinjaman.getTipeVariabelDenda());
         object.put(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_TIPE_FREKUENSI_DENDA], mappingDendaPinjaman.getTipeFrekuensiDenda());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_ID_MAPPING_DENDA],0);
         if (oid > 0){
          MappingDendaPinjaman mappingDendaPinjaman = new MappingDendaPinjaman();
          mappingDendaPinjaman.setOID(jSONObject.optLong(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_ID_MAPPING_DENDA],0));
          mappingDendaPinjaman.setNilaiDenda(jSONObject.optDouble(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_NILAI_DENDA],0));
          mappingDendaPinjaman.setTipeDendaBerlaku(jSONObject.optInt(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_TIPE_DENDA_BERLAKU],0));
          mappingDendaPinjaman.setTipePerhitunganDenda(jSONObject.optInt(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_TIPE_PERHITUNGAN_DENDA],0));
          mappingDendaPinjaman.setFrekuensiDenda(jSONObject.optInt(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_FREKUENSI_DENDA],0));
          mappingDendaPinjaman.setSatuanFrekuensiDenda(jSONObject.optInt(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_SATUAN_FREKUENSI_DENDA],0));
          mappingDendaPinjaman.setPinjamanId(jSONObject.optLong(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_PINJAMAN_ID],0));
          mappingDendaPinjaman.setDendaToleransi(jSONObject.optInt(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_DENDA_TOLERANSI],0));
          mappingDendaPinjaman.setVariabelDenda(jSONObject.optInt(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_VARIABEL_DENDA],0));
          mappingDendaPinjaman.setJenisAngsuran(jSONObject.optInt(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_JENIS_ANGSURAN],0));
          mappingDendaPinjaman.setTipeVariabelDenda(jSONObject.optInt(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_TIPE_VARIABEL_DENDA],0));
          mappingDendaPinjaman.setTipeFrekuensiDenda(jSONObject.optInt(PstMappingDendaPinjaman.fieldNames[PstMappingDendaPinjaman.FLD_TIPE_FREKUENSI_DENDA],0));
         boolean checkOidMappingDendaPinjaman = PstMappingDendaPinjaman.checkOID(oid);
          try{
            if(checkOidMappingDendaPinjaman){
               PstMappingDendaPinjaman.updateExc(mappingDendaPinjaman);
            }else{
               PstMappingDendaPinjaman.insertByOid(mappingDendaPinjaman);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(MappingDendaPinjaman mappingDendaPinjaman) throws DBException {
      try {
         PstMappingDendaPinjaman pstMappingDendaPinjaman = new PstMappingDendaPinjaman(0);
         pstMappingDendaPinjaman.setLong(FLD_ID_MAPPING_DENDA, mappingDendaPinjaman.getOID());
         pstMappingDendaPinjaman.setDouble(FLD_NILAI_DENDA, mappingDendaPinjaman.getNilaiDenda());
         pstMappingDendaPinjaman.setInt(FLD_TIPE_DENDA_BERLAKU, mappingDendaPinjaman.getTipeDendaBerlaku());
         pstMappingDendaPinjaman.setInt(FLD_TIPE_PERHITUNGAN_DENDA, mappingDendaPinjaman.getTipePerhitunganDenda());
         pstMappingDendaPinjaman.setInt(FLD_FREKUENSI_DENDA, mappingDendaPinjaman.getFrekuensiDenda());
         pstMappingDendaPinjaman.setInt(FLD_SATUAN_FREKUENSI_DENDA, mappingDendaPinjaman.getSatuanFrekuensiDenda());
         pstMappingDendaPinjaman.setLong(FLD_PINJAMAN_ID, mappingDendaPinjaman.getPinjamanId());
         pstMappingDendaPinjaman.setInt(FLD_DENDA_TOLERANSI, mappingDendaPinjaman.getDendaToleransi());
         pstMappingDendaPinjaman.setInt(FLD_VARIABEL_DENDA, mappingDendaPinjaman.getVariabelDenda());
         pstMappingDendaPinjaman.setInt(FLD_JENIS_ANGSURAN, mappingDendaPinjaman.getJenisAngsuran());
         pstMappingDendaPinjaman.setInt(FLD_TIPE_VARIABEL_DENDA, mappingDendaPinjaman.getTipeVariabelDenda());
         pstMappingDendaPinjaman.setInt(FLD_TIPE_FREKUENSI_DENDA , mappingDendaPinjaman.getTipeFrekuensiDenda());
         pstMappingDendaPinjaman.insertByOid(mappingDendaPinjaman.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstMappingDendaPinjaman(0), DBException.UNKNOWN);
      }
      return mappingDendaPinjaman.getOID();
   }
}
