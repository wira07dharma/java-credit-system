...
public class AngsuranPayment extends Entity {
    ...
    public static final int TIPE_PAYMENT_POTONG_KOMISI = 23;
    ...
    public static String getTipePaymentTitle(int tipe) {
        switch (tipe) {
            ...
            case TIPE_PAYMENT_POTONG_KOMISI:
                return TIPE_PAYMENT_TITLE[8];
            default:
                return "Not defined";
        }
    }
    ...
    public static final TreeMap<Integer, String> TIPE_PAYMENT = new TreeMap<Integer, String>(){{
      ...
      put(TIPE_PAYMENT_POTONG_KOMISI, TIPE_PAYMENT_TITLE[8]);
    }};
