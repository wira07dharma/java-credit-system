...
public class PstAngsuranPayment extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         AngsuranPayment angsuranPayment = PstAngsuranPayment.fetchExc(oid);
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_ANGSURAN_PAYMENT_ID], angsuranPayment.getOID());
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_PAYMENT_SYSTEM_ID], angsuranPayment.getPaymentSystemId());
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_JUMLAH], angsuranPayment.getJumlah());
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_CARD_NAME], angsuranPayment.getCardName());
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_CARD_NO], angsuranPayment.getCardNumber());
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_BANK_NAME], angsuranPayment.getBankName());
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_VALIDATE_DATE], angsuranPayment.getValidateDate());
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_STATUS], angsuranPayment.getStatus());
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_TRANSAKSI_ID], angsuranPayment.getTransaksiId());
         object.put(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_ID_SIMPANAN], angsuranPayment.getIdSimpanan());
      }catch(Exception exc){}
      return object;
   } 
  ...
  public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_ANGSURAN_PAYMENT_ID],0);
         if (oid > 0){
          AngsuranPayment angsuranPayment = new AngsuranPayment();
          angsuranPayment.setOID(jSONObject.optLong(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_ANGSURAN_PAYMENT_ID],0));
          angsuranPayment.setPaymentSystemId(jSONObject.optLong(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_PAYMENT_SYSTEM_ID],0));
          angsuranPayment.setJumlah(jSONObject.optDouble(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_JUMLAH],0));
          angsuranPayment.setCardName(jSONObject.optString(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_CARD_NAME], ""));
          angsuranPayment.setCardNumber(jSONObject.optString(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_CARD_NO], ""));
          angsuranPayment.setBankName(jSONObject.optString(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_BANK_NAME], ""));
          angsuranPayment.setValidateDate(Formater.formatDate(jSONObject.optString(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_VALIDATE_DATE],"0000-00-00"),"yyyy-MM-dd"));
          angsuranPayment.setStatus(jSONObject.optInt(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_STATUS],0));
          angsuranPayment.setTransaksiId(jSONObject.optLong(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_TRANSAKSI_ID],0));
          angsuranPayment.setIdSimpanan(jSONObject.optLong(PstAngsuranPayment.fieldNames[PstAngsuranPayment.FLD_ID_SIMPANAN],0));
         boolean checkOidAngsuranPayment = PstAngsuranPayment.checkOID(oid);
          try{
            if(checkOidAngsuranPayment){
               PstAngsuranPayment.updateExc(angsuranPayment);
            }else{
               PstAngsuranPayment.insertByOid(angsuranPayment);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(AngsuranPayment angsuranPayment) throws DBException {
      try {
         PstAngsuranPayment pstAngsuranPayment = new PstAngsuranPayment(0);
         pstAngsuranPayment.setLong(FLD_ANGSURAN_PAYMENT_ID, angsuranPayment.getOID());
         pstAngsuranPayment.setLong(FLD_PAYMENT_SYSTEM_ID, angsuranPayment.getPaymentSystemId());
         pstAngsuranPayment.setDouble(FLD_JUMLAH, angsuranPayment.getJumlah());
         pstAngsuranPayment.setString(FLD_CARD_NAME, angsuranPayment.getCardName());
         pstAngsuranPayment.setString(FLD_CARD_NO, angsuranPayment.getCardNumber());
         pstAngsuranPayment.setString(FLD_BANK_NAME, angsuranPayment.getBankName());
         pstAngsuranPayment.setDate(FLD_VALIDATE_DATE, angsuranPayment.getValidateDate());
         pstAngsuranPayment.setInt(FLD_STATUS, angsuranPayment.getStatus());
         pstAngsuranPayment.setLong(FLD_TRANSAKSI_ID, angsuranPayment.getTransaksiId());
         pstAngsuranPayment.setLong(FLD_ID_SIMPANAN, angsuranPayment.getIdSimpanan());
         pstAngsuranPayment.insertByOid(angsuranPayment.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstAngsuranPayment(0), DBException.UNKNOWN);
      }
      return angsuranPayment.getOID();
   }
