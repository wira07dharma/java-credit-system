...
public class Pinjaman extends Entity {
    ...
    public static final int STATUS_DOC_DIHAPUS = 12;
    ...
    public static String getStatusDocTitle(int code) {
        switch (code) {
            ...
            case STATUS_DOC_DIKIRIM:
                return STATUS_DOC_TITLE[10];
            case STATUS_DOC_DITERIMA:
                return STATUS_DOC_TITLE[11];
            case STATUS_DOC_DIHAPUS:
                return STATUS_DOC_TITLE[12];
            default:
                return "Not defined";
        }
    }
...
//            history += "<p><b>INSERT : </b>";
            ...
            history += "; Nomor " + namaNasabah + ": " + newAnggota.getNoAnggota();
            ...
            if (prevPinjaman.getAnggotaId() != newPinjaman.getAnggotaId()) {
                history += "Nomor " + namaNasabah + " : " + prevAnggota.getNoAnggota() + " changed to " + newAnggota.getNoAnggota() + "; ";
            }
            ...
            if (prevPinjaman.getAccountOfficerId() != newPinjaman.getAccountOfficerId()) {
                ...
                history += "Analyst  : " + tempOld.getName() + " changed to " + tempNew.getName() + "; ";
            }
