...
public class PstPengurusKelompok extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static int findLimitCommand(int start, int recordToGet, int vectSize) {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         PengurusKelompok pengurusKelompok = PstPengurusKelompok.fetchExc(oid);
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_ID_PENGURUS], pengurusKelompok.getOID());
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_NAMA_PENGURUS], pengurusKelompok.getNamaPengurus());
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_JENIS_KELAMIN], pengurusKelompok.getJenisKelamin());
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_STATUS_KEPEMILIKAN], pengurusKelompok.getStatusKepemilikan());
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_JABATAN], pengurusKelompok.getJabatan());
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_TELEPON], pengurusKelompok.getTelepon());
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_EMAIL], pengurusKelompok.getEmail());
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_ALAMAT], pengurusKelompok.getAlamat());
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_PROSENTASE_KEPENGURUSAN], pengurusKelompok.getProsentaseKepengurusan());
         object.put(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_ID_KELOMPOK], pengurusKelompok.getIdKelompok());
      }catch(Exception exc){}
      return object;
   }
      ...
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_ID_PENGURUS],0);
         if (oid > 0){
          PengurusKelompok pengurusKelompok = new PengurusKelompok();
          pengurusKelompok.setOID(jSONObject.optLong(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_ID_PENGURUS],0));
          pengurusKelompok.setNamaPengurus(jSONObject.optString(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_NAMA_PENGURUS], ""));
          pengurusKelompok.setJenisKelamin(jSONObject.optInt(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_JENIS_KELAMIN],0));
          pengurusKelompok.setStatusKepemilikan(jSONObject.optInt(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_STATUS_KEPEMILIKAN],0));
          pengurusKelompok.setJabatan(jSONObject.optLong(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_JABATAN],0));
          pengurusKelompok.setTelepon(jSONObject.optString(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_TELEPON], ""));
          pengurusKelompok.setEmail(jSONObject.optString(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_EMAIL], ""));
          pengurusKelompok.setAlamat(jSONObject.optString(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_ALAMAT], ""));
          pengurusKelompok.setProsentaseKepengurusan(jSONObject.optDouble(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_PROSENTASE_KEPENGURUSAN],0));
          pengurusKelompok.setIdKelompok(jSONObject.optLong(PstPengurusKelompok.fieldNames[PstPengurusKelompok.FLD_ID_KELOMPOK],0));
         boolean checkOidPengurusKelompok = PstPengurusKelompok.checkOID(oid);
          try{
            if(checkOidPengurusKelompok){
               PstPengurusKelompok.updateExc(pengurusKelompok);
            }else{
               PstPengurusKelompok.insertByOid(pengurusKelompok);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(PengurusKelompok pengurusKelompok) throws DBException {
      try {
         PstPengurusKelompok pstPengurusKelompok = new PstPengurusKelompok(0);
         pstPengurusKelompok.setLong(FLD_ID_PENGURUS, pengurusKelompok.getOID());
         pstPengurusKelompok.setString(FLD_NAMA_PENGURUS, pengurusKelompok.getNamaPengurus());
         pstPengurusKelompok.setInt(FLD_JENIS_KELAMIN, pengurusKelompok.getJenisKelamin());
         pstPengurusKelompok.setInt(FLD_STATUS_KEPEMILIKAN, pengurusKelompok.getStatusKepemilikan());
         pstPengurusKelompok.setLong(FLD_JABATAN, pengurusKelompok.getJabatan());
         pstPengurusKelompok.setString(FLD_TELEPON, pengurusKelompok.getTelepon());
         pstPengurusKelompok.setString(FLD_EMAIL, pengurusKelompok.getEmail());
         pstPengurusKelompok.setString(FLD_ALAMAT, pengurusKelompok.getAlamat());
         pstPengurusKelompok.setDouble(FLD_PROSENTASE_KEPENGURUSAN, pengurusKelompok.getProsentaseKepengurusan());
         pstPengurusKelompok.setLong(FLD_ID_KELOMPOK, pengurusKelompok.getIdKelompok());
         pstPengurusKelompok.insertByOid(pengurusKelompok.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstPengurusKelompok(0), DBException.UNKNOWN);
      }
      return pengurusKelompok.getOID();
   }
}
