...
public class PstSumberDana extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         SumberDana sumberDana = PstSumberDana.fetchExc(oid);
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_SUMBER_DANA_ID], sumberDana.getOID());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_CONTACT_ID], sumberDana.getContactId());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_JENIS_SUMBER_DANA], sumberDana.getJenisSumberDana());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_KODE_SUMBER_DANA], sumberDana.getKodeSumberDana());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_JUDUL_SUMBER_DANA], sumberDana.getJudulSumberDana());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_TARGET_PENDANAAN], sumberDana.getTargetPendanaan());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_PRIORITAS_PENGGUNAAN], sumberDana.getPrioritasPenggunaan());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_TOTAL_KETERSEDIAAN_DANA], sumberDana.getTotalKetersediaanDana());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_BIAYA_BUNGA_KE_KREDITUR], sumberDana.getBiayaBungaKeKreditur());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_TIPE_BUNGA_KE_KREDITUR], sumberDana.getTipeBungaKeKreditur());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_TANGGAL_DANA_MASUK], sumberDana.getTanggalDanaMasuk());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_TANGGAL_LUNAS_KE_KREDITUR], sumberDana.getTanggalLunasKeKreditur());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_TANGGAL_DANA_MULAI_TERSEDIA], sumberDana.getTanggalDanaMulaiTersedia());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_TANGGAL_AKHIR_TERSEDIA], sumberDana.getTanggalAkhirTersedia());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_MINIMUM_PINJAMAN_KE_DEBITUR], sumberDana.getMinimumPinjamanKeDebitur());
         object.put(PstSumberDana.fieldNames[PstSumberDana.FLD_MAXIMUM_PINJAMAN_KE_DEBITUR], sumberDana.getMaximumPinjamanKeDebitur());
      }catch(Exception exc){}
      return object;
   }
}
