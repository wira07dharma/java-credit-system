...
public class PstDataTabungan extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static String queryGetSimpananByJenisSimpanan(Vector<Long> js) {
    ...
    public static JSONObject fetchJSON(long oid){
      ...
      try {
         DataTabungan dataTabungan = PstDataTabungan.fetchExc(oid);
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_SIMPANAN], dataTabungan.getOID());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_ANGGOTA], dataTabungan.getIdAnggota());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_TANGGAL], dataTabungan.getTanggal());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_STATUS], dataTabungan.getStatus());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_KODE_TABUNGAN], dataTabungan.getKodeTabungan());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_CONTACT_ID_AHLI_WARIS], dataTabungan.getContactIdAhliWaris());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_TANGGAL_TUTUP], dataTabungan.getTanggalTutup());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ALASAN_TUTUP], dataTabungan.getAlasanTutup());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_CATATAN], dataTabungan.getCatatan());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ASSIGN_TABUNGAN_ID], dataTabungan.getAssignTabunganId());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_JENIS_SIMPANAN], dataTabungan.getIdJenisSimpanan());
         object.put(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_ALOKASI_BUNGA], dataTabungan.getIdAlokasiBunga());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_SIMPANAN],0);
         if (oid > 0){
          DataTabungan dataTabungan = new DataTabungan();
          dataTabungan.setOID(jSONObject.optLong(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_SIMPANAN],0));
          dataTabungan.setIdAnggota(jSONObject.optLong(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_ANGGOTA],0));
          dataTabungan.setTanggal(Formater.formatDate(jSONObject.optString(PstDataTabungan.fieldNames[PstDataTabungan.FLD_TANGGAL],"0000-00-00"),"yyyy-MM-dd"));
          dataTabungan.setStatus(jSONObject.optInt(PstDataTabungan.fieldNames[PstDataTabungan.FLD_STATUS],0));
          dataTabungan.setKodeTabungan(jSONObject.optString(PstDataTabungan.fieldNames[PstDataTabungan.FLD_KODE_TABUNGAN], ""));
          dataTabungan.setContactIdAhliWaris(jSONObject.optLong(PstDataTabungan.fieldNames[PstDataTabungan.FLD_CONTACT_ID_AHLI_WARIS],0));
          dataTabungan.setTanggalTutup(Formater.formatDate(jSONObject.optString(PstDataTabungan.fieldNames[PstDataTabungan.FLD_TANGGAL_TUTUP],"0000-00-00"),"yyyy-MM-dd"));
          dataTabungan.setAlasanTutup(jSONObject.optString(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ALASAN_TUTUP], ""));
          dataTabungan.setCatatan(jSONObject.optString(PstDataTabungan.fieldNames[PstDataTabungan.FLD_CATATAN], ""));
          dataTabungan.setAssignTabunganId(jSONObject.optLong(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ASSIGN_TABUNGAN_ID],0));
          dataTabungan.setIdJenisSimpanan(jSONObject.optLong(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_JENIS_SIMPANAN],0));
          dataTabungan.setIdAlokasiBunga(jSONObject.optLong(PstDataTabungan.fieldNames[PstDataTabungan.FLD_ID_ALOKASI_BUNGA],0));
         boolean checkOidDataTabungan = PstDataTabungan.checkOID(oid);
          try{
            if(checkOidDataTabungan){
               PstDataTabungan.updateExc(dataTabungan);
            }else{
               PstDataTabungan.insertByOid(dataTabungan);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(DataTabungan dataTabungan) throws DBException {
      try {
         PstDataTabungan pstDataTabungan = new PstDataTabungan(0);
         pstDataTabungan.setLong(FLD_ID_SIMPANAN, dataTabungan.getOID());
         pstDataTabungan.setLong(FLD_ID_ANGGOTA, dataTabungan.getIdAnggota());
         pstDataTabungan.setDate(FLD_TANGGAL, dataTabungan.getTanggal());
         pstDataTabungan.setInt(FLD_STATUS, dataTabungan.getStatus());
         pstDataTabungan.setString(FLD_KODE_TABUNGAN, dataTabungan.getKodeTabungan());
         pstDataTabungan.setLong(FLD_CONTACT_ID_AHLI_WARIS, dataTabungan.getContactIdAhliWaris());
         pstDataTabungan.setDate(FLD_TANGGAL_TUTUP, dataTabungan.getTanggalTutup());
         pstDataTabungan.setString(FLD_ALASAN_TUTUP, dataTabungan.getAlasanTutup());
         pstDataTabungan.setString(FLD_CATATAN, dataTabungan.getCatatan());
         pstDataTabungan.setLong(FLD_ASSIGN_TABUNGAN_ID, dataTabungan.getAssignTabunganId());
         pstDataTabungan.setLong(FLD_ID_JENIS_SIMPANAN, dataTabungan.getIdJenisSimpanan());
         pstDataTabungan.setLong(FLD_ID_ALOKASI_BUNGA , dataTabungan.getIdAlokasiBunga());
         pstDataTabungan.insertByOid(dataTabungan.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstDataTabungan(0), DBException.UNKNOWN);
      }
      return dataTabungan.getOID();
   }
