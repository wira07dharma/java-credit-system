...
public class PstMasterTabunganPenarikan extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static JSONObject fetchJSON(long oid){
      ...
      try {
         MasterTabunganPenarikan masterTabunganPenarikan = PstMasterTabunganPenarikan.fetchExc(oid);
         object.put(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_ID_TABUNGAN_RANGE_PENARIKAN], masterTabunganPenarikan.getOID());
         object.put(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_JUDUL_RANGE_PENARIKAN], masterTabunganPenarikan.getJudulRangePenarikan());
         object.put(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_TIPE_RANGE], masterTabunganPenarikan.getTipeRange());
         object.put(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_START_DATE], masterTabunganPenarikan.getStartDate());
         object.put(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_END_DATE], masterTabunganPenarikan.getEndDate());
         object.put(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_PERIODE_BULAN], masterTabunganPenarikan.getPeriodeBulan());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_ID_TABUNGAN_RANGE_PENARIKAN],0);
         if (oid > 0){
          MasterTabunganPenarikan masterTabunganPenarikan = new MasterTabunganPenarikan();
          masterTabunganPenarikan.setOID(jSONObject.optLong(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_ID_TABUNGAN_RANGE_PENARIKAN],0));
          masterTabunganPenarikan.setJudulRangePenarikan(jSONObject.optString(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_JUDUL_RANGE_PENARIKAN], ""));
          masterTabunganPenarikan.setTipeRange(jSONObject.optInt(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_TIPE_RANGE],0));
          masterTabunganPenarikan.setStartDate(Formater.formatDate(jSONObject.optString(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_START_DATE],"0000-00-00"),"yyyy-MM-dd"));
          masterTabunganPenarikan.setEndDate(Formater.formatDate(jSONObject.optString(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_END_DATE],"0000-00-00"),"yyyy-MM-dd"));
          masterTabunganPenarikan.setPeriodeBulan(jSONObject.optInt(PstMasterTabunganPenarikan.fieldNames[PstMasterTabunganPenarikan.FLD_PERIODE_BULAN],0));
         boolean checkOidMasterTabunganPenarikan = PstMasterTabunganPenarikan.checkOID(oid);
          try{
            if(checkOidMasterTabunganPenarikan){
               PstMasterTabunganPenarikan.updateExc(masterTabunganPenarikan);
            }else{
               PstMasterTabunganPenarikan.insertByOid(masterTabunganPenarikan);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(MasterTabunganPenarikan masterTabunganPenarikan) throws DBException {
      try {
         PstMasterTabunganPenarikan pstMasterTabunganPenarikan = new PstMasterTabunganPenarikan(0);
         pstMasterTabunganPenarikan.setLong(FLD_ID_TABUNGAN_RANGE_PENARIKAN, masterTabunganPenarikan.getOID());
         pstMasterTabunganPenarikan.setString(FLD_JUDUL_RANGE_PENARIKAN, masterTabunganPenarikan.getJudulRangePenarikan());
         pstMasterTabunganPenarikan.setInt(FLD_TIPE_RANGE, masterTabunganPenarikan.getTipeRange());
         pstMasterTabunganPenarikan.setDate(FLD_START_DATE, masterTabunganPenarikan.getStartDate());
         pstMasterTabunganPenarikan.setDate(FLD_END_DATE, masterTabunganPenarikan.getEndDate());
         pstMasterTabunganPenarikan.setInt(FLD_PERIODE_BULAN, masterTabunganPenarikan.getPeriodeBulan());
         pstMasterTabunganPenarikan.insertByOid(masterTabunganPenarikan.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstMasterTabunganPenarikan(0), DBException.UNKNOWN);
      }
      return masterTabunganPenarikan.getOID();
   }
}
