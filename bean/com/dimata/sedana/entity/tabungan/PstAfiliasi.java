  ...
  public static int findLimitCommand(int start, int recordToGet, int vectSize) {
    ...
    return cmd;
     ...
     public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstAfiliasi.fieldNames[PstAfiliasi.FLD_AFILIASI_ID],0);
         if (oid > 0){
          Afiliasi afiliasi = new Afiliasi();
          afiliasi.setOID(jSONObject.optLong(PstAfiliasi.fieldNames[PstAfiliasi.FLD_AFILIASI_ID],0));
          afiliasi.setFeeKoperasi(jSONObject.optLong(PstAfiliasi.fieldNames[PstAfiliasi.FLD_FEE_KOPERASI],0));
          afiliasi.setNameAfiliasi(jSONObject.optString(PstAfiliasi.fieldNames[PstAfiliasi.FLD_NAME_AFILIASI], ""));
          afiliasi.setAlamatAfiliasi(jSONObject.optString(PstAfiliasi.fieldNames[PstAfiliasi.FLD_ALAMAT_AFILIASI], ""));
         boolean checkOidAfiliasi = PstAfiliasi.checkOID(oid);
          try{
            if(checkOidAfiliasi){
               PstAfiliasi.updateExc(afiliasi);
            }else{
               PstAfiliasi.insertByOid(afiliasi);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(Afiliasi afiliasi) throws DBException {
      try {
         PstAfiliasi pstAfiliasi = new PstAfiliasi(0);
         pstAfiliasi.setLong(FLD_AFILIASI_ID, afiliasi.getOID());
         pstAfiliasi.setLong(FLD_FEE_KOPERASI, afiliasi.getFeeKoperasi());
         pstAfiliasi.setString(FLD_NAME_AFILIASI, afiliasi.getNameAfiliasi());
         pstAfiliasi.setString(FLD_ALAMAT_AFILIASI, afiliasi.getAlamatAfiliasi());
         pstAfiliasi.insertByOid(afiliasi.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstAfiliasi(0), DBException.UNKNOWN);
    ...
    public static JSONObject fetchJSON(long oid){
      ...
      try {
         Afiliasi afiliasi = PstAfiliasi.fetchExc(oid);
         object.put(PstAfiliasi.fieldNames[PstAfiliasi.FLD_AFILIASI_ID], afiliasi.getOID());
         object.put(PstAfiliasi.fieldNames[PstAfiliasi.FLD_FEE_KOPERASI], afiliasi.getFeeKoperasi());
         object.put(PstAfiliasi.fieldNames[PstAfiliasi.FLD_NAME_AFILIASI], afiliasi.getNameAfiliasi());
         object.put(PstAfiliasi.fieldNames[PstAfiliasi.FLD_ALAMAT_AFILIASI], afiliasi.getAlamatAfiliasi());
      }catch(Exception exc){}
      return object;
   }
}
