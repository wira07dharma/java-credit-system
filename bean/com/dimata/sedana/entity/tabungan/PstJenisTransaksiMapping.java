...
public class PstJenisTransaksiMapping extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static JSONObject fetchJSON(long oid){
      ...
      try {
         JenisTransaksiMapping jenisTransaksiMapping = PstJenisTransaksiMapping.fetchExc(oid);
         object.put(PstJenisTransaksiMapping.fieldNames[PstJenisTransaksiMapping.FLD_JENIS_TRANSAKSI_MAPPING_ID], jenisTransaksiMapping.getOID());
         object.put(PstJenisTransaksiMapping.fieldNames[PstJenisTransaksiMapping.FLD_JENIS_TRANSAKSI_ID], jenisTransaksiMapping.getJenisTransaksiId());
         object.put(PstJenisTransaksiMapping.fieldNames[PstJenisTransaksiMapping.FLD_ID_JENIS_SIMPANAN], jenisTransaksiMapping.getIdJenisSimpanan());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstJenisTransaksiMapping.fieldNames[PstJenisTransaksiMapping.FLD_JENIS_TRANSAKSI_MAPPING_ID],0);
         if (oid > 0){
          JenisTransaksiMapping jenisTransaksiMapping = new JenisTransaksiMapping();
          jenisTransaksiMapping.setOID(jSONObject.optLong(PstJenisTransaksiMapping.fieldNames[PstJenisTransaksiMapping.FLD_JENIS_TRANSAKSI_MAPPING_ID],0));
          jenisTransaksiMapping.setJenisTransaksiId(jSONObject.optLong(PstJenisTransaksiMapping.fieldNames[PstJenisTransaksiMapping.FLD_JENIS_TRANSAKSI_ID],0));
          jenisTransaksiMapping.setIdJenisSimpanan(jSONObject.optLong(PstJenisTransaksiMapping.fieldNames[PstJenisTransaksiMapping.FLD_ID_JENIS_SIMPANAN],0));
         boolean checkOidJenisTransaksiMapping = PstJenisTransaksiMapping.checkOID(oid);
          try{
            if(checkOidJenisTransaksiMapping){
               PstJenisTransaksiMapping.updateExc(jenisTransaksiMapping);
            }else{
               PstJenisTransaksiMapping.insertByOid(jenisTransaksiMapping);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(JenisTransaksiMapping jenisTransaksiMapping) throws DBException {
      try {
         PstJenisTransaksiMapping pstJenisTransaksiMapping = new PstJenisTransaksiMapping(0);
         pstJenisTransaksiMapping.setLong(FLD_JENIS_TRANSAKSI_MAPPING_ID, jenisTransaksiMapping.getOID());
         pstJenisTransaksiMapping.setLong(FLD_JENIS_TRANSAKSI_ID, jenisTransaksiMapping.getJenisTransaksiId());
         pstJenisTransaksiMapping.setLong(FLD_ID_JENIS_SIMPANAN, jenisTransaksiMapping.getIdJenisSimpanan());
         pstJenisTransaksiMapping.insertByOid(jenisTransaksiMapping.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstJenisTransaksiMapping(0), DBException.UNKNOWN);
      }
      return jenisTransaksiMapping.getOID();
   }
}
