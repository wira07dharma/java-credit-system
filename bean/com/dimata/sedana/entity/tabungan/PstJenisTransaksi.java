...
public class PstJenisTransaksi extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language, I_Sedana {
    ...
    public static long getIdJenisTransaksiByPinjamanId(long pinajamanId, int tipeDoc) {
      ...
      try {
         JenisTransaksi jenisTransaksi = PstJenisTransaksi.fetchExc(oid);
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_JENIS_TRANSAKSI_ID], jenisTransaksi.getOID());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_JENIS_TRANSAKSI], jenisTransaksi.getJenisTransaksi());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_AFLIASI_ID], jenisTransaksi.getAfliasiId());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_TIPE_ARUS_KAS], jenisTransaksi.getTipeArusKas());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_TYPE_PROSEDUR], jenisTransaksi.getTypeProsedur());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_PROSEDURE_UNTUK], jenisTransaksi.getProsedureUntuk());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_PROSENTASE_PERHITUNGAN], jenisTransaksi.getProsentasePerhitungan());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_TYPE_TRANSAKSI], jenisTransaksi.getTypeTransaksi());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_VALUE_STANDAR_TRANSAKSI], jenisTransaksi.getValueStandarTransaksi());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_STATUS_AKTIF], jenisTransaksi.getStatusAktif());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_TIPE_DOC], jenisTransaksi.getTipeDoc());
         object.put(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_INPUT_OPTION], jenisTransaksi.getInputOption());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_JENIS_TRANSAKSI_ID],0);
         if (oid > 0){
          JenisTransaksi jenisTransaksi = new JenisTransaksi();
          jenisTransaksi.setOID(jSONObject.optLong(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_JENIS_TRANSAKSI_ID],0));
          jenisTransaksi.setJenisTransaksi(jSONObject.optString(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_JENIS_TRANSAKSI], ""));
          jenisTransaksi.setAfliasiId(jSONObject.optLong(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_AFLIASI_ID],0));
          jenisTransaksi.setTipeArusKas(jSONObject.optInt(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_TIPE_ARUS_KAS],0));
          jenisTransaksi.setTypeProsedur(jSONObject.optInt(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_TYPE_PROSEDUR],0));
          jenisTransaksi.setProsedureUntuk(jSONObject.optInt(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_PROSEDURE_UNTUK],0));
          jenisTransaksi.setProsentasePerhitungan(jSONObject.optDouble(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_PROSENTASE_PERHITUNGAN],0));
          jenisTransaksi.setTypeTransaksi(jSONObject.optInt(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_TYPE_TRANSAKSI],0));
          jenisTransaksi.setValueStandarTransaksi(jSONObject.optDouble(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_VALUE_STANDAR_TRANSAKSI],0));
          jenisTransaksi.setStatusAktif(jSONObject.optInt(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_STATUS_AKTIF],0));
          jenisTransaksi.setTipeDoc(jSONObject.optInt(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_TIPE_DOC],0));
          jenisTransaksi.setInputOption(jSONObject.optInt(PstJenisTransaksi.fieldNames[PstJenisTransaksi.FLD_INPUT_OPTION],0));
         boolean checkOidJenisTransaksi = PstJenisTransaksi.checkOID(oid);
          try{
            if(checkOidJenisTransaksi){
               PstJenisTransaksi.updateExc(jenisTransaksi);
            }else{
               PstJenisTransaksi.insertByOid(jenisTransaksi);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(JenisTransaksi jenisTransaksi) throws DBException {
      try {
         PstJenisTransaksi pstJenisTransaksi = new PstJenisTransaksi(0);
         pstJenisTransaksi.setLong(FLD_JENIS_TRANSAKSI_ID, jenisTransaksi.getOID());
         pstJenisTransaksi.setString(FLD_JENIS_TRANSAKSI, jenisTransaksi.getJenisTransaksi());
         pstJenisTransaksi.setLong(FLD_AFLIASI_ID, jenisTransaksi.getAfliasiId());
         pstJenisTransaksi.setInt(FLD_TIPE_ARUS_KAS, jenisTransaksi.getTipeArusKas());
         pstJenisTransaksi.setInt(FLD_TYPE_PROSEDUR, jenisTransaksi.getTypeProsedur());
         pstJenisTransaksi.setInt(FLD_PROSEDURE_UNTUK, jenisTransaksi.getProsedureUntuk());
         pstJenisTransaksi.setDouble(FLD_PROSENTASE_PERHITUNGAN, jenisTransaksi.getProsentasePerhitungan());
         pstJenisTransaksi.setInt(FLD_TYPE_TRANSAKSI, jenisTransaksi.getTypeTransaksi());
         pstJenisTransaksi.setDouble(FLD_VALUE_STANDAR_TRANSAKSI, jenisTransaksi.getValueStandarTransaksi());
         pstJenisTransaksi.setInt(FLD_STATUS_AKTIF, jenisTransaksi.getStatusAktif());
         pstJenisTransaksi.setInt(FLD_TIPE_DOC, jenisTransaksi.getTipeDoc());
         pstJenisTransaksi.setInt(FLD_INPUT_OPTION, jenisTransaksi.getInputOption());
         pstJenisTransaksi.insertByOid(jenisTransaksi.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstJenisTransaksi(0), DBException.UNKNOWN);
      }
      return jenisTransaksi.getOID();
   }
}
