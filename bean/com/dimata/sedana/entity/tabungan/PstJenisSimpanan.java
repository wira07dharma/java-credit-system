...
public class PstJenisSimpanan extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
  ...
  public static int findLimitCommand(int start, int recordToGet, int vectSize) {
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         JenisSimpanan jenisSimpanan = PstJenisSimpanan.fetchExc(oid);
         object.put(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_ID_JENIS_SIMPANAN], jenisSimpanan.getOID());
         object.put(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_NAMA_SIMPANAN], jenisSimpanan.getNamaSimpanan());
         object.put(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_SETORAN_MIN], jenisSimpanan.getSetoranMin());
         object.put(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_BUNGA], jenisSimpanan.getBunga());
         object.put(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_PROVISI], jenisSimpanan.getProvisi());
         object.put(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_BIAYA_ADMIN], jenisSimpanan.getBiayaAdmin());
         object.put(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_DESC_JENIS_SIMPANAN], jenisSimpanan.getDescJenisSimpanan());
         object.put(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_FREKUENSI_SIMPANAN], jenisSimpanan.getFrekuensiSimpanan());
         object.put(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_FREKUENSI_PENARIKAN], jenisSimpanan.getFrekuensiPenarikan());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_ID_JENIS_SIMPANAN],0);
         if (oid > 0){
          JenisSimpanan jenisSimpanan = new JenisSimpanan();
          jenisSimpanan.setOID(jSONObject.optLong(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_ID_JENIS_SIMPANAN],0));
          jenisSimpanan.setNamaSimpanan(jSONObject.optString(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_NAMA_SIMPANAN], ""));
          jenisSimpanan.setSetoranMin(jSONObject.optLong(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_SETORAN_MIN],0));
          jenisSimpanan.setBunga(jSONObject.optLong(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_BUNGA],0));
          jenisSimpanan.setProvisi(jSONObject.optLong(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_PROVISI],0));
          jenisSimpanan.setBiayaAdmin(jSONObject.optLong(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_BIAYA_ADMIN],0));
          jenisSimpanan.setDescJenisSimpanan(jSONObject.optString(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_DESC_JENIS_SIMPANAN], ""));
          jenisSimpanan.setFrekuensiSimpanan(jSONObject.optInt(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_FREKUENSI_SIMPANAN],0));
          jenisSimpanan.setFrekuensiPenarikan(jSONObject.optInt(PstJenisSimpanan.fieldNames[PstJenisSimpanan.FLD_FREKUENSI_PENARIKAN],0));
         boolean checkOidJenisSimpanan = PstJenisSimpanan.checkOID(oid);
          try{
            if(checkOidJenisSimpanan){
               PstJenisSimpanan.updateExc(jenisSimpanan);
            }else{
               PstJenisSimpanan.insertByOid(jenisSimpanan);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(JenisSimpanan jenisSimpanan) throws DBException {
      try {
         PstJenisSimpanan pstJenisSimpanan = new PstJenisSimpanan(0);
         pstJenisSimpanan.setLong(FLD_ID_JENIS_SIMPANAN, jenisSimpanan.getOID());
         pstJenisSimpanan.setString(FLD_NAMA_SIMPANAN, jenisSimpanan.getNamaSimpanan());
         pstJenisSimpanan.setLong(FLD_SETORAN_MIN, jenisSimpanan.getSetoranMin());
         pstJenisSimpanan.setLong(FLD_BUNGA, jenisSimpanan.getBunga());
         pstJenisSimpanan.setLong(FLD_PROVISI, jenisSimpanan.getProvisi());
         pstJenisSimpanan.setLong(FLD_BIAYA_ADMIN, jenisSimpanan.getBiayaAdmin());
         ...
         pstJenisSimpanan.insertByOid(jenisSimpanan.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstJenisSimpanan(0), DBException.UNKNOWN);
