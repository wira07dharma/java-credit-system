...
public class PstDetailTransaksi extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
 ...
 public static JSONObject fetchJSON(long oid){
      ...
      try {
         DetailTransaksi detailTransaksi = PstDetailTransaksi.fetchExc(oid);
         object.put(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_TRANSAKSI_DETAIL_ID], detailTransaksi.getOID());
         object.put(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_JENIS_TRANSAKSI_ID], detailTransaksi.getJenisTransaksiId());
         object.put(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_DEBET], detailTransaksi.getDebet());
         object.put(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_KREDIT], detailTransaksi.getKredit());
         object.put(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_ID_SIMPANAN], detailTransaksi.getIdSimpanan());
         object.put(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_TGL_PRINT_TERAKHIR], detailTransaksi.getTglPrintTerakhir());
         object.put(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_TRANSAKSI_ID], detailTransaksi.getTransaksiId());
         object.put(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_DETAIL_INFO], detailTransaksi.getDetailInfo());
      }catch(Exception exc){}
      return object;
   }
   ...
   public static long syncExc(JSONObject jSONObject){
      long oid = 0;
      if (jSONObject != null){
       oid = jSONObject.optLong(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_TRANSAKSI_DETAIL_ID],0);
         if (oid > 0){
          DetailTransaksi detailTransaksi = new DetailTransaksi();
          detailTransaksi.setOID(jSONObject.optLong(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_TRANSAKSI_DETAIL_ID],0));
          detailTransaksi.setJenisTransaksiId(jSONObject.optLong(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_JENIS_TRANSAKSI_ID],0));
          detailTransaksi.setDebet(jSONObject.optDouble(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_DEBET],0));
          detailTransaksi.setKredit(jSONObject.optDouble(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_KREDIT],0));
          detailTransaksi.setIdSimpanan(jSONObject.optLong(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_ID_SIMPANAN],0));
          detailTransaksi.setTglPrintTerakhir(Formater.formatDate(jSONObject.optString(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_TGL_PRINT_TERAKHIR],"0000-00-00"),"yyyy-MM-dd"));
          detailTransaksi.setTransaksiId(jSONObject.optLong(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_TRANSAKSI_ID],0));
          detailTransaksi.setDetailInfo(jSONObject.optString(PstDetailTransaksi.fieldNames[PstDetailTransaksi.FLD_DETAIL_INFO], ""));
         boolean checkOidDetailTransaksi = PstDetailTransaksi.checkOID(oid);
          try{
            if(checkOidDetailTransaksi){
               PstDetailTransaksi.updateExc(detailTransaksi);
            }else{
               PstDetailTransaksi.insertByOid(detailTransaksi);
            }
         }catch(Exception exc){}
         }
      }
   ...
   public static long insertByOid(DetailTransaksi detailTransaksi) throws DBException {
      try {
         PstDetailTransaksi pstDetailTransaksi = new PstDetailTransaksi(0);
         pstDetailTransaksi.setLong(FLD_TRANSAKSI_DETAIL_ID, detailTransaksi.getOID());
         pstDetailTransaksi.setLong(FLD_JENIS_TRANSAKSI_ID, detailTransaksi.getJenisTransaksiId());
         pstDetailTransaksi.setDouble(FLD_DEBET, detailTransaksi.getDebet());
         pstDetailTransaksi.setDouble(FLD_KREDIT, detailTransaksi.getKredit());
         pstDetailTransaksi.setLong(FLD_ID_SIMPANAN, detailTransaksi.getIdSimpanan());
         pstDetailTransaksi.setDate(FLD_TGL_PRINT_TERAKHIR, detailTransaksi.getTglPrintTerakhir());
         pstDetailTransaksi.setLong(FLD_TRANSAKSI_ID, detailTransaksi.getTransaksiId());
         pstDetailTransaksi.setString(FLD_DETAIL_INFO, detailTransaksi.getDetailInfo());
         pstDetailTransaksi.insertByOid(detailTransaksi.getOID());
      } catch (DBException dbe) {
         throw dbe;
      } catch (Exception e) {
         throw new DBException(new PstDetailTransaksi(0), DBException.UNKNOWN);
      }
      return detailTransaksi.getOID();
   }
}
