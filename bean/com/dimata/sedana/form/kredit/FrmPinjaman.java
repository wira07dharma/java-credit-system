...
public class FrmPinjaman extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_JANGKA_WAKTU_ID = 25;
    public static final int FRM_ACCOUNT_OFFICER_ID = 26;
    public static final int FRM_COLLECTOR_ID = 27;
    public static final int FRM_LOKASI_PENAGIHAN = 28;
    public static final int FRM_JUMLAH_BUNGA = 29;
    public static final int FRM_CATEGORY_PINJAMAN = 30;
    public static final int FRM_STATUS_DENDA = 31;
    ...
    public static String[] fieldNames
            = {
                ...
                "FRM_COLLECTOR_ID",
                "FRM_LOKASI_PENAGIHAN",
                "FRM_JUMLAH_BUNGA",
                "FRM_CATEGORY_PINJAMAN",
                "FRM_STATUS_DENDA"
            };
    ...
    public void requestEntityObject(Pinjaman kredit) {
        try {
            ...
            pinjaman.setJangkaWaktuId(this.getLong(FRM_JANGKA_WAKTU_ID));
            pinjaman.setBillMainId(this.getLong(FRM_CASH_BILL_MAIN_ID));
            pinjaman.setLokasiPenagihan(this.getInt(FRM_LOKASI_PENAGIHAN)); 
            pinjaman.setJumlahBunga(this.getDouble(FRM_JUMLAH_BUNGA));
            pinjaman.setCategoryPinjaman(this.getLong(FRM_CATEGORY_PINJAMAN));
            pinjaman.setStatusDenda(this.getInt(FRM_STATUS_DENDA));
            pinjaman.setAccountOfficerId(this.getLong(FRM_ACCOUNT_OFFICER_ID));
        } catch (Exception e) {
