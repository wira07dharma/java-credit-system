...
public class FrmAngsuran extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_DISC_PCT = 4;
    public static final int FRM_FIELD_DISC_AMOUNT = 5;
...
//            entAngsuran.setIdAngsuran(getLong(FRM_FIELD_ID_ANGSURAN));
            ...
            entAngsuran.setDiscPct(getDouble(FRM_FIELD_DISC_PCT));
            entAngsuran.setDiscAmount(getDouble(FRM_FIELD_DISC_AMOUNT));
        } catch (Exception e) {
